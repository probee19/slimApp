...
<?php
          $houses = array('Une villa de 20 000 000 $', 'Une villa luxieuse de 15,000,000 $', 'Un immeuble à Miami', 'Une île rien que toi');
          $cars = array('Une Mercedes Classe A','Une Lamborghini Urus' ,'Une BMW Série 7');
          $calls = array('Un Iphone X', 'Un Galaxy S9');
          $trips = array('Des vacances à Bora Bora','15 jours de folie à Dubai','Des vacances à Bali', 'Un séjour à Londres');
          $money = array('un chèque de 5000 $', 'un chèque de 10,000 $', 'un chèque de 15 000 $');
...
<div class="entete" id="entete" >Pour ton prochain anniversaire, tu auras:</div>
...
<div class="footer" id="footer" >... de la part de tes amis!</div>
