...
<?php
          $houses = array('Uma villa de US $ 20.000.000', 'Uma villa luxuosa de US $ 15.000.000', 'Um prédio em Miami', 'Uma ilha apenas para você');
          $cars = array('A Mercedes Classe A','A Lamborghini Urus' ,'A Série BMW 7');
          $calls = array('Um Iphone X', 'A Galaxy S9');
          $trips = array('Férias em Bora Bora','15 dias de loucura em Dubai','Feriados de Bali', 'Uma estadia em Londres');
          $money = array('um cheque por US $ 5.000', 'um cheque por US $ 10.000', 'um cheque por US $ 15.000');
...
<div class="entete" id="entete" >Para o seu próximo aniversário, você terá:</div>
...
<div class="footer" id="footer" >... de seus amigos!</div>
