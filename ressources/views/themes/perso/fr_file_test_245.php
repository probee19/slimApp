...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
                    $mots = array('sensuel','robuste','sérieux','aimant','créatif','charismatique','fort','protecteur','gentil','polyvalent','divertissant','reconnaissant','charmant','un du goût','drôle'  );
         else
                    $mots = array('sensuelle','robuste','sérieuse','aimante','Créatif','charismatique','forte','protectrice','gentille','polyvalente','divertissante','reconnaissante','charmante','un du goût','drôle'  );
          shuffle($mots);
?>
<!DOCTYPE HTML>
