...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
                    $qualite =array('Er hat keine Angst vor Herausforderungen', 'Er hat ein Herz aus Gold', 'Er ist geduldig', 'Er gibt niemals auf', 'Er hat das schönste Lächeln', 'Er ist demütig', 'Er ist nett', 'Er liebt seine Familie', 'Er ist immer für seine Lieben da','Er ist ein Träumer'  );
          else  
                    $qualite =array('Sie hat keine Angst vor Herausforderungen', 'Sie hat ein Herz aus Gold', 'Sie ist geduldig', 'Sie gibt niemals auf', 'Sie hat das schönste Lächeln', 'Sie ist bescheiden', 'Sie ist nett', 'Sie liebt ihre Familie', 'Sie ist immer anwesend für ihre Lieben','Sie ist eine Träumerin'  );
