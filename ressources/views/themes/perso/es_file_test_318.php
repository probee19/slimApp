...
<?php
          $pour = array('por sus excelentes servicios de guardaespaldas','por sus habilidades de actuación','para los baños que le da a los leones','por su talento cómico');
          $en = array('en reconocimiento de su apoyo y protección en todo momento','en reconocimiento a su personalidad que hace que el mundo sea un poco menos aburrido','en reconocimiento de los baños que se las arregla para dar a los leones sin ningún accidente','en reconocimiento a su humor que da la sonrisa a todos');
          $ind = mt_rand(0,3);
?>
<!DOCTYPE HTML>
...
<div class="texte" id="header_t"> Certificado de éxito </div>

<div class="texte" id="header_t_2"> orgullosamente emitido para </div>
...
<div class="texte" id="deliv" >Reconocimiento emitido y reconocido por:</div>
