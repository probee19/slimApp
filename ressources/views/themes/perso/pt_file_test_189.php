...
if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
              $texte = array("Secretamente em um relacionamento","Esquecido na zona de amigos","Em um relacionamento com Vodka","Sexy, grátis e solteiro",
"Esperando por um milagre","Amantes de alguém levado","Não entende nada para as mulheres");     }
            else{ 
              $texte = array("Secretamente em um relacionamento","Esquecido na zona de amigos","Em um relacionamento com Vodka","Sexy, grátis e solteiro",
"Esperando por um milagre","Apaixonado por alguém tomado","Não compreende nada para os homens");
            }
