...
<?php
           if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
                  $results = array('Assistindo vídeos divertidos no Youtube','Passando um bom tempo em frente ao jogo PSG Real Madrid FC','Comemorando a vitória do PSG sobre o Real Madrid','Comemorando a vitória do Real Madrid sobre o PSG',
          'Beijando uma garota linda','No jantar romântico', 'Contando seu dinheiro','Visitando amigos');
           }
           else{
                  $results = array('Assistindo vídeos divertidos no Youtube','Comemorando a vitória do PSG sobre o Real Madrid','Comemorando a vitória do Real Madrid sobre o PSG',
          'Beijando um cara legal','No jantar romântico', 'Contando seu dinheiro','Visitando namoradas');
           }
           shuffle($results);
