...
<?php
      ...
      if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
               $message = array('Nostro figlio ha una faccia seducente, lo chiameremo '.$_GET['Nome utente'].''
               ,'Nostro figlio ha una faccia intelligente, lo chiameremo '.$_GET['Nome utente'].''
               ,'Nostro figlio ha una faccia angelica, lo chiameremo '.$_GET['Nome utente'].''
               ,'Nostro figlio ha un sorriso angelico, lo chiameremo '.$_GET['Nome utente'].''
              ...
              ,'Nostra figlia ha un viso intelligente, la chiameremo '.$_GET['Nome utente'].''
               ,'Nostra figlia ha una faccia da angelo, la chiameremo '.$_GET['Nome utente'].''
               ,'Nostra figlia ha un sorriso angelico, la chiameremo '.$_GET['Nome utente'].''
