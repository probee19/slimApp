...
<!DOCTYPE HTML>
<?php
          $dons = array('أمل', 'هدوء', 'حظ', 'اخلاص', 'شجاعة', 'قوة', 'القيادة');
          $qualites = array('حساسية','شجاعة','تحذير','سحر','تأمين','شخصية','إيثار','قوة of character','وفاء','نزاهة','المرونة');
          shuffle($qualites);
          shuffle($dons);
?>
