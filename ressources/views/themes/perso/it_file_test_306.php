...
<?php
          $rev = array('Sei la tranquillità di persona.','Tu incarnare la saggezza.','Sei degno di fiducia','Hai un grande coraggio',
          'Possiamo sempre fidarci di te.','Hai lo spirito creativo.','Hai un buon cuore.','Hai un alto senso di lealtà.','Hai dei bellissimi occhi.','Otterrai grandi cose.');
          shuffle($rev);
?>
<!DOCTYPE HTML>
<img src="https://creation.funizi.com/images-theme-perso/1520361060.jpg" id="back"> 
<img src="https://graph.facebook.com/<?php echo $_GET['fb_id_user']; ?>/picture/?width=275&height=275" class="img_profile" id="fb_id_user">
<div class="texte" id="t_footer">Che cosa rivela la tua immagine del profilo su di te?</div>
