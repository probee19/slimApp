...
<?php
 $texte = array('Armas caídas','É uma bagunça','solteiro','Secretamente em um relacionamento');
 $texte1 = array('Hesite entre 2 pessoas','Coração partido','Oficialmente em um relacionamento','Finalmente como um casal','Em casal e feliz','Mãos fora! coração já tomado!');
 shuffle($texte);
 shuffle($texte1);
?>
...
<div style=" position:absolute; width:800px; top:115px; text-align:center; z-index:2; font-size:20px; font-weight:bold; color:#0C6CFF">Hoje</div>
...
<div style=" position:absolute; width:800px; top:330px; text-align:center; z-index:2; font-size:20px; font-weight:bold; color:#0C6CFF">Em 6 meses</div>
