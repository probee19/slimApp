...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
                    $prix = array('الرجل الأكثر سرية من السنة', 'الرجل الأكثر مغر من السنة', 'الرجل من السنة', 'أطرف رجل من السنة', 'الرجل الأكثر حسية من السنة ');
          else
                    $prix = array('المرأة الأكثر سرية من السنة ', 'المرأة الأكثر مغر من السنة', 'أطرف امرأة من السنة', 'المرأة الأكثر حسية من السنة');
