...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
                    $mots = array('sensual','robust','serious','magnet','creative','charismatic','strong','protective','nice','polyvalent','entertaining','thankful','charming','tastes','funny'  );
         else
                    $mots = array('sensual','robust','serious','magnetic','creative','charismatic','strong','protectress','gentle','versatile','entertaining','thankful','lovely','tastes','funny'  );
          shuffle($mots);
?>
<!DOCTYPE HTML>
