...
.result{font-size:43px; margin-top:0px;font-family: 'Acme', sans-serif; color:#FFF; width:100%; }
 ...
 <?php
                $aime = array('Lachen','dein Bett','deine Freunde','die Musik');
                $couleur = array('Blau', 'rot', 'Grün','Weiß','Orange');
                $force = array('magisches Lächeln','die Einfachheit','Großzügigkeit','Dein Charakter','dein Herz');
                $deteste = array('Die Lüge','dein Wecker','Der Verrat','der Verkehr','die Snobs');
                $personnalite = array('bewundernswert','kreativ','entschlossen');
                $tondefaut = array('empfindlich','Perfektionist');
...
<div id="aime"><span class="titre_rubrique">Du magst</span><div class="result"><?php echo $nature[0] ?><?php echo $aime[0] ?></div></div>
<div id="couleur"><span class="titre_rubrique">Farbe</span><div class="result" style="font-size:30px"><?php echo $couleur[0] ?></div></div>
<div id="force"><span class="titre_rubrique">Deine Stärke</span><div class="result"><?php echo $force[0] ?> </div></div>
<div id="deteste"><span class="titre_rubrique">Du hasst</span><div class="result"><?php echo $deteste[0] ?></div></div>
<div id="personnalite"><span class="titre_rubrique">Persönlichkeit</span><div class="result" style="font-size:30px"><?php echo $personnalite[0] ?></div></div>
<div id="defaut"><span class="titre_rubrique">Deine Schuld</span><div class="result"><?php echo $tondefaut[0] ?></div></div>
