...
#titre_test{position:absolute; z-index:1; left:0; top:0;  width:800px; background:#F77F00; text-align:center; font-size:2em; color:#fff; padding-top:15px;padding-bottom:15px; }
...
#mot3{position:absolute; z-index:1; left: 0px; top: 160px;}
          ...
          <div class='main'>
             ...
             <?php
                $mot = array('Enjaillement','Allocodrome','Asso','Akounamatata','Chapchap','Dabroudordjor','En Gblazou','Kpakpatoyas');
                shuffle($mot);
            ?>
            
            <img src="http://creation.funizi.com/images-theme-perso/1508526452.jpg" id='background'>
                <div id='titre_test'>Quels sont les 3 mots Nouchi qui te vont bien ?</div>
