...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
                    $prix = array('O homem mais discreto do ano', 'O homem mais sedutor do ano', 'O cavalheiro do ano', 'O homem mais engraçado do ano', 'O homem mais sensual do ano ');
          else
                    $prix = array('A mulher mais discreta do ano ', 'A mulher mais sedutora do ano', 'A mulher mais engraçada do ano', 'A mulher mais sensual do ano');
