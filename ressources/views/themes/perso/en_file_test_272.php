...
<?php
      if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
               $message = array('She is already at your side','You&#39;re already going out with her','You already live with her');          }
            else{ 
              $message = array('He is already at your side','You&#39;re already going out with him','You already live with him');
            }
