...
<div class="texte" id="verite3"> <span class="title_block">Seu animal espiritual</span> <span class="content_block"> <?=$animaux[0]; ?> </span> </div>
<div class="texte" id="verite4"> <span class="title_block">Personalidade</span> <span class="content_block"> <?=$personnalites[0]; ?> </span> </div>
<div class="texte" id="verite5"> <span class="title_block">Força</span> <span class="content_block"> <?=$forces[0]; ?> </span> </div>
