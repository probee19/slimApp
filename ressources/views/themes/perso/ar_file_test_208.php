...
<div class="name texte" id="name_user" ><span style="font-size:30px">أنا <span style="color:#EF372C"><?php echo $_GET['user_name']; ?></span></span>,<br> انا اقول <span style="color:#EF372C">STOP</span><br> في المزاد في<span style="color:#EF372C">ليبيا</span> المهاجرين مثل <span style="color:#EF372C">عبيد</span> !</div>
