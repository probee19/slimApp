...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
                    $qualite =array('Él no tiene miedo a los desafíos', 'El tiene un corazón de oro', 'Él es paciente', 'Él nunca se da por vencido', 'Él tiene las más bellas sonrisas', 'Él es humilde', 'Él es agradable', 'Él ama a su familia', 'Él está siempre presente para sus seres queridos','Él es un soñador'  );
          else  
                    $qualite =array('Ella no le teme a los desafíos', 'Ella tiene un corazón de oro', 'Ella es paciente', 'Ella nunca se da por vencida', 'Ella tiene las más bellas sonrisas', 'Ella es humilde', 'Ella es buena', 'Ella ama a su familia', 'Ella está siempre presente para sus seres queridos','Ella es una soñadora'  );
