...
<?php
  if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
                     $texte = array('Você sempre dá com o coração','Você nunca deixa ninguém cair','Você não precisa de ninguém','Você tem a preocupação do detalhe',
                     'Você nunca machucará ninguém','Você não pára em nada','Você passaria por um incêndio para salvar sua família',
                     'Você odeia a injustiça','Você nunca desiste de pessoas','Sua lealdade é infalível','Você aprende com seus erros','Você sempre guarda seus amigos','Você sempre é honesto com as pessoas');
