...
<?php 
           if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
                   $faits = array('perdona tutti','amo la sua famiglia','farà tutto per i suoi amici','non mollare mai','è molto paziente',' è un combattente','è coraggioso',
                         'non fa mai male a una persona','è sempre sorridente','trova sempre il tempo per i suoi amici','sempre superare un fallimento','ama sua madre');
          else
                    $faits = array('perdona tutti','amo la sua famiglia','farà tutto per i suoi amici','non mollare mai','è molto paziente','è un oscillante','è coraggioso',
                         'non fa mai male a una persona','è sempre sorridente','trova sempre il tempo per i suoi amici','sempre superare un fallimento','ama sua madre');
