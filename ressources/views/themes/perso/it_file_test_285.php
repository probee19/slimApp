...
<?php
      if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
               $type = array('Sei un vero marsigliese','Un vero fanatico');
               $message = array('Sei con la tua squadra nella vittoria come nella sconfitta','Ecco Marsiglia','Per sempre per primo','Nessuna pietà per il Clasico');          }
            else{ 
               $type = array('Sei un vero marsigliesee','Un vero fanatico');
              $message = array('Sei con la tua squadra nella vittoria come nella sconfitta','Ecco Marsiglia','Per sempre per primo','Nessuna pietà per il Clasico'); 
            }
