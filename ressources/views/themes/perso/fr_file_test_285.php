...
<?php
      if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
               $type = array(' Tu es un vrai Marseillais ',' Un vrai fanatique ');
               $message = array(' Tu es avec ton équipe dans la victoire comme dans la défaite ',' Ici c\'est Marseille ',' A jamais les premiers ',' Pas de pitié pour le Clasico ');          }
            else{ 
               $type = array(' Tu es une vraie Marseillaise ',' Une vraie fanatique ');
              $message = array(' Tu es avec ton équipe dans la victoire comme dans la défaite ',' Ici c\'est Marseille ',' A jamais les premiers ',' Pas de pitié pour le Clasico '); 
            }
