...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin'){
                    $mots_1 = array('noch nie','Immer','Immer','Nicht','groß','Wahr','Immer');
                    $mots_2 = array('Müde','Bereit','liebenswürdig','Dumm','Herz','Führer','Lächelnd');
          }
          else{
                    $mots_1 = array('noch nie','Immer','Immer','Nicht','groß','Wahr','Immer');
                    $mots_2 = array('müde','bereit','liebenswürdig','Dumm','Herz','Führer','lächelnd');
...
<div class="texte" id="header_t"> Was sind die zwei Wörter, die deine Persönlichkeit am besten beschreiben? </div>
