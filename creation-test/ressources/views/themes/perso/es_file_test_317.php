...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin'){
                    $mots_1 = array('Nunca','Siempre','Siempre','No']','estupendo','Cierto','Siempre');
                    $mots_2 = array('Cansado','Listo','amable','Tonto','Corazón','Líder','Sonriente');
          }
          else{
                    $mots_1 = array('Nunca','Siempre','Siempre','No']','estupendo','Cierto','Siempre');
                    $mots_2 = array('cansado','Listo','amable','Tonto','Corazón','líder','sonriente');
...
<div class="texte" id="header_t"> ¿Cuáles son las dos palabras que mejor describen tu personalidad? </div>
