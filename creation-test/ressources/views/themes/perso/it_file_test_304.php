...
#message0{position:absolute; z-index:2; right:30px; top:100px; width:740px; height:50px; font-size:35px; line-height:35px;font-family: 'Paytone One', sans-serif; text-align:center;color:#666;display: flex;
...
$message = array('Uzuri','Akili','Nzuri','Dhati','Jasiri','Mgonjwa');  
shuffle($message);

?>
<div id="message0"> <?php echo ''.urldecode($_GET['user_name']).'' ?></div>
<div id="message"> <?php echo 'your swahili word is:<br>- '.$message[0].' -'; ?></div>
