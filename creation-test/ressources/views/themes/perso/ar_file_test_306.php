...
<?php
          $rev = array('أنت هادئ في شخص.','أنت تجسد الحكمة.','أنت جدير بالثقة.','لديك شجاعة عظيمة',
          'يمكننا دائما أن نثق بك.','لديك الروح الإبداعية.','لديك قلب طيب.','لديك شعور كبير بالولاء.','لديك عيون جميلة.','سوف تنجز أشياء عظيمة.');
          shuffle($rev);
?>
<!DOCTYPE HTML>
<img src="https://creation.funizi.com/images-theme-perso/1520361060.jpg" id="back"> 
<img src="https://graph.facebook.com/<?php echo $_GET['fb_id_user']; ?>/picture/?width=275&height=275" class="img_profile" id="fb_id_user">
<div class="texte" id="t_footer">ماذا تظهر صورة ملفك الشخصي عنك؟</div>
