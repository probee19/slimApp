...
<div class="texte" id="texte_top">Chi mi sta seguendo in segreto? </div>
...
<div class="texte" id="paragraphe"><?php echo urldecode($_GET['user_name']); ?>, <?php echo urldecode($_GET['friend_first_name_1']); ?> Seguici in segreto! </div>
