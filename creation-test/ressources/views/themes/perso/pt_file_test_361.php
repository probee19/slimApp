...
<?php
          $positions = array('Marcador');
          $roles = array('Líder','Herói','Capitão');
          $forces = array('Nunca solta!','Trabalho duro!','Espírito de equipe !');
          $faiblesses = array('Altruísta','Entende muito');
          $tactiques = array('Procurar e destruir!','Marque e comemore!');
          $devises = array('A vida não é sobre ganhar, mas não perder!','O melhor dos seus jogadores é o pior dos meus!');
...
<div class="texte label_r" id="position"> Posição : </div>
<div class="texte label_r" id="role"> Função : </div>
<div class="texte label_r" id="force"> Força : </div>
<div class="texte label_r" id="faiblesse"> Fraqueza : </div>
<div class="texte label_r" id="tactique"> Tático : </div>
