          ...
          <div class='main'>
            ...
            <?php
                $nature = array('سعيد','السعيدة');
                $personnalite = array('شارع', 'مؤمن', 'جدي');
                $aime = array('تواضع','البساطة');
                $deteste = array('الكذبة','غش','الخيانة');
                $force = array('التحفيز','القوة','مال');
            ...
            <span id="texte_4" class="texte"> <b> اكرهه:</b> <?php echo $deteste[0] ?></span>
            <span id="texte_5" class="texte"> <b> قوة :</b> <?php echo $force[0] ?></span>
            <span id="texte_6" class="texte"> <b> ضعف :</b> <?php echo $faiblesse[0] ?></span>
