...
<?php
          $surprises = array('سيكون لديك طفل. {؟ User_name؟} &#39;عائلة S سيكون لها كنز جديد!', 
                    'يصعب الاختيار {؟ اسم المستخدم؟}. العديد من الأشياء سوف تحسن العام المقبل!',
                    'سوف تحصل على وظيفة جديدة مثالية من شأنها أن تلبي تماما توقعاتك!',
                    'سيكون لديك ترقية المهنية خلال هذا العام',
                    'سوف تجعل رحلة غنية في التجارب والاكتشافات!');
          shuffle($surprises);
?>
<!DOCTYPE HTML>
