...
<?php
          $couleurs = array('الأصفر','أخضر','أبيض','أحمر','أزرق');
          $aimes = array('العناق','السفر','قراءة','العطل','الموسيقى','للنوم');
          $detestes = array('الكذبة','نفاق','الخيانة','التأخير');
          $forces = array('حكمة','شجاعة','سخاء','ابتسامة لطيفة','قلب كبير','فكاهة');
          $faiblesses = array('حساس','الكمال');
...
<div class="texte bloc" id="bloc1"><span class="title">اللون</span><span class="body"><?=ucfirst($couleurs[0])?></span></div>
<div class="texte bloc" id="bloc2"><span class="title">تحب</span><span class="body"><?=$aimes[0]?></span></div>
<div class="texte bloc" id="bloc3"><span class="title">أنت تكره</span><span class="body"><?=$detestes[0]?></span></div>
<div class="texte bloc" id="bloc4"><span class="title">قوتك</span><span class="body"><?=ucfirst($forces[0])?></span></div>
<div class="texte bloc" id="bloc5"><span class="title">نقطة ضعفك</span><span class="body"><?=ucfirst($faiblesses[0])?></span></div>
