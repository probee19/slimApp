...
<?php 
           if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
                   $faits = array('pardonne à tout le monde','aime sa famille','fera tout pour ses amis','n&#39;abandonne jamais','est très patient',' est un battant','est courageux',
                         'ne fait jamais du mal à une personne','est toujours souriant','trouve toujours du temps pour ses amis','toujours une echec','aime fort sa mère');
          else
                    $faits = array('pardonne à tout le monde','aime sa famille','fera tout pour ses amis','n&#39;abandonne jamais','est très patiente','est un battante','est courageuse',
                         'ne fait jamais du mal à une personne','est toujours souriante','trouve toujours du temps pour ses amis','toujours une echec','aime fort sa mère');
...
<div id="header"> 7 faits au sujet de <?php echo urldecode($_GET['user_name']); ?></div>
<hr>
<div id="profile_img">
