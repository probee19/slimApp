...
<div id='titre'><span style="font-size:40px;"><?php echo urldecode($_GET['user_name']); ?>,</span><br>tu avrai <br><?php echo $nb_enfants;?> bambini)</div>
<div id='boys'><?php echo $garcon ?>ragazzi)</div>
<div id='girls'><?php echo $fille?> figlia / e</div>
