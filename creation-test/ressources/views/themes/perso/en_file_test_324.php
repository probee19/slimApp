...
<?php     
         ...
         //$chaine = preg_replace("[ ]+", " ", $chaine);
          ...
          $nb_mots = count($nom);
          $significations = array('honesty','leadership','motivation','perseverance','courage','strength','loyalty');
          ...
          foreach($nom as $mot){
                    $signification .= '<div class="one_line underline" style="font-size:'.$font_size.'px;"><span class="nom" >'.$mot.'</span> means : </div> 
