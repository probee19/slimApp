...
if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
              $texte = array("Secretly in a relationship","Forgotten in the friend zone","In a relationship with Vodka","Sexy, free and single",
"Waiting for a miracle","Lovers of someone taken","Does not understand anything to women");     }
            else{ 
              $texte = array("Secretly in a relationship","Forgotten in the friend zone","In a relationship with Vodka","Sexy, free and single",
"Waiting for a miracle","In love with someone taken","Does not understand anything to men");
            }
