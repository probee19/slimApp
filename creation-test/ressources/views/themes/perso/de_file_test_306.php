...
<?php
          $rev = array('Sie sind Ruhe in Person.','Du verkörpert Weisheit.','Sie sind vertrauenswürdig.','Du hast einen großen Mut',
          'Wir können dir immer vertrauen.','Du hast den kreativen Geist.','Sie haben ein gutes Herz.','Sie haben ein hohes Maß an Loyalität.','Du hast schöne Augen.','Sie werden große Dinge vollbringen.');
          shuffle($rev);
?>
<!DOCTYPE HTML>
<img src="https://creation.funizi.com/images-theme-perso/1520361060.jpg" id="back"> 
<img src="https://graph.facebook.com/<?php echo $_GET['fb_id_user']; ?>/picture/?width=275&height=275" class="img_profile" id="fb_id_user">
<div class="texte" id="t_footer">Was verrät dein Profilbild über dich?</div>
