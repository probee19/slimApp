...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
                    $amour = array('Verheiratet','Verheiratet, 2 children','Verheiratet, 3 children','Verheiratet, 2 twins','Verheiratet, 1 child');
                    $carriere = array('Wissenschaftler','Sternagent','Berühmter Vlogger','Fotograf von Sternen','Berühmter Dichter');
                    $argent = array('2 Bankkonten mit Millionen von Dollar','2.000.000 $ pro Jahr','2.500.000 $ pro Jahr','Eigentümer von 3 behelfsmäßigen Häusern','Millionär. Besitzer von 5 großen Villen. ');
                    $accomplissement = array('Doktorat','Erstellen Sie Ihre eigene Firma','Hilfe vieler Wohltätigkeitsorganisationen','Inhaber einer großen Automobilmarke','Freund der Berühmtheiten','Besitzer eines glamourösen Nachtclubs');
          }
          else{
                    $amour = array('Verheiratet','Braut, 2 Kinder','Braut, 3 Kinder','Braut, 2 Zwillinge','Braut, 1 Kind');
                    $carriere = array('Wissenschaftler','Sternagent','Berühmter Vlogger','Fotograf von Sternen','Berühmter Dichter');
                    $argent = array('2 Bankkonten mit Millionen von Dollar','2.000.000 $ pro Jahr','2.500.000 $ pro Jahr','Eigentümer von 3 behelfsmäßigen Häusern','Millionär. Besitzer von 5 großen Villen. ');
                    $accomplissement = array('Doktorat','Erstellen Sie Ihre eigene Firma','Hilfe vieler Wohltätigkeitsorganisationen','Inhaber einer großen Automobilmarke','Freund der Berühmtheiten','Besitzer eines glamourösen Nachtclubs');
...
<div class="texte box" id="box_heart"> Liebe </div>
...
<div class="texte box" id="box_money"> Geld </div>
