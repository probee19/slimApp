...
<?php
          ...
          $background = $background_eden; $verdict = "PARAÍSO"; $color1 = '#1A237E'; $color2 = '#fff';
...
<div class="notes" style="color:<?php echo $color1;?>; background:<?php echo $bg_color;?>">
          <div id="nom">Nombre: <?php echo urldecode($_GET['user_name']); ?></div>
          <div id="good">Buenas acciones: <?php echo number_format($action); ?> </div>
          <div id="bad">Pecados: <?php echo number_format($peches); ?></div>
          <div id="kindness">Amabilidad: <?php echo $gentillesse; ?> %</div>
</div>

<div class="decision" style="color:<?php echo $color2;?>; background:<?php echo $bg_color;?>">
         Decisión definitiva : <?php echo $verdict;?>
</div>
