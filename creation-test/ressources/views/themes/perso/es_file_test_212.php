...
<?php
      if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
               $message = array('Ella ya está a tu lado.','Ya compartes tu vida con ella.','Ella siempre ha estado a tu lado y seguirá siéndolo.');          }
            else{ 
               $message = array('Él ya está a tu lado.','Ya compartes tu vida con Él.','Él siempre ha estado a tu lado y seguirá siéndolo.');     
            }
