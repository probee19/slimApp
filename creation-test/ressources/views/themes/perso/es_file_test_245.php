...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
                    $mots = array('sensual','robustoo','grave','imán','creativo','carismático','fuerte','protector','bonito','polivalente','entretenido','agradecido','encantador','gustos','gracioso'  );
         else
                    $mots = array('sensual','robustoo','grave','imánic','creativo','carismático','fuerte','protectora','amable','versátil','entretenido','agradecido','encantador','gustos','gracioso'  );
          shuffle($mots);
?>
<!DOCTYPE HTML>
