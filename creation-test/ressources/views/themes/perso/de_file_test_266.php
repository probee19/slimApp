...
<!DOCTYPE HTML>
<?php
          $surprises = array('Du wirst heiraten.','Sie werden ein neues Auto als Geschenk haben.','Du wirst dich verlobten.','Sie werden Ihren Ex anrufen.',
                    'Sie werden einen Urlaub in Miami haben.', 'Du wirst Zwillinge bekommen');
