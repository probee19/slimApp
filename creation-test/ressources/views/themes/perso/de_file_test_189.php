...
if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
              $texte = array("Heimlich in einer Beziehung","In der Freundeszone vergessen","In einer Beziehung mit Vodka","Sexy, frei und Single",
"Warten auf ein Wunder","Liebhaber von jemandem genommen","Versteht nichts für Frauen");     }
            else{ 
              $texte = array("Heimlich in einer Beziehung","In der Freundeszone vergessen","In einer Beziehung mit Vodka","Sexy, frei und Single",
"Warten auf ein Wunder","In jemanden verliebt verliebt","Versteht nichts für Männer");
            }
