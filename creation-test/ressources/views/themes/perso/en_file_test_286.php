...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
                    $amour = array('Married','Married, 2 children','Married, 3 children','Married, 2 twins','Married, 1 child');
                    $carriere = array('Scientist','Star Agent','Famous Vlogger','Photographer of stars','Famous poet');
                    $argent = array('2 bank accounts with millions of dollars','$ 2,000,000 a year','$ 2,500,000 a year','Owner of 3 makeshift houses','Millionaire. Owner of 5 large villas. ');
                    $accomplissement = array('PhD','Creating your own company','Help of many charities','Owner of a major automobile brand','Friend of the celebrities','Owner of a glamorous nightclub');
          }
          else{
                    $amour = array('Married','Bride, 2 children','Bride, 3 children','Bride, 2 twins','Bride, 1 child');
                    $carriere = array('Scientist','Star Agent','Famous vlogger','Photographer of stars','Famous poet');
                    $argent = array('2 bank accounts with millions of dollars','$ 2,000,000 a year','$ 2,500,000 a year','Owner of 3 makeshift houses','Millionaire. Owner of 5 large villas. ');
                    $accomplissement = array('PhD','Creating your own company','Help of many charities','Owner of a major automobile brand','Friend of the celebrities','Owner of a glamorous nightclub');
...
<div class="texte box" id="box_heart"> Love </div>
...
<div class="texte box" id="box_money"> Money </div>
