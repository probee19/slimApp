...
<?php
      if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
               $type = array('You are a true Marseillais','A real fanatic');
               $message = array('You are with your team in victory as in defeat','Here is Marseille','Forever first','No mercy for the Clasico');          }
            else{ 
               $type = array('You are a true Marseillaise','A real fanatic');
              $message = array('You are with your team in victory as in defeat','Here is Marseille','Forever first','No mercy for the Clasico'); 
            }
