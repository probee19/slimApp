...
.result{font-size:43px; margin-top:0px;font-family: 'Acme', sans-serif; color:#FFF; width:100%; }
 ...
 <?php
                $aime = array('reír','tu cama','tus amigos','la música');
                $couleur = array('azul', 'rojo', 'verde','Blanco','naranja');
                $force = array('sonrisa mágica','la simplicidad','generosidad','tu personaje','tu corazón');
                $deteste = array('La mentira','tu despertador','La traición','tráfico','los snobs');
                $personnalite = array('admirable','creativo','determinado');
                $tondefaut = array('sensible','perfeccionista');
...
<div id="aime"><span class="titre_rubrique">Te gusta</span><div class="result"><?php echo $nature[0] ?><?php echo $aime[0] ?></div></div>
<div id="couleur"><span class="titre_rubrique">Color</span><div class="result" style="font-size:30px"><?php echo $couleur[0] ?></div></div>
<div id="force"><span class="titre_rubrique">Tu fuerza</span><div class="result"><?php echo $force[0] ?> </div></div>
<div id="deteste"><span class="titre_rubrique">Tu odias</span><div class="result"><?php echo $deteste[0] ?></div></div>
<div id="personnalite"><span class="titre_rubrique">Personalidad</span><div class="result" style="font-size:30px"><?php echo $personnalite[0] ?></div></div>
<div id="defaut"><span class="titre_rubrique">Tu culpa</span><div class="result"><?php echo $tondefaut[0] ?></div></div>
