...
<?php
  ...
  $texte = array('{؟ اسم المستخدم؟} حافظ على الأسرار!', 'مع {؟ نحن لا نشعر بالملل!', '{؟ user_name؟} هو مجرد رائعتين!',
  '{؟ user_name؟} يمكن أن تعطي كل شيء عن طريق الصداقة!','{؟ يعرف user_name؟} كيفية إعطاء نصيحة جيدة!', 
  '{؟ يعد user_name؟} مفاجآت رائعة!','{؟ يعرف user_name؟} كيفية جعل الحياة أكثر جمالا!');
shuffle($texte);
?>
...
<div id="titretest" >ال <span style="color:#D90000">5 أسباب</span> ان نكون اصدقاء <br><?php echo $_GET['full_user_name']; ?></div>
