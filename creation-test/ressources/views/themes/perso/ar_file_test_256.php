...
<!DOCTYPE HTML>
<?php 
          $phrases = array('أدركت أنني لا أخاف من الدفاع عن الأشياء التي أؤمن بها، حتى لو اضطررت للقتال من أجلها وحدها.',
                    'أدركت أنني لم يكن لديك للقتال من أجل مكان في حياة الآخرين. أولئك الذين حقا احترام لي سوف تبقى لي دائما مكانا في قلوبهم',
                    'فهمت أنني لا ينبغي أن يشك في قدراتي. لدي فقط أن نتذكر الطريق سافر، فرناشيس العقبات، وفاز المعارك والمخاوف التغلب عليها.',
                    'أدركت أنني لا أستطيع تغيير الطريقة التي رأيتني الناس. لم يكن حتى يستحق المحاولة. سأعيش حياتي و سعيدة.');
          shuffle($phrases);
?>
