...
<?php
$texte = array("ne dit que des choses intéressantes","est gracieuse","est mystèrieuse","est belle","aime les câlins","est intelligente","transmetteur sa joie de vivre","est épanouie", "prend soin d&#39;elle","est inaccessible"
,"un sens de l&#39;humour","est passionnée","est pétillante et énergique","un sens de l&#39;humour","est prêt à faire des compromis","aime faire des galipettes", "dit ce qu&#39;elle veut"
,"est une femme indépendante","est gentille et attentionnée");
 shuffle($texte);
?>
...
<div id="titretest" >Pourquoi <?php echo urldecode($_GET['user_name']); ?> est une Femme Parfaite?</div>
<div class="name texte" id="name_user" ></div>
