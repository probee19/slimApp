          ...
          <div class='main'>
            ...
            <?php
                $nature = array('Alegre','contento');
                $personnalite = array('S t.', 'creyente', 'grave');
                $aime = array('Modestia','La simplicidad');
                $deteste = array('La mentira','Engañando','La traición');
                $force = array('Motivación','El poder','dinero');
            ...
            <span id="titre" class="titre"> ¿Cuál es tu personalidad <?php echo urldecode($_GET['user_name']); ?>?</span>
            ...
            <span id="texte_1" class="texte"> <b>Naturaleza:</b> <?php echo $nature[0] ?></span>
            <span id="texte_2" class="texte"> <b> Personalidad:</b> <?php echo $personnalite[0] ?></span>
            <span id="texte_3" class="texte"> <b>Amor :</b> <?php echo $aime[0] ?></span>
            <span id="texte_4" class="texte"> <b> Odio:</b> <?php echo $deteste[0] ?></span>
            <span id="texte_5" class="texte"> <b> Fuerza:</b> <?php echo $force[0] ?></span>
            <span id="texte_6" class="texte"> <b> Debilidad:</b> <?php echo $faiblesse[0] ?></span>
