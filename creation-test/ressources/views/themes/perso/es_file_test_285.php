...
<?php
      if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
               $type = array('Eres un verdadero Marsellais','Un verdadero fanático');
               $message = array('Estás con tu equipo en la victoria como en la derrota','Aquí está Marsella','Para siempre primero','Sin piedad para el Clásico');          }
            else{ 
               $type = array('Eres un verdadero Marsellaise','Un verdadero fanático');
              $message = array('Estás con tu equipo en la victoria como en la derrota','Aquí está Marsella','Para siempre primero','Sin piedad para el Clásico'); 
            }
