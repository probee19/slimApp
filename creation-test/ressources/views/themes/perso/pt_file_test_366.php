...
<?php 
          $texte = array('Meus pensamentos para as vítimas das chuvas torrenciais em Abidjan','Yako para meus amigos da Costa do Marfim. Sinceramente com a Costa do Marfim.');
          shuffle($texte);
?>
<!DOCTYPE HTML>
