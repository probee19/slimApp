...
<?php
          $significations = array('ثقة','وفاء','سلام','ازدهار','شجاعة','شجاعة','كرامة','لطف','قوة');
...
<div class="texte" id="texte1"> الدم الملكي 100 ٪ </div>
<div class="texte" id="texte2"> يعني </div>
<div class="texte" id="texte3"> <?=$significations[0]?> و <?=$significations[1]?> </div>
