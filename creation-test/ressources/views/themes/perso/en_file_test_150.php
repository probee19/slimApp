...
<div class="name texte" id="position1_name_friend_1" ><?php echo urldecode($_GET['friend_name_1']); ?> <span>just now</span></div>
<div  id="message1" ><?php echo $message_1[$key]; ?></div>
<div class="name texte" id="position2_name_friend_1" ><?php echo urldecode($_GET['friend_name_1']); ?> <span>4 minutes ago</span></div>
<div  id="message2" ><?php echo $message_2[$key]; ?></div>
<div class="name texte" id="position3_name_friend_1" ><?php echo urldecode($_GET['friend_name_1']); ?> <span>6 minutes ago</span></div>
