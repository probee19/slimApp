...
<?php     
          ...
          $nb_mots = count($nom);
          $significations = array('أمانة','قيادة','التحفيز','مثابرة','شجاعة','قوة','وفاء');
          ...
          foreach($nom as $mot){
                    $signification .= '<div class="one_line underline" style="font-size:'.$font_size.'px;"><span class="nom" >'.$mot.'</span> يعني : </div> 
