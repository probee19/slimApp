...
<div class="texte" id="texte1"><?php echo $_GET['User_name']; ?> <br> te deseo un feliz</div>

<div class="texte" id="texte2">Día de la Independencia</div>

<div class="texte" id="texte3">República del Congo</div>
