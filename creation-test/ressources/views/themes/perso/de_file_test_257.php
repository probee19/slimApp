...
<!DOCTYPE HTML>
<?php
          $dons = array('Hoffnung', 'Ruhe', 'Glück', 'Aufrichtigkeit', 'Mut', 'Stärke', 'die Führung');
          $qualites = array('Empfindlichkeit','Mut','Warnung','Charme','Versicherung','Individualität','Altruismus','Stärke of character','Loyalität','Unparteilichkeit','Flexibilität');
          shuffle($qualites);
          shuffle($dons);
?>
