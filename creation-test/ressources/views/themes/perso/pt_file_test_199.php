...
#nouvelle_bottom{position:absolute; z-index:2; left: 420px; width:360px; bottom: 50px; font-size:30px; color:#FFBF00;line-height:30px; text-align:center; font-family: 'Raleway', sans-serif;} 
   ...
   <?php
                ...
                $message_1 = array('"Novos encontros"','"Serenidade"','"A riqueza"','"Projetos"','"Renovação"');
                $message_2 = array('Você nunca estará sozinho.','Você encontrará paz interior!','Sua conta bancária agradecerá.','Aproveite as oportunidades!','Você não deixará nada ao acaso!');
...
<div class="name texte" id="name_user" >O ano de<?php echo urldecode($_GET['user_name']); ?> :</div>
