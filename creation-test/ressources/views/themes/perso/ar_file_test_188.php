...
<?php
$texte = array("فقط يقول أشياء مثيرة للاهتمام","هو رشيقة","هو غامض","جميل","احب العناق","يكون ذكيا","ينقل له جوي دي فيفر","هو الوفاء", "اهتم بها","غير قابل للوصول"
,"لديه روح الدعابة","هو عاطفي","هو شمبانيا وحيوية","لديه روح الدعابة","مستعدة للتسوية","مثل الذهاب للنزهة", "تعرف ما تريد"
,"هي امرأة مستقلة","هو نوع ومراعاة");
 shuffle($texte);
?>
