...
<?php
$message = array('Você pensa em outros antes de pensar em si mesmo','Você sempre confia nas pessoas','Você às vezes questiona suas escolhas demais',
'Você deixa as pessoas abusarem da sua gentileza');
shuffle($message);
?>
