...
<?php
          $significations = array('confianza','lealtad','paz','prosperidad','valentía','valor','dignidad','amabilidad','fuerza');
...
<div class="texte" id="texte1"> Sangre real 100% </div>
<div class="texte" id="texte2"> medio </div>
<div class="texte" id="texte3"> <?=$significations[0]?> y <?=$significations[1]?> </div>
