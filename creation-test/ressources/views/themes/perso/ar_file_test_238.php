...
<?php
  if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
            $texte = array('كنت تفعل أي شيء لأصدقائك','سحر الخاص بك هو قاتلة','تحب بحماس','الناس يجب أن لا نقلل لك','أنت تكره الظلم','أنت أقوى مما يبدو','لا شيء يمكن كسر روحك','ثقتك في أنت لا تتزعزع','كنت شجاع مما كنت اعتقد');
  }
            else{ 
          $texte = array('كنت تفعل أي شيء لأصدقائك','سحر الخاص بك هو قاتلة','تحب بحماس','الناس يجب أن لا نقلل لك','أنت تكره الظلم','أنت أقوى مما يبدو','لا شيء يمكن كسر روحك','ثقتك في أنت لا تتزعزع','كنت شجاع مما كنت اعتقد');
  }
...
<div id="titretest" ><span style=\"color:#EFA200\">تروثس 5</span> اكتشفت عنك في عام 2017<br> <?php echo urldecode($_GET['full_user_name']); ?> 
         </div>
