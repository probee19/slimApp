...
<?php
$texte = array('Você é uma pessoa de beleza perfeita, você pode colocar qualquer um em seu bolso','Uau! Com esta magnífica beleza que você tem, todo mundo está procurando por você!','Nós só falamos sobre você! Você tem uma beleza extraordinária!');
$score = array('11','12','10');
$k = mt_rand(0,2);
?>
<div class="texte" id="top"> <?php echo urldecode($_GET['user_name']); ?> ESTE É SEU PONTO! </div>
