...
<?php 
          $texte = array('Meine Gedanken an die Opfer der sintflutartigen Regenfälle in Abidjan','Yako zu meinen ivorischen Freunden. Von ganzem Herzen mit der Elfenbeinküste.');
          shuffle($texte);
?>
<!DOCTYPE HTML>
