...
<?php
          $houses = array('Eine 20.000.000 $ Villa', 'Eine luxuriöse Villa von $ 15.000.000', 'Ein Gebäude in Miami', 'Eine Insel nur für dich');
          $cars = array('Ein Mercedes Klasse A','Ein Lamborghini Urus' ,'Ein BMW 7er');
          $calls = array('Ein Iphone X', 'Ein Galaxy S9');
          $trips = array('Ein Urlaub in Bora Bora','15 Tage Wahnsinn in Dubai','Bali Urlaub', 'Ein Aufenthalt in London');
          $money = array('ein Scheck über 5.000 Dollar', 'ein Scheck über 10.000 Dollar', 'ein Scheck über 15.000 $');
...
<div class="entete" id="entete" >Für Ihren nächsten Geburtstag haben Sie:</div>
...
<div class="footer" id="footer" >... von deinen Freunden!</div>
