...
<?php     
         ...
         //$chaine = preg_replace("[ ]+", " ", $chaine);
          ...
          $nb_mots = count($nom);
          $significations = array('Ehrlichkeit','Führung','Motivation','Ausdauer','Mut','Stärke','Loyalität');
          ...
          foreach($nom as $mot){
                    $signification .= '<div class="one_line underline" style="font-size:'.$font_size.'px;"><span class="nom" >'.$mot.'</span> meint : </div> 
