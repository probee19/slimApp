...
<?php
  if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
            $texte = array('Faresti qualsiasi cosa per i tuoi amici','Il tuo fascino è fatale','Ami appassionatamente','La gente non dovrebbe sottovalutarti','Tu odi le ingiustizie','Sei più forte di quello che sembra','Niente può rompere il tuo spirito','La tua fiducia in te è irremovibile','Sei più coraggioso di quanto pensi');
  }
            else{ 
          $texte = array('Faresti qualsiasi cosa per i tuoi amici','Il tuo fascino è fatale','Ami appassionatamente','La gente non dovrebbe sottovalutarti','Tu odi le ingiustizie','Sei più forte di quello che sembra','Niente può rompere il tuo spirito','La tua fiducia in te è irremovibile','Sei più coraggioso di quanto pensi');
  }
...
<div id="titretest" >Le <span style=\"color:#EFA200\">5 VERITÀ</span> Scoperte su di te nel 2017<br> <?php echo urldecode($_GET['full_user_name']); ?> 
         </div>
