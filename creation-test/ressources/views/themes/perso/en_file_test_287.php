...
<?php 
          $forces = array('his courage','his intelligence','his kindness','his cool','his way of speaking','his sense of respect','his sense of duty');
          shuffle($forces);
?>
<!DOCTYPE HTML>
...
<div class="texte" id="force">  
          <div  id="force_1"> The main strength of <?php echo urldecode($_GET['user_name']); ?> is</div>
          <div  id="force_2"> <?= $forces[0];?>  </div>
</div>

<div class="texte" id="texte_bottom">What is your greatest strength?</div>
