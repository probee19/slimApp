...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
                   $sis = array('Halte es zurück, du musst ihn heiraten.','Lass ihn nicht gehen, er ist nett.','Warte, er ist beschützend.','Denken Sie daran, er ist ein perfekter Ehemann.'
                    ,'Warte, er ist treu.','Moment mal, er ist galant. ');
          else
                   $sis = array('Lass sie nicht gehen, du musst sie heiraten.','Halte es zurück, sie ist nett.','Lass sie nicht gehen, sie ist eine perfekte Frau.'
                    ,'Denken Sie daran, sie ist treu und treu.','Halte es zurück, sie wird eine gute Mutter sein.');
          shuffle($sis);
?>

<div class="texte" id="sis_1"> Wenn sein Name ist </div>
