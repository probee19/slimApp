...
<!DOCTYPE HTML>
<?php
          $dons = array('esperança', 'calma', 'sorte', 'sinceridade', 'coragem', 'força', 'a liderança');
          $qualites = array('sensibilidade','coragem','Atenção','charme','seguro','individualidade','altruísmo','força of character','fidelidade','imparcialidade','flexibilidade');
          shuffle($qualites);
          shuffle($dons);
?>
...
<div id="p" >Você está irradiando </div>
