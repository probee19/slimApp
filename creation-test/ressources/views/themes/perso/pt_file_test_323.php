...
<?php
          $like = array('a família dele','amigos dele','donner','sua paixão por viajar','oferecer um sorriso','ajudar pessoas');
          $dislike = array('mentirosos','os chuveiros','as pessoas mal-humoradas');
          $nature = array('fiel','empático','sociável');
          $personnalite = array('gostaria de compartilhar','não é egoísta','faça todos rirem');
...
<div class="texte ligne" id="ligne1"> $_GET['vos amo :  </div>
<div class="texte resultat" id="resultat1"> <?=$like[0];?> </div>

<div class="texte ligne" id="ligne2"> $_GET[' t ódio :  </div>
<div class="texte resultat" id="resultat2"> <?=$dislike[0];?> </div>

<div class="texte ligne" id="ligne3"> $_GET[' t Nature :  </div>
<div class="texte resultat" id="resultat3"> <?=$nature[0];?> </div>

<div class="texte ligne" id="ligne4"> $_GET[' t personalidade :  </div>
