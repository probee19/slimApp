...
<div class="texte" id="head"> How many people visited your profile today? </div>
...
<div class="texte" id="visite">
          ...
          <div class="texte" id="compteur"> <?=mt_rand(75,204)?> <div class="texte" id="lab_compteur"> visits</div> </div>
</div>
