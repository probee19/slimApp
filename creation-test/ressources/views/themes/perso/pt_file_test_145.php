...
#mot3{position:absolute; z-index:1; left: 0px; top: 160px;}
   ...
   if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
		 $mot = array('Esperto','Trabalho','Famille','Honestoo','Afetuoso','Visionário','Grave','Amizade');
   }
   else{
		 $mot = array('inteligente','Trabalho','Família','Honestoo','afetuoso','Visionário','grave','Amizade');
   }
  ...
  <img src="http://creation.funizi.com/images-theme-perso/1508526452.jpg" id='background'>
      <div id='titre_test'>Quais são as 3 palavras que descrevem você?</div>
