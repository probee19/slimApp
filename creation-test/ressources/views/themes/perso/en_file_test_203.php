...
<?php
  if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
                     $texte = array('You always give with the heart','You will never let anyone down','You do not need anyone','You have the worry of the detail',
                     'You will never hurt anyone','You do not stop at nothing','You would go through a fire to save your family',
                     'You hate injustice','You never give up people','Your loyalty is foolproof','You learn from your mistakes','You always watch over your friends','You are always honest with people');
