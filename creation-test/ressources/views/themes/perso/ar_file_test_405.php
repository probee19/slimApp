...
<?php
          $qualites = array('نحن أبطال العالم لكرة القدم لعام 2018','فن الطهي الفرنسي مصنف في اليونسكو!','نحن المخترعون اللامعون لـ \"قبلة فرنسية\".',
          'Daft Punk جعل العالم كله يرقص!','لدينا ميل فوي!','فرنسا هي دولة الشمبانيا.','يجسد الفرنسيون الأناقة والرومانسية!','لدينا أفضل البطاطا المقلية في العالم!');
          shuffle($qualites);
?>
<!DOCTYPE HTML>
