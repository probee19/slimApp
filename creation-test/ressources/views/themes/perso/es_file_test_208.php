...
<div class="name texte" id="name_user" ><span style="font-size:30px">Yo <span style="color:#EF372C"><?php echo urldecode($_GET['user_name']); ?></span></span>,<br> yo digo <span style="color:#EF372C">STOP</span><br> en la subasta en<span style="color:#EF372C">Libia</span> a los migrantes les gusta <span style="color:#EF372C">esclavos</span> !</div>
