...
<?php
          $aimes = array(' L\'amour ',' L\'amitié ',' La famille ',' Les enfants ',' Les amis ');
          $detestes = array( 'Les menteurs ',' Les infidéles ',' Les hypocrites ',' Les trompeurs ',' Les erreurs ');
...
<div class="texte" id="phrase"> <?php echo $_GET['user_name']; ?> sait ce qui est bon et pas bon dans sa vie </div>
