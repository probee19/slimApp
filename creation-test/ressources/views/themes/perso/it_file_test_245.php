...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
                    $mots = array('sensualee','robustoo','grave','magnete','creativo','carismatico','forte','protettivo','simpatico','polivalente','divertente','grato','affascinante','gusti','divertente'  );
         else
                    $mots = array('sensualee','robustoo','grave','magneteic','creativo','carismatico','forte','protettrice','dolce','versatile','divertente','grato','bello','gusti','divertente'  );
          shuffle($mots);
?>
<!DOCTYPE HTML>
