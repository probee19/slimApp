...
<?php 
          $messages = array(' Solidarité avec nos frères Italiens. Pensées émues pour les victimes et leurs proches. ',' Pleine solidarité avec les victimes, leurs familles et tous nos amis Italiens... ',
          ' Mes pensées les plus attristées au peuple italien après la catastrophe de Gênes. ');
          shuffle($messages);
?>
<!DOCTYPE HTML>
