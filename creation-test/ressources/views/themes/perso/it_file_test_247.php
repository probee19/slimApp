...
<?php
          $houses = array('Una villa da $ 20.000.000', 'Una villa lussuosa di $ 15.000.000', 'Un edificio a Miami', 'Un&#39;isola solo per te');
          $cars = array('Una Mercedes Classe A','Un Lamborghini Urus' ,'Una BMW Serie 7');
          $calls = array('Un Iphone X', 'Un Galaxy S9');
          $trips = array('Una vacanza a Bora Bora','15 giorni di follia a Dubai','Vacanze a Bali', 'Un soggiorno a Londra');
          $money = array('un assegno per $ 5,000', 'un assegno di $ 10.000', 'un assegno di $ 15.000');
...
<div class="entete" id="entete" >Per il tuo prossimo compleanno, avrai:</div>
...
<div class="footer" id="footer" >... dai tuoi amici!</div>
