...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin'){
                    $mots_1 = array('Nunca','Sempre','Sempre','Não','ótimo','Verdade','Sempre');
                    $mots_2 = array('Cansado','pronto','amável','Burro','Coração','Líder','Sorridente');
          }
          else{
                    $mots_1 = array('Nunca','Sempre','Sempre','Não','ótimo','Verdade','Sempre');
                    $mots_2 = array('cansado','pronto','amável','Burro','Coração','líder','sorridente');
...
<div class="texte" id="header_t"> Quais são as duas palavras que melhor descrevem sua personalidade? </div>
