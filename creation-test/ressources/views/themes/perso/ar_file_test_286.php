...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
                    ...
                    $carriere = array('امن','وكيل النجم','Vlogger الشهيرة','مصور النجوم','الشاعر الشهير');
                    $argent = array('2 حسابات بنكية بملايين الدولارات','2000،000 دولار في السنة','2500000 دولار في السنة','مالك من 3 منازل مؤقتة','مليونير. صاحب 5 فيلات كبيرة. ');
                    $accomplissement = array('الدكتوراه','خلق شركتك الخاصة','مساعدة من العديد من الجمعيات الخيرية','مالك لعلامة تجارية رئيسية للسيارات','صديق المشاهير','مالك ملهى ليلي ساحر');
          }
          else{
                    $amour = array('زوجت','عروس ، طفلين','العروس ، 3 أطفال','العروس ، توأمان','عروس ، طفل واحد');
                    $carriere = array('امن','وكيل النجم','فيديو مشهور','مصور النجوم','الشاعر الشهير');
                    $argent = array('2 حسابات بنكية بملايين الدولارات','2000،000 دولار في السنة','2500000 دولار في السنة','مالك من 3 منازل مؤقتة','مليونير. صاحب 5 فيلات كبيرة. ');
                    $accomplissement = array('الدكتوراه','خلق شركتك الخاصة','مساعدة من العديد من الجمعيات الخيرية','مالك لعلامة تجارية رئيسية للسيارات','صديق المشاهير','مالك ملهى ليلي ساحر');
