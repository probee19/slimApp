...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
                    $amour = array('زوجت','زوجت, 2 children','زوجت, 3 children','زوجت, 2 twins','زوجت, 1 child');
                    $carriere = array('امن','وكيل ستار','مدونة فيديو مدهشة','مصور النجوم','الشاعر الشهير');
                    $argent = array('2 حسابات مصرفية مع الملايين من الدولارات','000 000 2 دولار في السنة','000 500 2 دولار في السنة','المالك من 3 منازل مؤقتة','مليونير. المالك من 5 فلل كبيرة. ');
                    $accomplissement = array('الدكتوراه','إنشاء الشركة الخاصة بك','مساعدة العديد من الجمعيات الخيرية','صاحب العلامة التجارية للسيارات الكبرى','صديق المشاهير','مالك ملهى ليلي براقة');
          }
          else{
                    $amour = array('زوجت','عروس، طفلان','العروس، 3 أطفال','العروس، 2 التوائم','العروس، 1 طفل');
                    $carriere = array('امن','وكيل ستار','مدونة فيديو مشهورة','مصور النجوم','الشاعر الشهير');
                    $argent = array('2 حسابات مصرفية مع الملايين من الدولارات','000 000 2 دولار في السنة','000 500 2 دولار في السنة','المالك من 3 منازل مؤقتة','مليونير. المالك من 5 فلل كبيرة. ');
                    $accomplissement = array('الدكتوراه','إنشاء الشركة الخاصة بك','مساعدة العديد من الجمعيات الخيرية','صاحب العلامة التجارية للسيارات الكبرى','صديق المشاهير','مالك ملهى ليلي براقة');
...
<div class="texte box" id="box_heart"> حب </div>
...
<div class="texte box" id="box_job"> مهنة </div>
...
<div class="texte box" id="box_money"> مال </div>
...
<div class="texte box" id="box_done"> إنجاز </div>
