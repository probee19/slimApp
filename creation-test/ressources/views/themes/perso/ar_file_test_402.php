...
<div class="texte" id="texte1"><?php echo $_GET['اسم المستخدم']; ?> <br> أتمنى لك السعادة</div>

<div class="texte" id="texte2">عيد الاستقلال</div>

<div class="texte" id="texte3">جمهورية الكونغو</div>
