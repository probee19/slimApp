...
<?php
      if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
               $message = array('Ella ya está a tu lado','Ya estás saliendo con ella','Ya vives con ella');          }
            else{ 
              $message = array('Él ya está a tu lado','Ya estás saliendo con él','Ya vives con él');
            }
