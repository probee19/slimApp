...
<div class="texte" id="texte_top">Wer folgt mir im Verborgenen? </div>
...
<div class="texte" id="paragraphe"><?php echo urldecode($_GET['user_name']); ?>, <?php echo urldecode($_GET['friend_first_name_1']); ?> Folge dir im Verborgenen! </div>
