...
<?php
      if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
               $type = array('Du bist ein echter Marseillais','Ein echter Fanatiker');
               $message = array('Sie sind mit Ihrer Mannschaft im Sieg wie in der Niederlage','Hier ist Marseille','Für immer zuerst','Keine Gnade für das Clasico');          }
            else{ 
               $type = array('Du bist ein echter Marseillaise','Ein echter Fanatiker');
              $message = array('Sie sind mit Ihrer Mannschaft im Sieg wie in der Niederlage','Hier ist Marseille','Für immer zuerst','Keine Gnade für das Clasico'); 
            }
