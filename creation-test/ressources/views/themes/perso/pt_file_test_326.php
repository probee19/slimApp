...
<div class="texte" id="head"> Quantas pessoas visitaram seu perfil hoje? </div>
...
<div class="texte" id="visite">
          ...
          <div class="texte" id="compteur"> <?=mt_rand(75,204)?> <div class="texte" id="lab_compteur"> visitas</div> </div>
</div>
