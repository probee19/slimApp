...
<?php
$message_1 = array('Quem tem roupas de bebê?<br> Estamos esperando geminhas !!! :)', 'Mamãe, pai, lamento anunciar que você será avô!');
$message_2 = array('O que !!!!:)','Suspeitava de algo! <3 Parabéns!');
$message_3 = array('Parabéns para você 2 !!! eu não posso acreditar nisso','É bom, está confirmado? Você fará pais maravilhosos!');
$date = array('22 de dezembro às 22:53','11 de março às 8:03 pm','13 de junho às 21:43');shuffle($date);
