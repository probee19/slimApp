...
<?php
          $qualites = array('amabile','piacevole','socievole','degno','modesto','efficace','integrato','divertente');
          $defauts = array('troppo sensibile',' tropamabile');
...
<div class="back" id="back_blue" > Migliore qualità : <span class="res" id="qualite"><?=$qualites[0]?></span></div>
<div class="back" id="back_red" > Peggior difetto : <span class="res" id="defaut"><?=$defauts[0]?></span></div> 
