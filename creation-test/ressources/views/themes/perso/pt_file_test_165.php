...
.result{font-size:43px; margin-top:0px;font-family: 'Acme', sans-serif; color:#FFF; width:100%; }
 ...
 <?php
                $aime = array('rir','sua cama','seus amigos','a música');
                $couleur = array('azul', 'vermelho', 'verde','Branco','laranja');
                $force = array('sorriso mágico','a simplicidade','generosidade','seu personagem','seu coração');
                $deteste = array('A mentira','seu despertador','A traição','tráfego','os snobs');
                $personnalite = array('admirável','criativo','determinado');
                $tondefaut = array('sensível','perfeccionista');
...
<div id="aime"><span class="titre_rubrique">Você gosta</span><div class="result"><?php echo $nature[0] ?><?php echo $aime[0] ?></div></div>
<div id="couleur"><span class="titre_rubrique">Cor</span><div class="result" style="font-size:30px"><?php echo $couleur[0] ?></div></div>
<div id="force"><span class="titre_rubrique">Sua força</span><div class="result"><?php echo $force[0] ?> </div></div>
<div id="deteste"><span class="titre_rubrique">Você odeia</span><div class="result"><?php echo $deteste[0] ?></div></div>
<div id="personnalite"><span class="titre_rubrique">Personalidade</span><div class="result" style="font-size:30px"><?php echo $personnalite[0] ?></div></div>
<div id="defaut"><span class="titre_rubrique">Sua culpa</span><div class="result"><?php echo $tondefaut[0] ?></div></div>
