...
<div class="texte" id="phrase"> <span class="name"><?php echo $_GET['friend_first_name_1']; ?></span> looked at the pictures of <span class="name"><?php echo $_GET['user_name']; ?></span> <?php echo mt_rand(20,37);  ?>today </div>
