...
if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
          $lois = array('{؟ user_name؟} هو رئيس الأركان.',
          'حتى 31 مايو 2020، {؟ friend_first_name_1؟} هل سيتعين عليك دفع {؟ User_name؟} إيجار. ',
          '{؟ user_name؟} كبير جدا، فأمر بأن يتلقى عرض ترويجي.',
          'أوافق على أن راتب {؟ اسم المستخدم؟} يتم مضاعفة.',
          'أعلن هذا العيد تكريما ل {؟ اسم المستخدم؟}.');
else 
       $lois = array('{؟ user_name؟} هو رئيس الأركان',
          'حتى 31 مايو 2020، {؟ friend_first_name_1؟} هل سيتعين عليك دفع {؟ User_name؟} إيجار. ',
          '{؟ user_name؟} رائع جدا، فأمرها بتلقي عرض ترويجي.',
          'أوافق على أن راتب {؟ اسم المستخدم؟} يتم مضاعفة.',
          'أعلن هذا العيد تكريما ل {؟ اسم المستخدم؟}.');   
