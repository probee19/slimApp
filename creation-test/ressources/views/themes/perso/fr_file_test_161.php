...
<div class="texte" id="titre_top">Qui a regardé tes albums photo Facebook? </div>
...
<div class="texte" id="phrase"> <span class="name"><?php echo urldecode($_GET['friend_first_name_1']); ?></span> a regardé les photos de <span class="name"><?php echo urldecode($_GET['user_name']); ?></span> <?php echo mt_rand(20,37);  ?>fois aujourd&#39;hui </div>
