...
<div class="texte" id="phrase"> <span class="name"><?php echo urldecode($_GET['friend_first_name_1']); ?></span> miró las fotos de <span class="name"><?php echo urldecode($_GET['user_name']); ?></span> <?php echo mt_rand(20,37);  ?>hoy </div>
