...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
                    ...
                    $details = array('You are a true vigilante and capable of everything to protect yours.','You are loved, respected and able to keep secrets that threaten the stability of your country.',
                    'You are a formidable fighter with extraordinary intelligence','','You are a high level scientist and you possess superhuman strength and endurance',
                    'You are a great leader and you have superhuman abilities.','You are a faithful advisor, a man of trust.');
                    $ind = mt_rand(0,6);
          }
          else{
                    $personnages = array('Ramonda','Nakia','Okoye','Shuri');
                    $images = array('1519662856','1519662954','1519663017','1519663589');
                    $details = array('You are a discreet counselor, a queen mother.',
                    'You are a true warrior capable of leading any mission to liberate the oppressed.','You are a loyal and dedicated general.',
                    'You are a princess, a genius capable of being responsible for several technological innovations.');
                    $ind = mt_rand(0,3);
          }
