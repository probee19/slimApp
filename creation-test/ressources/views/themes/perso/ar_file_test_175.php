...
<?php
$texte = array('أنت شخص من الجمال المثالي، يمكنك وضع أي شخص في جيبك','نجاح باهر مع هذا الجمال الرائع لديك، والجميع يبحثون عنك!','نحن نتحدث فقط عنك! لديك جمال غير عادي!');
$score = array('11','12','10');
$k = mt_rand(0,2);
?>
<div class="texte" id="top"> <?php echo urldecode($_GET['user_name']); ?> هذا هو سكور الخاص بك! </div>
