...
.result{font-size:43px; margin-top:0px;font-family: 'Acme', sans-serif; color:#FFF; width:100%; }
 ...
 <?php
                $aime = array('rire','ton lit','tes amis','la musique');
                $couleur = array('bleu', 'rouge', 'vert','blanc','Orange');
                $force = array('sourire magique','la simplicité','générosité','ton caractère','ton coeur');
                $deteste = array('le mensonge','ton réveil','La trahison','le trafic','les snobs');
                $personnalite = array('admirable','Créatif','l&#39;engagement');
                $tondefaut = array('sensible','perfectionniste');
...
<div id="aime"><span class="titre_rubrique">Tu aimes</span><div class="result"><?php echo $nature[0] ?><?php echo $aime[0] ?></div></div>
<div id="couleur"><span class="titre_rubrique">Couleur</span><div class="result" style="font-size:30px"><?php echo $couleur[0] ?></div></div>
<div id="force"><span class="titre_rubrique">Ta force</span><div class="result"><?php echo $force[0] ?> </div></div>
<div id="deteste"><span class="titre_rubrique">Tu détestes</span><div class="result"><?php echo $deteste[0] ?></div></div>
<div id="personnalite"><span class="titre_rubrique">Personnalité</span><div class="result" style="font-size:30px"><?php echo $personnalite[0] ?></div></div>
<div id="defaut"><span class="titre_rubrique">Ton défaut</span><div class="result"><?php echo $tondefaut[0] ?></div></div>
