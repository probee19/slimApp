...
#message{z-index:1; position: absolute; font-family: 'Exo 2', sans-serif; text-transform:uppercase; left: 10px; bottom: 100px; color:#f1c40f; font-size:35px; line-height:45px; width:420px ; height:200px ; display:flex; align-items:center; justify-content:center; text-align:center; }
