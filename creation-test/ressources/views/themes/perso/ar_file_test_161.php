...
<div class="texte" id="titre_top">الذي بدا في الفيسبوك الخاص بك ألبومات الصور؟ </div>
...
<div class="texte" id="phrase"> <span class="name"><?php echo urldecode($_GET['friend_first_name_1']); ?></span> نظرت إلى الصور <span class="name"><?php echo urldecode($_GET['user_name']); ?></span> <?php echo mt_rand(20,37);  ?>اليوم </div>
