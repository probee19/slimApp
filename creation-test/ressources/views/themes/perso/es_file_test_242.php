...
<?php
          $actions = array('mudarse con usted','llorar cada momento','roba tu computadora','roba toda la comida en tu refrigerador','involucra a Derrick para encontrarte',
          'cuida a tu familia','robar toda tu ropa','obtener su cuenta bancaria');
          shuffle($actions);
