...
<?php
  if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
            $texte = array('Du würdest alles für deine Freunde tun','Dein Charme ist fatal','Du liebst leidenschaftlich','Leute sollten dich nicht unterschätzen','Du hasst Ungerechtigkeiten','Du bist stärker als es scheint','Nichts kann deinen Geist brechen','Dein Vertrauen in dich ist unerschütterlich','Du bist mutiger als du denkst');
  }
            else{ 
          $texte = array('Du würdest alles für deine Freunde tun','Dein Charme ist fatal','Du liebst leidenschaftlich','Leute sollten dich nicht unterschätzen','Du hasst Ungerechtigkeiten','Du bist stärker als es scheint','Nichts kann deinen Geist brechen','Dein Vertrauen in dich ist unerschütterlich','Du bist mutiger als du denkst');
  }
...
<div id="titretest" >Die <span style=\"color:#EFA200\">5 WAHRHEITEN</span> 2017 über Sie entdeckt<br> <?php echo urldecode($_GET['full_user_name']); ?> 
         </div>
