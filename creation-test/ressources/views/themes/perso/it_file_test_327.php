...
<?php
          $couleurs = array('giallo','verde','bianca','rosso','blu');
          $aimes = array('abbracci','viaggio','lettura','vacanze','la musica','dormire');
          $detestes = array('La bugia','ipocrisia','il tradimento','ritardi');
          $forces = array('saggezza','coraggio','generosità','sorriso piacevole','grande cuore','umorismo');
          $faiblesses = array('sensibile','perfezionista');
...
<div class="texte bloc" id="bloc1"><span class="title">Colore</span><span class="body"><?=ucfirst($couleurs[0])?></span></div>
<div class="texte bloc" id="bloc2"><span class="title">Ti piace</span><span class="body"><?=$aimes[0]?></span></div>
<div class="texte bloc" id="bloc3"><span class="title">Tu odi</span><span class="body"><?=$detestes[0]?></span></div>
<div class="texte bloc" id="bloc4"><span class="title">La tua forza</span><span class="body"><?=ucfirst($forces[0])?></span></div>
<div class="texte bloc" id="bloc5"><span class="title">La tua debolezza</span><span class="body"><?=ucfirst($faiblesses[0])?></span></div>
