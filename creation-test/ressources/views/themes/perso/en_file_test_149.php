...
<div class="name texte" id="name_user" ><?php echo urldecode($_GET['user_name']); ?>, you&#39;re going to have <span style="color:#C03A2B; font-weight:normal; font-size:40px; ">
          <?php echo rand(5,35) ?></span> relationships in your life!<br><br><span>Precision <?php echo rand(95,99) ?>.<?php echo rand(1,9) ?>%</span></div>
