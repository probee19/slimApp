...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin'){
                    $personnalites = array('زعيم','قوي','مبتكر','موح','فنان مبدع','مغامر');
                    $adore = array('المفاجآت','لتضحك','السفر','تعلم');
                    $deteste = array('نميمة','قسوة','كذابين','غير مخلص');
                    $animaux = array('أسد','نمر','فهد','ظبي','الفهد');
                    $forces = array('صادق على 100٪','مقنع','واثق من نفسه');
                    $faiblesses = array('أعط الكثير','هو أيضا فهم');
          }
          else{
                    $personnalites = array('زعيم','قوي','مبتكر','موح','فنان مبدع','المغامرة');
                    $adore = array('المفاجآت','لتضحك','السفر','تعلم');
                    $deteste = array('نميمة','قسوة','Les menteurs','Les infidèles');
                    $animaux = array('أسد','نمر','فهد','ظبي','الفهد');
                    $forces = array('صادق على 100٪','التعاطف','مقنع','واثق من نفسه');
                    $faiblesses = array('أعط الكثير','هو أيضا فهم');
          }
...
<div class="texte" id="header_t"> الحقائق الستة التي تلخص حياتك: </div>

<div class="texte" id="verite1"> <span class="title_block">أنت تعشق</span> <span class="content_block"> <?=$adore[0]; ?> </span> </div>
<div class="texte" id="verite2"> <span class="title_block">أنت تكره</span> <span class="content_block"> <?=$deteste[0]; ?> </span> </div>
<div class="texte" id="verite3"> <span class="title_block">حيوانك الروحي</span> <span class="content_block"> <?=$animaux[0]; ?> </span> </div>
<div class="texte" id="verite4"> <span class="title_block">الشخصية</span> <span class="content_block"> <?=$personnalites[0]; ?> </span> </div>
<div class="texte" id="verite5"> <span class="title_block">قوة</span> <span class="content_block"> <?=$forces[0]; ?> </span> </div>
<div class="texte" id="verite6"> <span class="title_block">ضعف</span> <span class="content_block"> <?=$faiblesses[0]; ?> </span> </div>
