...
<?php
      if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
               $message = array(' Elle est déjà à tes côtés. ',' Tu partages déjà ta vie avec Elle. ',' Elle a toujours été à tes côtés et le restera .');          }
            else{ 
               $message = array(' Il est déjà à tes côtés. ',' Tu partages déjà ta vie avec Lui. ',' Il a toujours été à tes côtés et le restera. ');     
            }
