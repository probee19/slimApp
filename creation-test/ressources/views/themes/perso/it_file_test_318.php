...
<?php
          $pour = array('per i suoi eccellenti servizi di guardia del corpo','per le sue capacità di recitazione','per i bagni dà ai leoni','per il suo talento comico');
          $en = array('in riconoscimento del suo supporto e protezione in ogni momento','in riconoscimento della sua personalità che rende il mondo un po \'meno noioso','in riconoscimento dei bagni che riesce a dare ai leoni senza alcun incidente','in riconoscimento del suo umorismo che regala il sorriso a tutti');
          $ind = mt_rand(0,3);
?>
<!DOCTYPE HTML>
...
<div class="texte" id="header_t"> Certificato di successo </div>
