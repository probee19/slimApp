...
<?php
          $positions = array('marcatore');
          $roles = array('Capo','Eroe','Capitano');
          $forces = array('Non perdere mai!','Lavoro duro!','Spirito di squadra !');
          $faiblesses = array('altruistico','Capisce troppo');
          $tactiques = array('Cerca e distruggi!','Segna e festeggia!');
          $devises = array('La vita non è vincere ma non perdere!','Il migliore dei tuoi giocatori è il peggiore dei miei!');
...
<div class="texte label_r" id="position"> Posizione : </div>
<div class="texte label_r" id="role"> Ruolo : </div>
<div class="texte label_r" id="force"> Forza : </div>
<div class="texte label_r" id="faiblesse"> Debolezza : </div>
<div class="texte label_r" id="tactique"> Tattico : </div>
