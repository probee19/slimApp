...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
                   $sis = array(' Retiens le, il faut l\'épouser. ',' Ne le laisse pas partir, il est bienveillant. ',' Retiens le, il est protecteur. ',' Retiens le, il est un mari parfait. '
                    ,' Retiens le, il est fidèle. ',' Retiens le, il est galant.  ');
          else
                   $sis = array(' Ne la laisse pas partir, il faut l\'épouser. ',' Retiens la, elle est bienveillante. ',' Ne la laisse pas partir, elle est une épouse parfaite. '
                    ,' Retiens la, elle est fidèle et loyale. ',' Retiens la, elle fera une bonne mère.  ');
          shuffle($sis);
?>

<div class="texte" id="sis_1">  Si son prénom est  </div>
