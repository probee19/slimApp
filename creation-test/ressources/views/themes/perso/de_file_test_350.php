...
#fb_id_user{position: absolute; z-index:1; left: -60px; top: 0px; width:420px ;  height:420px ; object-fit: cover; object-position: 50% 10%; border-radius:0px; max-width:800px; max-height:420px;}
.back{position:absolute;font-family: 'Satisfy', cursive; font-size:35px; line-height:35px; color:#FFF; z-index:1; right: 0;  width:490px; height:85px;}
#back_blue{top: 336px; background:#2962FF; } 
...
#back_red{top: 252px; background:#C51162; }
#back_red .triangle{border-right: 40px solid #C51162 ;}
#back_grey{top: 168px; background:#1B5E20; }
#back_grey .triangle{border-right: 40px solid #1B5E20 ;}
#back_purple{top: 0; background:#4A148C; }
...
<?php
          $mots = array('Dein Herz funkelt vor Mut.','Du bist voller Energie.','Du kämpfst gegen Ungerechtigkeit.','Dein Leben besteht aus Ehrlichkeit.','Sie möchten das Lächeln verbreiten.','Du hast einen humorvollen Charakter.','Sie teilen gerne.','Sie unterstützen keine Idioten.','Du hast keine Angst vor Veränderung.');
          shuffle($mots);
?>
<!DOCTYPE HTML> 
