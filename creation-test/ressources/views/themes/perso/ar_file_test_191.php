...
<?php
  if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
            $texte = array('{؟ اسم المستخدم؟} يريد الحفاظ على سمعة ممتازة','{؟ user_name؟} خالص وسخي ومخلص','{؟ user_name؟} لا يزال مستمرا لوعوده',
'{؟ user_name؟} لم يكشف سرا','{؟ اسم المستخدم؟} لا يريد أن يخيب أحباءه','
{؟ اسم المستخدم؟} هو المؤمنين في الحب كما الصداقة','{؟ user_name؟} غير قابلة للإصلاح','{؟ اسم المستخدم؟} يحب أن يرجى من يحب',
'{؟ user_name؟} لا يقول أبدا أشياء سيئة عن الآخرين','{؟ user_name؟} لم يخون أحدا أبدا', '{؟ user_name؟} يضع رغبات الآخرين قبل بلده');
  }
            else{ 
             $texte = array('{؟ اسم المستخدم؟} يريد الحفاظ على سمعة ممتازة','{؟ user_name؟} خالص وسخي ومخلص','{؟ user_name؟} لا يزال مستمرا لوعوده',
'{؟ user_name؟} لم يكشف سرا','{؟ اسم المستخدم؟} لا يريد أن يخيب أحباءه','
{؟ اسم المستخدم؟} هو المؤمنين في الحب كما الصداقة','{؟ user_name؟} غير قابلة للإصلاح','{؟ اسم المستخدم؟} يحب أن يرجى تلك تحب',
'{؟ user_name؟} لا يقول أبدا أشياء سيئة عن الآخرين','{؟ user_name؟} لم يخون أحدا أبدا', '{؟ user_name؟} يضع رغبات الآخرين قبل بلده');
