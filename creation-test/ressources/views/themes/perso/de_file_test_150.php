...
<div class="name texte" id="position1_name_friend_1" ><?php echo $_GET['friend_name_1']; ?> <span>gerade jetzt</span></div>
<div  id="message1" ><?php echo $message_1[$key]; ?></div>
<div class="name texte" id="position2_name_friend_1" ><?php echo $_GET['friend_name_1']; ?> <span>vor 4 Minuten</span></div>
<div  id="message2" ><?php echo $message_2[$key]; ?></div>
<div class="name texte" id="position3_name_friend_1" ><?php echo $_GET['friend_name_1']; ?> <span>Vor 6 Minuten</span></div>
