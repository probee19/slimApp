          ...
          <div class='main'>
            ...
            <?php
                $nature = array('gioioso','contento');
                $personnalite = array('St.', 'credente', 'grave');
                $aime = array('Modestia','La semplicità');
                $deteste = array('La bugia','Imbrogliare','Il tradimento');
                $force = array('Motivazione','Il potere','i soldi');
            ...
            <span id="titre" class="titre"> Qual è la tua personalità <?php echo urldecode($_GET['user_name']); ?>?</span>
            ...
            <span id="texte_1" class="texte"> <b>Natura:</b> <?php echo $nature[0] ?></span>
            <span id="texte_2" class="texte"> <b> Personalità:</b> <?php echo $personnalite[0] ?></span>
            <span id="texte_3" class="texte"> <b>Amore :</b> <?php echo $aime[0] ?></span>
            <span id="texte_4" class="texte"> <b> Odiare:</b> <?php echo $deteste[0] ?></span>
            <span id="texte_5" class="texte"> <b> Forza :</b> <?php echo $force[0] ?></span>
            <span id="texte_6" class="texte"> <b> Debolezza</b> <?php echo $faiblesse[0] ?></span>
