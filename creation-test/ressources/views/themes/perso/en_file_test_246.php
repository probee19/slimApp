...
<?php
          ...
          $background = $background_eden; $verdict = "PARADISE"; $color1 = '#1A237E'; $color2 = '#fff';
...
<div class="notes" style="color:<?php echo $color1;?>; background:<?php echo $bg_color;?>">
          ...
          <div id="good">Good actions : <?php echo number_format($action); ?> </div>
          <div id="bad">Sins: <?php echo number_format($peches); ?></div>
          <div id="kindness">Kindness: <?php echo $gentillesse; ?> %</div>
</div>

<div class="decision" style="color:<?php echo $color2;?>; background:<?php echo $bg_color;?>">
         Final decision : <?php echo $verdict;?>
</div>
