...
<?php
          $qualites = array(' la sincèrité ',' la précision ',' la compétence ',' la gentillesse ',' le romantisme ', ' la fidélité ',' la bravoure ',' le courage ',' l\'honnêteté ',' la persévérance ',' la loyauté ',' le leadership ');
          shuffle($qualites);
?>
<!DOCTYPE HTML>
...
<div class="texte" id="header"> <?php echo urldecode($_GET['user_name']); ?>, d'après notre analyse approfondie, la qualité qui te décrit le mieux est :  </div>

<div class="texte" id="quality"><?=$qualites[0]?></div>

<div class="texte" id="footer">(  précis à <?=mt_rand(94,99)?>%  )</div
