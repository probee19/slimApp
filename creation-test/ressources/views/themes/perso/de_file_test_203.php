...
<?php
  if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
                     $texte = array('Du gibst immer mit dem Herzen','Du wirst niemals jemanden enttäuschen','Du brauchst niemanden','Sie haben die Sorge um das Detail',
                     'Du wirst niemals jemanden verletzen','Du hörst nicht vor nichts auf','Du würdest durch ein Feuer gehen, um deine Familie zu retten',
                     'Du hasst Ungerechtigkeit','Du gibst niemals Menschen auf','Ihre Loyalität ist narrensicher','Du lernst aus deinen Fehlern','Du passt immer auf deine Freunde auf','Du bist immer ehrlich zu Menschen');

  }
            else{ 
             $texte = array('glücklich','Führer','Ehrlich','Leistungsstark','Weise','Erfolg');
