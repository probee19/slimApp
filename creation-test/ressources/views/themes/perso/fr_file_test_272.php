...
<?php
      if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
               $message = array('Elle est déjà à tes côtés','Tu sors déjà avec elle','Tu vis déjà avec elle');          }
            else{ 
              $message = array('Il est déjà à tes côtés','Tu sors déjà avec lui','Tu vis déjà avec lui');
            }
