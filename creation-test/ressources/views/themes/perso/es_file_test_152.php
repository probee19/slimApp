          ...
          <div class='main'>
            ...
            <?php
                $apparence = array('carismático','maravilloso','majestuoso');
                $ame = array('Magnético', 'Adivinar', 'limpiar');
                $personnalite = array('hombre encantador','Reconocido','Humilde');
            ...
            <span id="titre" class="titre">¿Qué secretos se esconden detrás de tu foto de perfil?</span>
            ...
            <span id="texte_1" class="texte"> <b> Apariencia:</b> <?php echo $apparence[0] ?></span>
            <span id="texte_2" class="texte"> <b> Alma:</b> <?php echo $ame[0] ?></span>
            <span id="texte_3" class="texte"> <b> Personalidad:</b> <?php echo $personnalite[0] ?></span>
