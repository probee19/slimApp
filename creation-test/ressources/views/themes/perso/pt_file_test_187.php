...
<?php
 ...
 {
       $texte = array("Quando o dobramos em uma fila!","Quando o telefone não tem bateria!",
"Quando seu cabeleireiro faz desastres!", "Quando sua mãe o chama 10 vezes por dia!", "Quando um mosquito o impede de dormir"
,"Quando está chovendo e ele não tem um guarda-chuva!","Quando as pessoas estão falando atrás das costas dele!","Quando as pessoas sussurram no cinema!");    
 }
 else
 {
           $texte = array("Quando o dobramos em uma fila!","Quando o telefone não tem bateria!",
"Quando seu cabeleireiro faz desastres!", "Quando sua mãe o chama 10 vezes por dia!", "Quando um mosquito o impede de dormir"
,"Quando está chovendo e ela não tem guarda-chuva!","Quando as pessoas estão falando atrás das costas dele!","Quando as pessoas sussurram no cinema! ");
 }
...
<div id="titretest" >Quais são as 5 coisas que o <?php echo urldecode($_GET['user_name']); ?> odeiam mais?</div>
<div class="name texte" id="name_user" ></div>
