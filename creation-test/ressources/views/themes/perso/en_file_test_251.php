...
<?php
          $surprises = array('You will have a baby. '.$_GET[' User_name'].' &#39;S family will have a new treasure!', 
                    'Hard to choose '.$_GET[' User_name'].'. Many things will improve next year!',
                    'You will get a new perfect job that will perfectly meet your expectations!',
                    'You will have a professional promotion during this year',
                    'You will make a journey rich in experiences and discoveries!');
          shuffle($surprises);
?>
<!DOCTYPE HTML>
