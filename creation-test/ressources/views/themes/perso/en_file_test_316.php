...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin'){
                    $personnalites = array('Leader','strong','innovator','inspirer','Virtuoso','Adventurer');
                    $adore = array('The surprises','To laugh','Travel','Learn');
                    $deteste = array('Gossip','Cruelty','Liars','The unfaithful');
                    $animaux = array('Lion','Tiger','Leopard','Antelope','Cheetah');
                    $forces = array('Honest to 100%','Persuasive','autonomous');
                    $faiblesses = array('Give too much','Is too understanding');
          }
          else{
                    $personnalites = array('Leader','Strong','innovative','inspirer','Virtuoso','adventuress');
                    $adore = array('The surprises','To laugh','Travel','Learn');
                    $deteste = array('Gossip','Cruelty','Les menteurs','Les infidèles');
                    $animaux = array('Lion','Tiger','Leopard','Antelope','Cheetah');
                    $forces = array('Honest to 100%','Empathize','persuasive','autonomous');
                    $faiblesses = array('Give too much','Is too understanding');
          }
...
<div class="texte" id="header_t"> The 6 truths that summarize your life: </div>

<div class="texte" id="verite1"> <span class="title_block">You adore</span> <span class="content_block"> <?=$adore[0]; ?> </span> </div>
<div class="texte" id="verite2"> <span class="title_block">You hate</span> <span class="content_block"> <?=$deteste[0]; ?> </span> </div>
<div class="texte" id="verite3"> <span class="title_block">Your spiritual animal</span> <span class="content_block"> <?=$animaux[0]; ?> </span> </div>
<div class="texte" id="verite4"> <span class="title_block">Personality</span> <span class="content_block"> <?=$personnalites[0]; ?> </span> </div>
<div class="texte" id="verite5"> <span class="title_block">Strength</span> <span class="content_block"> <?=$forces[0]; ?> </span> </div>
<div class="texte" id="verite6"> <span class="title_block">Weakness</span> <span class="content_block"> <?=$faiblesses[0]; ?> </span> </div>
