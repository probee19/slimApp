...
<?php
          $significations = array(' confiance ',' loyauté ',' paix ',' prosperité ',' bravoure ',' courage ',' dignité ',' bienveillance ',' force ');
...
<div class="texte" id="texte1">  100% de sang royal  </div>
<div class="texte" id="texte2">  signifie  </div>
<div class="texte" id="texte3"> <?=$significations[0]?>  et  <?=$significations[1]?> </div>
