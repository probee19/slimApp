...
<?php
          ...
          $background = $background_eden; $verdict = "PARADIES"; $color1 = '#1A237E'; $color2 = '#fff';
...
<div class="notes" style="color:<?php echo $color1;?>; background:<?php echo $bg_color;?>">
          <div id="nom">Name: <?php echo urldecode($_GET['user_name']); ?></div>
          <div id="good">Gute Taten: <?php echo number_format($action); ?> </div>
          <div id="bad">Sünden: <?php echo number_format($peches); ?></div>
          <div id="kindness">Freundlichkeit: <?php echo $gentillesse; ?> %</div>
</div>

<div class="decision" style="color:<?php echo $color2;?>; background:<?php echo $bg_color;?>">
         Endgültige Entscheidung : <?php echo $verdict;?>
</div>
