...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin'){
                    $personnalites = array('Líder','fuerte','innovador','inspirador','Virtuoso','Aventurero');
                    $adore = array('Las sorpresas','Para reír','Viajar','Aprender');
                    $deteste = array('Chisme','Crueldad','Mentirosos','Los infieles');
                    $animaux = array('León','Tigre','Leopardoo','Antílope','Leopardoo cazador');
                    $forces = array('Honesto al 100%','Persuasivo','autónomo');
                    $faiblesses = array('Dar demasiado','Es muy comprensivo');
          }
          else{
                    $personnalites = array('Líder','Fuerte','innovador','inspirador','Virtuoso','aventurera');
                    $adore = array('Las sorpresas','Para reír','Viajar','Aprender');
                    $deteste = array('Chisme','Crueldad','Les menteurs','Les infidèles');
                    $animaux = array('León','Tigre','Leopardoo','Antílope','Leopardoo cazador');
                    $forces = array('Honesto al 100%','Empatizarse','persuasivo','autónomo');
                    $faiblesses = array('Dar demasiado','Es muy comprensivo');
          }
...
<div class="texte" id="header_t"> Las 6 verdades que resumen tu vida: </div>

<div class="texte" id="verite1"> <span class="title_block">Tú adoras</span> <span class="content_block"> <?=$adore[0]; ?> </span> </div>
<div class="texte" id="verite2"> <span class="title_block">Tu odias</span> <span class="content_block"> <?=$deteste[0]; ?> </span> </div>
<div class="texte" id="verite3"> <span class="title_block">Tu animal espiritual</span> <span class="content_block"> <?=$animaux[0]; ?> </span> </div>
<div class="texte" id="verite4"> <span class="title_block">Personalidad</span> <span class="content_block"> <?=$personnalites[0]; ?> </span> </div>
<div class="texte" id="verite5"> <span class="title_block">Fuerza</span> <span class="content_block"> <?=$forces[0]; ?> </span> </div>
<div class="texte" id="verite6"> <span class="title_block">Debilidad</span> <span class="content_block"> <?=$faiblesses[0]; ?> </span> </div>
