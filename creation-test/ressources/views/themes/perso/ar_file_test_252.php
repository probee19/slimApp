...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
                    $attentes = array('{؟ user_name؟}، 2018 سيكون واحدا من أفضل السنوات! كنت دائما موجودة لأحبائك وسوف تكون مليئة المكافآت.',
                              '{؟ user_name؟}، لقد قدمت الكثير من التضحيات حتى الآن. 2018 سيكون عاما من إنجاز جميع المشاريع الخاصة بك. سنة من السعادة بالنسبة لك.',
                              '{؟ اسم المستخدم؟}، أحبائك فخورون حقا بك هذا العام. 2018 سيكون لك سنة متلألئة من السعادة، والنكتة المتفجرة وصحة متألق.');
          else
                     $attentes = array('{؟ user_name؟}، 2018 سيكون واحدا من أفضل السنوات! كنت دائما موجودة لأحبائك وسوف تكون مليئة المكافآت.',
                              '{؟ user_name؟}، لقد قدمت الكثير من التضحيات حتى الآن. 2018 سيكون عاما من إنجاز جميع المشاريع الخاصة بك. سنة من السعادة بالنسبة لك.',
                              '{؟ اسم المستخدم؟}، أحبائك فخورون حقا بك هذا العام. 2018 سيكون لك سنة متلألئة من السعادة، والنكتة المتفجرة وصحة متألق.');
