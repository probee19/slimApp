...
<?php
      if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
               $message = array('Sie ist schon an deiner Seite.','Du teilst dein Leben schon mit ihr.','Sie war immer an Ihrer Seite und wird es auch bleiben.');          }
            else{ 
               $message = array('Er ist schon an deiner Seite.','Du teilst dein Leben bereits mit Ihm.','Er war immer an deiner Seite und wird es auch bleiben.');     
            }
