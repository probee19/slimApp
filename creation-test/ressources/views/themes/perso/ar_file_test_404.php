...
<?php 
          $messages = array('التضامن مع إخواننا الإيطاليين. انتقلت الأفكار للضحايا وأحبائهم.','تضامن كامل مع الضحايا وعائلاتهم وكل أصدقائنا الإيطاليين ...',
          'أفكاري الأكثر حزنا للشعب الإيطالي بعد كارثة جنوة.');
          shuffle($messages);
?>
<!DOCTYPE HTML>
