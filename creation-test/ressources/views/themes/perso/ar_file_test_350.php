...
<?php
          $mots = array('قلبك يتألق بشجاعة.','أنت مليء بالطاقة.','أنت تحارب الظلم.','حياتك مصنوعة من الصدق.','أنت تحب أن تنشر الابتسامة.','لديك شخصية روح الدعابة.','أنت تحب المشاركة.','أنت لا تدعم البلهاء.','أنت لست خائفا من التغيير.');
          shuffle($mots);
?>
<!DOCTYPE HTML> 
