...
<?php
          $surprises = array('tendrá un nuevo trabajo.', 'tendrá un aumento.', 'se casará.', 'tendrá un nuevo hijo.', 'hará una reunión que cambiará su vida.', 'se involucrará.');
...
<div id="texte_surprise" >Durante el año 2018, <?php echo urldecode($_GET['user_name']); ?> <?php echo $surprises[$index]; ?></div>
