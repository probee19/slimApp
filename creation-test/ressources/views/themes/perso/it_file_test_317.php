...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin'){
                    $mots_1 = array('Mai','Sempre','Sempre','Non','grande','Vero','Sempre');
                    $mots_2 = array('Stanco','Pronto','amabile','muto','Cuore','Capo','Sorridente');
          }
          else{
                    $mots_1 = array('Mai','Sempre','Sempre','Non','grande','Vero','Sempre');
                    $mots_2 = array('stanco','pronto','amabile','muto','Cuore','capo','sorridente');
...
<div class="texte" id="header_t"> Quali sono le due parole che meglio descrivono la tua personalità? </div>
