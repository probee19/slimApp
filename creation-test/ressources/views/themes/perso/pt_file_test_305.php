...
$message = array('Bravo','Admirável','Adorável','Honesto','Estável','Tender','Único','Voluntário','excelente','Boa','Heróico');  
shuffle($message);

?>
<div id="message0"> <?php echo ''.$_GET['user_name'].'' ?></div>
<div id="message"> <?php echo 'Sua melhor qualidade:<br>- '.$message[0].' -'; ?></div>
