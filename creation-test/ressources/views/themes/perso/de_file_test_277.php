...
<?php
           if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
                  $results = array('Lustige Videos auf Youtube ansehen','Eine gute Zeit vor dem Spiel PSG Real Madrid FC','Wir feiern PSGs Sieg gegen Real Madrid','Wir feiern Real Madrids Sieg gegen PSG',
          'Ein hübsches Mädchen küssen','Im romantischen Abendessen', 'Zählen Sie Ihr Geld','Besuche bei Freunden');
           }
           else{
                  $results = array('Lustige Videos auf Youtube ansehen','Wir feiern PSGs Sieg gegen Real Madrid','Wir feiern Real Madrids Sieg gegen PSG',
          'Einen netten Kerl küssen','Im romantischen Abendessen', 'Zählen Sie Ihr Geld','Freundinnen besuchen');
           }
           shuffle($results);
