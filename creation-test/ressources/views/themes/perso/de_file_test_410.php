...
<?php
 $qualites = array('seine Loyalität','seine Ehrlichkeit','seine Aufrichtigkeit','sein Franchise','seine Treue', 'seine Authentizität','seine Geduld','sein Mut', 'seine Sensibilität','seine Großzügigkeit','seine Weisheit');
 shuffle($qualites);
?>
<!DOCTYPE HTML>
...
<div class="texte qualites" id="qualites_entete">Die zwei größten Eigenschaften von <?php echo $_GET['user_name']; ?>:</div>
