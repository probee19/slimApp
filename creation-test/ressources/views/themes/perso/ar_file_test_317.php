...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin'){
                    $mots_1 = array('أبدا','دائما','دائما','ليس','عظيم','صحيح','دائما');
                    $mots_2 = array('متعبه','جاهز','ودي','أبكم','قلب','زعيم','باسم');
          }
          else{
                    $mots_1 = array('أبدا','دائما','دائما','ليس','عظيم','صحيح','دائما');
                    $mots_2 = array('متعبه','جاهز','ودي','أبكم','قلب','زعيم','باسم');
...
<div class="texte" id="header_t"> ما هي الكلمتين اللتين تصفان شخصيتك على أفضل وجه؟ </div>
