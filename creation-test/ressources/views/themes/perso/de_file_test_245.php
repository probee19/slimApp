...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
                    $mots = array('sinnlich','robust','ernst','Magnet','kreativ','charismatisch','stark','schützend','nett','polyvalent','unterhaltsam','dankbar','charmant','schmeckt','komisch'  );
         else
                    $mots = array('sinnlich','robust','ernst','Magnetic','kreativ','charismatisch','stark','Beschützerin','sanft','vielseitig','unterhaltsam','dankbar','schön','schmeckt','komisch'  );
          shuffle($mots);
?>
<!DOCTYPE HTML>
