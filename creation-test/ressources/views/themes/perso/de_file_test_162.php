...
<?php
$message = array('Du denkst an andere, bevor du an dich selbst denkst','Du vertraust Menschen immer','Sie hinterfragen manchmal Ihre Entscheidungen zu sehr',
'Du lässt die Leute deine Freundlichkeit missbrauchen');
shuffle($message);
?>
