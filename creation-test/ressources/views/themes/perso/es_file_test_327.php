...
<?php
          $couleurs = array('amarillo','verde','Blanco','rojo','azul');
          $aimes = array('abrazos','viaje','leyendo','vacaciones','la música','dormir');
          $detestes = array('La mentira','hipocresía','la traición','retrasos');
          $forces = array('sabiduría','valor','generosidad','sonrisa agradable','Gran corazón','humor');
          $faiblesses = array('sensible','perfeccionista');
...
<div class="texte bloc" id="bloc2"><span class="title">Te gusta</span><span class="body"><?=$aimes[0]?></span></div>
<div class="texte bloc" id="bloc3"><span class="title">Tu odias</span><span class="body"><?=$detestes[0]?></span></div>
<div class="texte bloc" id="bloc4"><span class="title">Tu fuerza</span><span class="body"><?=ucfirst($forces[0])?></span></div>
<div class="texte bloc" id="bloc5"><span class="title">Tu debilidad</span><span class="body"><?=ucfirst($faiblesses[0])?></span></div>
