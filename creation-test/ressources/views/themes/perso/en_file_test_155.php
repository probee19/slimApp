          ...
          <div class='main'>
            ...
            <?php
                $don = array('Your loyalty','Your Honesty','Your tender heart','Your natural charm','Your Faith','Your kindness','Your compassion','Your perseverance');
                shuffle($don);
            ?>
            <img src="http://creation.funizi.com/images-theme-perso/1508587038.jpg" id="background">
            <span id="titre" class="titre">What gift did you receive from God?</span>
