...
<?php
          $couleurs = array('yellow','green','White','red','blue');
          $aimes = array('hugs','travel','reading','holidays','the music','to sleep');
          $detestes = array('The lie','hypocrisy','the treason','delays');
          $forces = array('wisdom','courage','generosity','pleasant smile','big heart','humor');
          $faiblesses = array('sensitive','perfectionist');
...
<div class="texte bloc" id="bloc3"><span class="title">You hate</span><span class="body"><?=$detestes[0]?></span></div>
<div class="texte bloc" id="bloc4"><span class="title">Your strength</span><span class="body"><?=ucfirst($forces[0])?></span></div>
<div class="texte bloc" id="bloc5"><span class="title">Your weakness</span><span class="body"><?=ucfirst($faiblesses[0])?></span></div>
