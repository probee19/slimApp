...
<?php
 $nom_explication = array('honestidad','sinceridad','amor','franquicia','lealtad', 'autenticidad','paciencia','valor', 'sensibilidad','generosidad','sabiduría');
...
<div>=</div><div style="color:#FFF"><?php echo strtoupper ($nom_explication[0]) ?></div><div style="color:#FFF; font-size:20px;">pero también</div> <div style="color:#FFF"><?php echo strtoupper ($nom_explication[1]) ?></div>
</div>
</div>
