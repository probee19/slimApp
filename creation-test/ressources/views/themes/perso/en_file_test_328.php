...
<?php
          $philosophie = array('Time is precious, I must not lose it for futility. I focus all the time on the essentials.',
          'Happiness is in those little moments that life offers us. I enjoy every moment with my family, friends and colleagues.',
          'Celebrity or wealth are not important. What is important is a life without stress, without worries and filled with happiness.',
          'I do not regret any knowledge in life. The good people will always be there and the bad ones will leave me experiences that will move me forward.');
          shuffle($philosophie);
?>
<!DOCTYPE HTML>
