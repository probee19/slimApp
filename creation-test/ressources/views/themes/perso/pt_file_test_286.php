...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
                    ...
                    $carriere = array('Cientista','Star Agent','Vlogger famoso','Fotógrafo de estrelas','Poeta famoso');
                    $argent = array('2 contas bancárias com milhões de dólares','US $ 2.000.000 por ano','US $ 2.500.000 por ano','Proprietário de 3 casas improvisadas','Milionário. Proprietário de 5 grandes moradias. ');
                    $accomplissement = array('PhD','Criando sua própria empresa','Ajuda de muitas instituições de caridade','Proprietário de uma grande marca de automóveis','Amigo das celebridades','Proprietário de uma boate glamourosa');
          }
          else{
                    $amour = array('Casado','Noiva, 2 filhos','Noiva, 3 filhos','Noiva, 2 gêmeos','Noiva, 1 criança');
                    $carriere = array('Cientista','Star Agent','Vlogger famoso','Fotógrafo de estrelas','Poeta famoso');
                    $argent = array('2 contas bancárias com milhões de dólares','US $ 2.000.000 por ano','US $ 2.500.000 por ano','Proprietário de 3 casas improvisadas','Milionário. Proprietário de 5 grandes moradias. ');
                    $accomplissement = array('PhD','Criando sua própria empresa','Ajuda de muitas instituições de caridade','Proprietário de uma grande marca de automóveis','Amigo das celebridades','Proprietário de uma boate glamourosa');
...
<div class="texte box" id="box_heart"> Ame </div>
...
<div class="texte box" id="box_job"> Carreira </div>
...
<div class="texte box" id="box_money"> Dinheiro </div>
...
<div class="texte box" id="box_done"> realização </div>
