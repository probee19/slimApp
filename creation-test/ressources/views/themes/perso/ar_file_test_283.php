...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
                   $sis = array('حجبه، يجب أن تتزوجه.','لا تدعه يذهب، هو نوع.','عقد، انه واقية.','تذكر، إنه زوج مثالي.'
                    ,'عقد، انه مخلص.','عقد، انه غالانت. ');
          else
                   $sis = array('لا تدعها تذهب، عليك أن تتزوجها.','حجب ذلك، وقالت انها نوع.','لا تدعها تذهب، وهي زوجة مثالية.'
                    ,'تذكر أنها مخلصة و مخلصة.','حجب ذلك، وقالت انها سوف تجعل أم جيدة.');
          shuffle($sis);
?>

<div class="texte" id="sis_1"> إذا كان اسمه </div>
