...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
                   $sis = array('حجبها ، يجب أن تتزوجه.','لا تدعه يذهب ، هو لطيف.','انتظر ، إنه وقائي','تذكر ، هو زوج مثالي.'
                    ,'انتظر ، هو أمين.','انتظر ، إنه شجاع ');
          else
                   $sis = array('لا تدعها تذهب ، عليك أن تتزوجها.','حجبها ، هي نوع.','لا تدعها تذهب ، إنها زوجة مثالية.'
                    ,'تذكر أنها مخلصة ومخلصة.','حجبها ، وقالت انها سوف تجعل الأم جيدة.');
          shuffle($sis);
?>
