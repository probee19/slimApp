...
<!DOCTYPE HTML>
<?php
          $dons = array('hope', 'calm', 'luck', 'sincerity', 'courage', 'strength', 'the leadership');
          $qualites = array('sensitivity','courage','Warning','charm','insurance','individuality','altruism','strength of character','loyalty','impartiality','flexibility');
          shuffle($qualites);
          shuffle($dons);
?>
...
<div id="p" >You are radiating </div>
