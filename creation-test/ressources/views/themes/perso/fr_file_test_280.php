...
<?php 
          $qualites = array(' Ton sourire ',' Ta beauté ',' Ta loyauté ',' Ton courage ',' Ton caractère ',' Ton intelligence ',' Ton calme ',' Ta modestie ',
          ' Ton humour ',' Ton honnêteté ',' Ta passion ',' Ta gentillesse ',' Ta force ',' Ton charisme ');
          shuffle($qualites);
?>        
<!DOCTYPE HTML>
