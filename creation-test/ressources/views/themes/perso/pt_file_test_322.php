...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
                    $amour = array('5 filhos, 18 netos','45 netos','4 filhos, 21 netos','7 filhos, 28 netos');
                    $carriere = array('Cientista','Piloto','Poeta famoso');
                    $argent = array('2 contas bancárias com milhões de dólares','US $ 15.000.000','US $ 12.500.000','Proprietário de 3 casas improvisadas','Milionário. Proprietário de 5 grandes moradias. ');
                    $accomplissement = array('Criando sua própria empresa','Ajuda de muitas instituições de caridade','Proprietário de uma grande marca de automóveis','Assessor do Presidente da República');
          }
...
<div class="texte box" id="box_heart"> Família </div>
...
<div class="texte box" id="box_money"> Fortuna </div>
