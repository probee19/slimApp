...
<?php 
          $forces = array('su coraje','su inteligencia','su amabilidad','su genial','su forma de hablar','su sentido de respeto','su sentido del deber');
          shuffle($forces);
?>
<!DOCTYPE HTML>
...
<div class="texte" id="force">  
          <div  id="force_1"> La fortaleza principal de <?php echo urldecode($_GET['user_name']); ?> es</div>
          <div  id="force_2"> <?= $forces[0];?>  </div>
</div>

<div class="texte" id="texte_bottom">¿Cuál es tu mayor fortaleza?</div>
