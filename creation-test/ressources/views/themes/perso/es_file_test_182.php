...
<div id='titre'><span style="font-size:40px;"><?php echo urldecode($_GET['user_name']); ?>,</span><br>usted tendrá <br><?php echo $nb_enfants;?> niños)</div>
<div id='boys'><?php echo $garcon ?>chicos)</div>
<div id='girls'><?php echo $fille?> hija (s)</div>
