...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
                    $mots = array('حسي','قوي','جدي','مغناطيس','خلاق','الكاريزمية','قوي','محمي','لطيف','متعدد التكافؤ','مسلي','شاكر','ساحر','الأذواق','مضحك'  );
         else
                    $mots = array('حسي','قوي','جدي','مغناطيسic','خلاق','الكاريزمية','قوي','محمية','لطيف','متعدد الجوانب والاستعمالات','مسلي','شاكر','جميل','الأذواق','مضحك'  );
          shuffle($mots);
?>
<!DOCTYPE HTML>
