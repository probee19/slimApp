...
<!DOCTYPE HTML>
<?php
          $reves = array('سيكون لديك سيارة جديدة','سوف تنتقل إلى فيلا جديدة','سوف تصبح غنية','سوف تكسب جائزة وطنية',
          'سيكون لديك زيادة الراتب','سوف تتزوج من المشاهير غنية','سيكون لديك طفل جديد');
          shuffle($reves);
?>
