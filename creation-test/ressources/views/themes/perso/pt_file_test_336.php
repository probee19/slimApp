...
<?php
          $qualites = array(''.$_GET['user_name'].' faz todos sorrirem',''.$_GET['user_name'].' ainda lutando contra a injustiça',''.$_GET['user_name'].' é confiável',''.$_GET['user_name'].' sempre fica sorrindo',''.$_GET['user_name'].' é sempre um bom conselho');
          shuffle($qualites);
?>
<!DOCTYPE HTML>
