...
<?php 
           if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
                   $faits = array('perdoe a todos','amo sua família','fará tudo por seus amigos','nunca desista','é muito paciente',' é um lutador','é corajoso',
                         'nunca machuca uma pessoa','está sempre sorrindo','sempre tempo para seus amigos','sempre supera um fracasso','amo sua mãe');
          else
                    $faits = array('perdoe a todos','amo sua família','fará tudo por seus amigos','nunca desista','é muito paciente','é um balanço','é corajoso',
                         'nunca machuca uma pessoa','está sempre sorrindo','sempre tempo para seus amigos','sempre supera um fracasso','amo sua mãe');
...
<div id="header"> 7 fatos sobre <?php echo urldecode($_GET['user_name']); ?></div>
<hr>
<div id="profile_img">
