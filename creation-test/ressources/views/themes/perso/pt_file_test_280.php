...
<?php 
          $qualites = array('Seu sorriso','Sua beleza','Sua lealdade','Sua coragem','Seu personagem','Sua inteligência','Sua calma','Sua modéstia',
          'Seu humor','Sua honestidade','Sua paixão','Bondade sua','Sua força','Seu carisma');
          shuffle($qualites);
?>        
<!DOCTYPE HTML>
