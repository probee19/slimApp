...
<?php
          $like = array('Su familia','sus amigos','donner','su pasión por viajar','ofrecer una sonrisa','ayudando gente');
          $dislike = array('mentirosos','las duchas','la gente gruñona');
          $nature = array('fiel','empático','sociable');
          $personnalite = array('Me gusta compartir','no es egoísta','hacer reír a todos');
...
<div class="texte ligne" id="ligne1"> e amo :  </div>
<div class="texte resultat" id="resultat1"> <?=$like[0];?> </div>

<div class="texte ligne" id="ligne2"> $_GET[' t odio :  </div>
<div class="texte resultat" id="resultat2"> <?=$dislike[0];?> </div>

<div class="texte ligne" id="ligne3"> $_GET[' t Naturaleza :  </div>
<div class="texte resultat" id="resultat3"> <?=$nature[0];?> </div>

<div class="texte ligne" id="ligne4"> $_GET[' t Personalidad :  </div>
