...
<?php
          $sign = array(' Tu es une femme à succès. ',' Tu es une femme forte. ',' Tu es une femme fidèle. ',' Tu es celle que tout le monde aime. ',' Tu deviens une diablesse si on te trahit. ',' Être fidèle est dans tes gênes. ');
          $pre = ' une ';
          
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
                    $sign = array(' Tu es un homme à succès. ',' Tu es un homme à femmes par nature. ',' Tu es un homme fidèle. ',' Tu es celui que tout le monde aime. ',' Tu deviens le diable si on te trahit. ',' Être fidèle est dans tes gênes. ');
                    $pre = ' un ';
          }
          shuffle($sign);
          $hashtag = ' On est comme ça ';
...
<div class="texte" id="header_f">  Quand tu es  <?=$pre?> </div>
