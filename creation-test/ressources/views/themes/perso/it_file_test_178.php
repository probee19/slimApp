 ...
 <?php 
            ...
            {
               $message_1 = array('Troppo onesto','Troppo sincero','Troppo sexy','strage','Troppo franco');
            $message_2 = array('Pericoloso perché dice le cose come sono.','Pericoloso per coloro che non vogliono vedere la verità di fronte','Invidiato da uomini dai 18 ai 35 anni'
            ,'Pericoloso per donne di età compresa tra i 18 e i 26 anni','Pericoloso per le persone che non supportano il franchising'); }
            else{ 
                 $message_1 = array('Trop honnête','Troppo sincero','Troppo sexy','strage','Troppo franco');
            $message_2 = array('Pericoloso perché dice le cose come sono.','Pericoloso per coloro che non vogliono vedere la verità di fronte','Invitato da donne di età compresa tra i 18 e i 35 anni'
            ,'Pericoloso per donne di età compresa tra 25 e 45 anni','Pericoloso per le persone che non supportano il franchising');
          
            }
            $max_key = 3; $key = mt_rand(0,$max_key);
            ?>
            <img src="http://creation.funizi.com/images-theme-perso/1508976353.jpg" id="background">
            <div id="certificat">Fedina penale</div> <div id="name">Nome:</div>
            <div id="name_reponse"> <?php echo urldecode($_GET['full_user_name']); ?></div> <div id="diagnostic">Crime:</div>
            <div id="diagnostic_reponse"><?php echo $message_1[$key]; ?></div> <div id="niveau">Questo documento certifica che <?php echo urldecode($_GET['user_name']); ?> è:</div>
