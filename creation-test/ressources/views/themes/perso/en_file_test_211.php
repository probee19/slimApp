...
<?php
  ...
  if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
          $mots = array(
                    "You are the embodied charm. Any day becomes radiant when I see you. Life is made to be lived and you know it well. Your thirst for knowledge and adventure is matched only by your love for your family and your friends.",
                    "You are a friendly friend who knows how to make any day entertaining and exciting. Whatever the time, you are always overflowing with contagious energy and you are always ready to explore the world. You are really unique.",
                    "You live your life as you understand it and you are not afraid to be the force of nature that you are naturally. You care a lot about your friends and you would do anything to protect them. You are someone honest and lovable."
          );
  else
           $mots = array(
                    "You are the embodied charm. Any day becomes radiant when I see you. Life is made to be lived and you know it well. Your thirst for knowledge and adventure is matched only by your love for your family and your friends.",
                    "You are a friendly friend who knows how to make any day entertaining and exciting. Whatever the time, you always overflow with contagious energy and you are always ready to explore the world. You are really unique.",
                    "You live your life as you understand it and you are not afraid to be the force of nature that you are naturally. You care a lot about your friends and you would do anything to protect them. You are someone honest and lovable."
          );
...
<div class="texte" id="entete"> Dear <?php echo urldecode($_GET['user_name']); ?>, </div>
