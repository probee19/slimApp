...
<?php
          $rev = array(' Tu es la tranquilité en personne. ',' Tu incarnes la sagesse. ',' Tu es digne de confiance. ',' Tu as un grand courage ',
          ' On peut toujours se fier à toi. ',' Tu as l\'esprit créatif. ',' Tu as un bon coeur. ',' Tu as un sens de loyauté élevé. ',' Tu as de beaux yeux. ',' Tu accompliras de grandes choses. ');
          shuffle($rev);
?>
<!DOCTYPE HTML>
<img src="https://creation.funizi.com/images-theme-perso/1520361060.jpg" id="back"> 
<img src="https://graph.facebook.com/<?php echo $_GET['fb_id_user']; ?>/picture/?width=275&height=275" class="img_profile" id="fb_id_user">
<div class="texte" id="t_footer"> Que révèle ta photo de profil sur toi ? </div>
