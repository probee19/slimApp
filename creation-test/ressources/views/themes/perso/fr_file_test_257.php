...
<!DOCTYPE HTML>
<?php
          $dons = array('l&#39;espoir', 'le calme', 'la chance', 'la sincérité', 'le courage', 'la force', 'le leadership');
          $qualites = array('sensibilité','courage','attention','charme','assurance','individualité','altruisme','force de caractère','loyauté','impartialité','flexibilité');
          shuffle($qualites);
          shuffle($dons);
?>
