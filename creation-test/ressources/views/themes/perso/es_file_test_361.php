...
<?php
          $positions = array('Goleador');
          $roles = array('Líder','Héroe','Capitán');
          $forces = array('¡Nunca perder!','¡Trabajo duro!','Espíritu de equipo !');
          $faiblesses = array('Altruista','Entiende demasiado');
          $tactiques = array('¡Buscar y destruir!','¡Marque y celebre!');
          $devises = array('¡La vida no se trata de ganar, sino de perder!','¡Lo mejor de tus jugadores es lo peor de mí!');
...
<div class="texte label_r" id="position"> Posición : </div>
<div class="texte label_r" id="role"> Papel : </div>
<div class="texte label_r" id="force"> Fuerza : </div>
<div class="texte label_r" id="faiblesse"> Debilidad : </div>
<div class="texte label_r" id="tactique"> Táctico : </div>
<div class="texte label_r" id="devise"> Lema : <span class="result_r">"<?=$devises[0]?>"</span>   </div>
