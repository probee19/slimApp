...
<?php 
          $appreciations = array('5'=> ' Le cours se passe à merveille en son absence ','6'=>' Il lui manque que son oreiller en classe. ','7'=>' La fenêtre n\'est pas plus intéressante que le tableau. ',
          '8'=>' La salle de cours n\'est pas une récréation ','9'=>' La salle de classe n\'est pas un ring ','10'=>' Passable ','11'=>' Passable ','12'=>' Peut mieux faire ',
          '13'=>' Continuez ainsi ','14'=>' Travail satisfaisant ','15'=>' Quand on veut on peut ','16'=>' Poursuivez vos efforts ');
...
<div class="bulletin">
<table>
  <caption> Bulletin scolaire 2018 de  <?php echo urldecode($_GET['full_user_name']); ?></caption>
  <tr>
    <th width="150px"> Matières </th>
    <th width="110px"> Moy de l'élève </th>
    <th width="120px"> Moy de la classe </th>
    <th width="300px"> Appréciations </th>
  </tr>
  <tr>
    <td> Français </td>
  ...
  <tr class="general">
    <td class="general"> Moyenne générale </td>
