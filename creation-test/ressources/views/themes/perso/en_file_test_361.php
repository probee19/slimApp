...
<?php
          $positions = array('Scorer');
          $roles = array('Leader','Hero','Captain');
          $forces = array('Never loose!','Hard work!','Team spirit !');
          $faiblesses = array('Altruistic','Understands too much');
          $tactiques = array('Search and destroy!','Mark and celebrate!');
          $devises = array('Life is not about winning but not losing!','The best of your players is the worst of mine!');
...
<div class="texte label_r" id="force"> Strength : </div>
<div class="texte label_r" id="faiblesse"> Weakness : </div>
<div class="texte label_r" id="tactique"> Tactical : </div>
