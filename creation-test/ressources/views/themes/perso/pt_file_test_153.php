...
<?php
 ...
 if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
                      $recherche = array('Porque '.$_GET['User_name'].' Nunca rir das minhas bofetadas?','Por que é '.$_GET['User_name'].' Mais bonito que eu?'
                ,'Por que é '.$_GET['User_name'].' Tão rico?','Por quê '.$_GET['User_name'].' O mais inteligente?'
                ,'Por quê '.$_GET['User_name'].' É tão majestoso?','Porque '.$_GET['User_name'].' Conheça o presidente Obama?'
                ,'Por quê '.$_GET['User_name'].' Tem tanta sorte?');
                }
            else{ 
                $recherche = array('Porque '.$_GET['User_name'].' Nunca rir de minhas piadas?','Por que é '.$_GET['User_name'].' Mais bonito que eu?'
                ,'Porque '.$_GET['User_name'].' Tem tanta classe?','Por quê '.$_GET['User_name'].' O mais inteligente?'
