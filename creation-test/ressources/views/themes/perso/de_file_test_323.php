...
<?php
          $like = array('seine Familie','seine Freunde','donner','seine Leidenschaft für das Reisen','biete ein Lächeln an','Menschen helfen');
          $dislike = array('Lügner','die Duschen','die mürrischen Leute');
          $nature = array('treu','empathisch','gesellig');
          $personnalite = array('gerne teilen','ist nicht egoistisch','Lass alle lachen');
...
<div class="texte ligne" id="ligne1"> $_GET['Ich liebe dich :  </div>
<div class="texte resultat" id="resultat1"> <?=$like[0];?> </div>

<div class="texte ligne" id="ligne2"> $_GET[' t Hass :  </div>
<div class="texte resultat" id="resultat2"> <?=$dislike[0];?> </div>

<div class="texte ligne" id="ligne3"> $_GET[' t Natur :  </div>
<div class="texte resultat" id="resultat3"> <?=$nature[0];?> </div>

<div class="texte ligne" id="ligne4"> $_GET[' t Persönlichkeit :  </div>
