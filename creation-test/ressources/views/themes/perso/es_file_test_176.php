...
<div class="texte" id="texte_top">¿Quién me está siguiendo en secreto? </div>
...
<div class="texte" id="paragraphe"><?php echo urldecode($_GET['user_name']); ?>, <?php echo urldecode($_GET['friend_first_name_1']); ?> ¡Te sigo en secreto! </div>
