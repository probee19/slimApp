...
<?php
  ...
  $texte = array(''.$_GET['user_name'].' guarda secretos!', 'Con '.$_GET['User_name'].' ¡Nunca nos aburrimos!', ''.$_GET['user_name'].' es simplemente adorable!',
  ''.$_GET['user_name'].' puede dar todo por amistad!',''.$_GET['user_name'].' sabe cómo dar un buen consejo!', 
  ''.$_GET['user_name'].' prepara maravillosas sorpresas!',''.$_GET['user_name'].' sabe cómo hacer la vida más bella!');
shuffle($texte);
?>
...
<div id="titretest" >los <span style="color:#D90000">5 razones</span> ser amigo de <br><?php echo $_GET['full_user_name']; ?></div>
