...
<div class="texte" id="head_club">  Clubs intéressés  :</div>
...
<div class="texte" id="cout">  Coût  : <span style="color:#f1c40f; font-weight:700"><?=$couts?> M€</span> <?php if($couts>220) echo "<br><span style='color:#e74c3c; font-weight:700;text-transform:uppercase'>  Record mondial </span> ";?> </div>
