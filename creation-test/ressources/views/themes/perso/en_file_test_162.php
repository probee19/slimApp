...
<?php
$message = array('You think of others before thinking of yourself','You always trust people','You sometimes question your choices too much',
'You let people abuse your kindness');
shuffle($message);
?>
