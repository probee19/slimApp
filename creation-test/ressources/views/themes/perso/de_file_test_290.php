...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
                    ...
                    $details = array('Sie sind eine echte Bürgerwehr und zu allem fähig, um Ihre zu schützen.','Sie sind geliebt, respektiert und in der Lage, Geheimnisse zu bewahren, die die Stabilität Ihres Landes bedrohen.',
                    'Du bist ein beeindruckender Kämpfer mit außergewöhnlicher Intelligenz','','Sie sind ein hochrangiger Wissenschaftler und besitzen übermenschliche Stärke und Ausdauer',
                    'Du bist ein großartiger Anführer und hast übermenschliche Fähigkeiten.','Sie sind ein treuer Berater, ein Mann des Vertrauens.');
                    $ind = mt_rand(0,6);
          }
          else{
                    $personnages = array('Ramonda','Nakia','Okoye','Shuri');
                    $images = array('1519662856','1519662954','1519663017','1519663589');
                    $details = array('Du bist ein diskreter Berater, eine Königinmutter.',
                    'Du bist ein wahrer Krieger, der in der Lage ist, jede Mission zu leiten, um die Unterdrückten zu befreien.','Sie sind ein loyaler und engagierter General.',
                    'Sie sind eine Prinzessin, ein Genie, das für mehrere technologische Innovationen verantwortlich sein kann.');
                    $ind = mt_rand(0,3);
          }
