...
<!DOCTYPE HTML>
<?php
          $reves = array('Avrai una nuova macchina','Ti trasferirai in una nuova villa','Diventerai ricco','Vincerai un premio nazionale',
          'Avrai un aumento di stipendio','Sposerai una ricca celebrità','Avrai un nuovo figlio');
          shuffle($reves);
?>
