...
<?php
          $surprises = array('Tendrás un bebé '.$_GET[' User_name'].' ¡La familia tendrá un nuevo tesoro!', 
                    'Difícil de elegir '.$_GET[' User_name'].'. ¡Muchas cosas mejorarán el próximo año!',
                    '¡Obtendrá un nuevo trabajo perfecto que satisfará perfectamente sus expectativas!',
                    'Tendrás una promoción profesional durante este año',
                    '¡Harás un viaje rico en experiencias y descubrimientos!');
          shuffle($surprises);
?>
<!DOCTYPE HTML>
