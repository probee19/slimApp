...
<?php
          $pour = array('لخدمات حارسه الشخصي الممتاز','لمهاراته التمثيل','للحمامات التي يعطيها للاسود','لموهبته الهزلية');
          $en = array('تقديرا لدعمه وحمايته في جميع الأوقات','تقديرا لشخصيته التي تجعل العالم أقل ممل قليلا','تقديرا للحمامات التي تمكن من إعطاءها للأسود دون أي حادث','اعترافًا بروحه التي تمنح الابتسامة للجميع');
          $ind = mt_rand(0,3);
?>
<!DOCTYPE HTML>
...
<div class="texte" id="header_t"> شهادة النجاح </div>
