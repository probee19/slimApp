...
#nouvelle_bottom{position:absolute; z-index:2; left: 420px; width:360px; bottom: 50px; font-size:30px; color:#FFBF00;line-height:30px; text-align:center; font-family: 'Raleway', sans-serif;} 
   ...
   <?php
                ...
                $message_1 = array('"Nuevos encuentros"','"Serenidad"','"La riqueza"','"Proyectos"','"Renovación"');
                $message_2 = array('Nunca estarás solo.','¡Encontrarás la paz interior!','Su cuenta bancaria se lo agradecerá.','¡Aprovecha las oportunidades!','¡No dejarás nada al azar!');
...
<div class="name texte" id="name_user" >El año de<?php echo urldecode($_GET['user_name']); ?> :</div>
