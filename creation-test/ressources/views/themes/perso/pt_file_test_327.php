...
<?php
          $couleurs = array('amarelo','verde','Branco','vermelho','azul');
          $aimes = array('abraços','viagem','leitura','feriados','a música','dormir');
          $detestes = array('A mentira','hipocrisia','a traição','atrasos');
          $forces = array('sabedoria','coragem','generosidade','sorriso agradável','grande coração','humor');
          $faiblesses = array('sensível','perfeccionista');
...
<div class="texte bloc" id="bloc1"><span class="title">Cor</span><span class="body"><?=ucfirst($couleurs[0])?></span></div>
<div class="texte bloc" id="bloc2"><span class="title">Você gosta</span><span class="body"><?=$aimes[0]?></span></div>
<div class="texte bloc" id="bloc3"><span class="title">Você odeia</span><span class="body"><?=$detestes[0]?></span></div>
<div class="texte bloc" id="bloc4"><span class="title">Sua força</span><span class="body"><?=ucfirst($forces[0])?></span></div>
<div class="texte bloc" id="bloc5"><span class="title">Sua fraqueza</span><span class="body"><?=ucfirst($faiblesses[0])?></span></div>
