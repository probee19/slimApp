...
#mot3{position:absolute; z-index:1; left: 0px; top: 160px;}
   ...
   if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
		 $mot = array('Intelligent','Travail','Famille','Honnête','Affectueux','Visionnaire','Sérieux','Amitié');
   }
   else{
		 $mot = array('Intelligente','Travail','Famille','Honnête','Affectueuse','Visionnaire','Sérieuse','Amitié');
   }
  ...
  <img src="http://creation.funizi.com/images-theme-perso/1508526452.jpg" id='background'>
      <div id='titre_test'>Quels sont les 3 mots qui te décrivent?</div>
