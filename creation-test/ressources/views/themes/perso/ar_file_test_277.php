...
<?php
           if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
                  $results = array('مشاهدة أشرطة فيديو مضحك على يوتيوب','وجود الوقت المناسب أمام مباراة باريس سان جيرمان ريال مدريد لكرة القدم','الاحتفال بفوز باريس سان جيرمان على ريال مدريد','احتفالا بفوز ريال مدريد على بي إس جي',
          'تقبيل فتاة جميلة','في عشاء رومانسي', 'عد المال الخاص بك','زيارة الأصدقاء');
           }
           else{
                  $results = array('مشاهدة أشرطة فيديو مضحك على يوتيوب','الاحتفال بفوز باريس سان جيرمان على ريال مدريد','احتفالا بفوز ريال مدريد على بي إس جي',
          'تقبيل رجل لطيف','في عشاء رومانسي', 'عد المال الخاص بك','زيارة الصديقات');
           }
           shuffle($results);
