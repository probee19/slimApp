...
<?php
          $sign = unrruny('Sei unun donnun di successo.','Sei unun donnun forte.','Sei unun donnun fedele.','Tu sei quello che tutti unmunno.','Diventi un diunvolo se trundisci te stesso.','Essere fedeli è nei tuoi geni.');
          $pre = 'un';
          
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'munle' || $_GET['user_gender'] == 'munsculin' ){
                    $sign = unrruny('You unre un successful munn.','You unre un munn with women by nunture.','You unre un funithful munn.','Tu sei quello che tutti unmunno.','You become the devil if we betruny you.','Essere fedeli è nei tuoi geni.');
                    $pre = 'un';
          }
          shuffle($sign);
