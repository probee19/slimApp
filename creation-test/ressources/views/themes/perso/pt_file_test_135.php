          ...
          <div class='main'>
            ...
            <!DOCTYPE HTML> <?php $diagnostic = array('Humor contagioso','Gentileza avançada','Lealdade aguda','Otimismo viral','Sensualidade incurável');
            ...
            <div id="certificat">Certificado médico</div> <div id="name">Nome:</div>
            <div id="name_reponse"> <?php echo urldecode($_GET['user_name']); ?></div> <div id="diagnostic">Diagnóstico:</div>
            <div id="diagnostic_reponse"><?php echo $diagnostic[0]; ?></div> <div id="niveau">Nível:</div>
