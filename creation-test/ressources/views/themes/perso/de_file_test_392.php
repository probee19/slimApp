...
<?php
          $aimes = array('Liebe','Freundschaft','Die Familie','Kinder','Die Freunde');
          $detestes = array(\"Lügner','Der Untreue','Heuchler','Die Betrüger','Fehler');
...
<div class="texte" id="phrase"><?php echo $_GET['user_name']; ?> weiß, was gut und nicht gut in seinem Leben ist</div>
