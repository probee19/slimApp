...
<?php
 $nom_explication = array('أمانة','اخلاص','حب','الامتياز التجاري','وفاء', 'أصالة','صبر','شجاعة', 'حساسية','سخاء','حكمة');
...
<div>=</div><div style="color:#FFF"><?php echo strtoupper ($nom_explication[0]) ?></div><div style="color:#FFF; font-size:20px;">لكن أيضا</div> <div style="color:#FFF"><?php echo strtoupper ($nom_explication[1]) ?></div>
</div>
</div>
