...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin'){
                    $personnalites = array(' Leader ',' Fort ',' Innovateur ',' Inspirateur ',' Virtuose ',' Aventurier ');
                    $adore = array(' Les surprises ',' Rire ',' Les voyages ',' Apprendre ');
                    $deteste = array(' Les ragots ',' La cruauté ',' Les menteurs ',' Les infidèles ');
                    $animaux = array(' Lion ',' Tigre ',' Léopard ',' Antilope ',' Guépard ');
                    $forces = array(' Honnête à 100% ',' Persuasif ',' Autonome ');
                    $faiblesses = array(' Donne trop ',' Est trop compréhensif ');
          }
          else{
                    $personnalites = array(' Leader ',' Forte ',' Innovatrice ',' Inspiratrice ',' Virtuose ',' Aventurière ');
                    $adore = array(' Les surprises ',' Rire ',' Les voyages ',' Apprendre ');
                    $deteste = array(' Les ragots ',' La cruauté ','Les menteurs','Les infidèles');
                    $animaux = array(' Lion ',' Tigre ',' Léopard ',' Antilope ',' Guépard ');
                    $forces = array(' Honnête à 100% ',' Fait preuve d\'empathie ',' Persuasive ',' Autonome ');
                    $faiblesses = array(' Donne trop ',' Est trop compréhensif ');
          }
...
<div class="texte" id="header_t">  Les 6 vérités qui résument ta vie :  </div>

<div class="texte" id="verite1"> <span class="title_block"> Tu adores </span> <span class="content_block"> <?=$adore[0]; ?> </span> </div>
<div class="texte" id="verite2"> <span class="title_block"> Tu détestes </span> <span class="content_block"> <?=$deteste[0]; ?> </span> </div>
<div class="texte" id="verite3"> <span class="title_block"> Ton animal spirituel </span> <span class="content_block"> <?=$animaux[0]; ?> </span> </div>
<div class="texte" id="verite4"> <span class="title_block"> Personnalité </span> <span class="content_block"> <?=$personnalites[0]; ?> </span> </div>
<div class="texte" id="verite5"> <span class="title_block"> Force </span> <span class="content_block"> <?=$forces[0]; ?> </span> </div>
<div class="texte" id="verite6"> <span class="title_block"> Faiblesse </span> <span class="content_block"> <?=$faiblesses[0]; ?> </span> </div>
