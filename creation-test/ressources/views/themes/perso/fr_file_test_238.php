...
<?php
  if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
            $texte = array('Tu ferais n&#39;importe quoi pour tes amis','Ton charme est fatal','Tu aimes passionnément','Les gens ne devraient pas sous estimer','Tu détestes les insjustices','Tu es plus fort que ne parait','Rien ne peut briser ton esprit','Ta confiance en toi est inébranlable','Tu es plus courageux que tu ne le penses');
  }
            else{ 
          $texte = array('Tu ferais n&#39;importe quoi pour tes amis','Ton charme est fatal','Tu aimes passionnément','Les gens ne devraient pas sous estimer','Tu détestes les insjustices','Tu es plus forte que ne parait','Rien ne peut briser ton esprit','Ta confiance en toi est inébranlable','Tu es plus courageuse que tu ne le penses');
  }
shuffle($texte);
?>
...
<div id="titretest" >Les <span style=\"color:#EFA200\">5 VÉRITÉS</span> découvertes à ton sujet en 2017<br> <?php echo urldecode($_GET['full_user_name']); ?> 
         </div>
