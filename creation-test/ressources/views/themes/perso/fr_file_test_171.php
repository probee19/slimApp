...
<?php
 $nom_explication = array('honnêteté','sincérité','amour','la franchise','la fidélité', 'authenticité','la patience','courage', 'sensibilité','générosité','sagesse');
...
<div>=</div><div style="color:#FFF"><?php echo strtoupper ($nom_explication[0]) ?></div><div style="color:#FFF; font-size:20px;">mais aussi</div> <div style="color:#FFF"><?php echo strtoupper ($nom_explication[1]) ?></div>
</div>
</div>
