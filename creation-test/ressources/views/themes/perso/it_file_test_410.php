...
<?php
 $qualites = array('la sua lealtà','la sua onestà','la sua sincerità','il suo franchising','la sua fedeltà', 'la sua autenticità','la sua pazienza','il suo coraggio', 'la sua sensibilità','la sua generosità','la sua saggezza');
 shuffle($qualites);
?>
<!DOCTYPE HTML>
...
<div class="texte qualites" id="qualites_entete">Le due migliori qualità di <?php echo $_GET['user_name']; ?>:</div>
