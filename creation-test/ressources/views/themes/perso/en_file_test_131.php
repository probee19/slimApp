          ...
          <div class='main'>
            ...
            <?php
                $nature = array('Joyful','happy');
                $personnalite = array('St.', 'believer', 'serious');
                $aime = array('Modesty','The simplicity');
                $deteste = array('The lie','Cheating','The treason');
                $force = array('Motivation','The power','money');
            ...
            <span id="titre" class="titre"> What is your personality <?php echo urldecode($_GET['user_name']); ?>?</span>
            ...
            <span id="texte_1" class="texte"> <b>Nature :</b> <?php echo $nature[0] ?></span>
            <span id="texte_2" class="texte"> <b> Personality:</b> <?php echo $personnalite[0] ?></span>
            <span id="texte_3" class="texte"> <b>Love :</b> <?php echo $aime[0] ?></span>
            <span id="texte_4" class="texte"> <b> Hate:</b> <?php echo $deteste[0] ?></span>
            <span id="texte_5" class="texte"> <b> Strength :</b> <?php echo $force[0] ?></span>
            <span id="texte_6" class="texte"> <b> Weakness :</b> <?php echo $faiblesse[0] ?></span>
