...
<?php
$message_1 = array('من لديه ملابس الطفل؟<br> نحن في انتظار التوائم قليلا !!! :)', 'أمي، يا أبي، يؤسفني أن أعلن أنك سوف تكون غراندبارنتس!');
$message_2 = array('ماذا !!!!:)','أنا يشتبه شيء! <3 تهانينا!');
$message_3 = array('تهانينا لكم 2 !!! لا أستطيع تصديق ذلك','انها جيدة وأكد ذلك؟ سوف تجعل الآباء رائعة!');
$date = array('22 كانون الاول / ديسمبر في 22:53','11 مارس في 8:03 مساء','13 يونيو في 21:43');shuffle($date);
