...
<?php     
          ...
          $nb_mots = count($nom);
          $significations = array('honestidad','liderazgo','motivación','perseverancia','valor','fuerza','lealtad');
          ...
          foreach($nom as $mot){
                    $signification .= '<div class="one_line underline" style="font-size:'.$font_size.'px;"><span class="nom" >'.$mot.'</span> medio : </div> 
