...
<?php
  ...
  if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
          $mots = array(
                    "Você é o encanto incorporado. Qualquer dia fica radiante quando te vejo. A vida é feita para ser vivida e você conhece bem. Sua sede de conhecimento e aventura é combinada apenas com seu amor por sua família e seus amigos.",
                    "Você é um amigo amigável que sabe como fazer qualquer dia divertido e emocionante. Seja qual for o tempo, você está sempre transbordando de energia contagiosa e você sempre está pronto para explorar o mundo. Você é realmente único.",
                    "Você vive sua vida conforme você entende e não tem medo de ser a força da natureza que você é naturalmente. Você se importa muito com seus amigos e você faria qualquer coisa para protegê-los. Você é alguém honesto e adorável."
          );
  else
           $mots = array(
                    "Você é o encanto incorporado. Qualquer dia fica radiante quando te vejo. A vida é feita para ser vivida e você conhece bem. Sua sede de conhecimento e aventura é combinada apenas com seu amor por sua família e seus amigos.",
                    "Você é um amigo amigável que sabe como fazer qualquer dia divertido e emocionante. Seja qual for o tempo, você sempre transborda de energia contagiosa e você está sempre pronto para explorar o mundo. Você é realmente único.",
                    "Você vive sua vida conforme você entende e não tem medo de ser a força da natureza que você é naturalmente. Você se importa muito com seus amigos e você faria qualquer coisa para protegê-los. Você é alguém honesto e adorável."
          );
...
<div class="texte" id="entete"> Prezado <?php echo urldecode($_GET['user_name']); ?>, </div>
