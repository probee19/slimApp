...
<?php
$message = array("Grazie alle buone azioni, riceverai denaro che non ti aspetti e buone notizie. Vincerai su tutti i fronti.",
"Avrai un lungo viaggio con due amici intimi. Lungo la strada incontrerai nuovi volti che avranno un enorme impatto sulla tua vita nel 2018. Emozionante.",
"Un enorme cambiamento nell\'ultima settimana del mese ti porterà a concentrarti sui tuoi obiettivi per il prossimo anno. Pianificerai la più grande avventura della tua vita.",
"Incontrerai l\'amore della tua vita, ma non nel modo in cui lo immagini. Una festa a casa di un amico attiverà gli eventi.");
shuffle($message);
?>

<div id="titre" class="titre">Cosa riserva per te il mese di settembre?</div>
