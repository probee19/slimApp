...
<?php
 $texte = array('Die Arme fallen gelassen','Es ist ein Chaos','Single','Heimlich in einer Beziehung');
 $texte1 = array('Hesite zwischen 2 Personen','Gebrochenes Herz','Offiziell in einer Beziehung','Endlich als Paar','Im Paar und glücklich','Hände weg ! Herz schon genommen!');
 shuffle($texte);
 shuffle($texte1);
?>
...
<div style=" position:absolute; width:800px; top:115px; text-align:center; z-index:2; font-size:20px; font-weight:bold; color:#0C6CFF">Heute</div>
...
<div style=" position:absolute; width:800px; top:330px; text-align:center; z-index:2; font-size:20px; font-weight:bold; color:#0C6CFF">In 6 Monaten</div>
