...
<?php
$message = array('حسي','نذل','السكر','عاطفي','خبير','حسي');
shuffle($message);
?>
<img src="http://creation.funizi.com/images-theme-perso/1508852359.png" id="background">
<span id="titre" class="titre">وقد لاحظ شركاؤك القبلات الخاصة بك:</span>
<img src="https://graph.facebook.com/<?php echo $_GET['fb_id_user']; ?>/picture/?width=275&height=275" class="img_profile" id="fb_id_user">
<div id="message"> <b><?php echo mt_rand(13,20) ?></b>/10</div>
<span id="titre_bottom" class="titre_bottom">نوع قبلة: <?php echo $message[0]; ?></span>
