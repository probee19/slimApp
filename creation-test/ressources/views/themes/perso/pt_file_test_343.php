...
<?php
          $qualites = array('amável','agradável','sociável','digno','modesto','eficaz','integrado','engraçado');
          $defauts = array('muito sensível',' tropamável');
...
<div class="back" id="back_blue" > Melhor qualidade : <span class="res" id="qualite"><?=$qualites[0]?></span></div>
<div class="back" id="back_red" > Pior defeito : <span class="res" id="defaut"><?=$defauts[0]?></span></div> 
