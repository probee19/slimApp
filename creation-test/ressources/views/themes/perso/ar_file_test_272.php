...
<?php
      if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
               $message = array('هي بالفعل في الجانب الخاص بك','كنت بالفعل الخروج معها','كنت تعيش معها بالفعل');          }
            else{ 
              $message = array('هو بالفعل في الجانب الخاص بك','كنت بالفعل الخروج معه','كنت تعيش معه بالفعل');
            }
