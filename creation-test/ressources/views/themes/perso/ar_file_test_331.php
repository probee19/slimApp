...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
                    $caracteres = array('الثقة والولاء مهمان بالنسبة إلى {؟ اسم المستخدم؟}. لم يساعده العالم دائما ، لكن نظرته الإيجابية سمحت له بالمرور في الأوقات العصيبة. إنه طموح ويحب كل ما تقدمه الحياة.',
