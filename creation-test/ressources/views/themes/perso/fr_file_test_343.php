...
<?php
          $qualites = array(' aimable ',' agréable ',' sociable ',' digne ',' modeste ',' efficace ',' intègre ',' drôle ');
          $defauts = array(' trop sensible ',' trop aimable ');
...
<div class="back" id="back_blue" >  Meilleure qualité  : <span class="res" id="qualite"><?=$qualites[0]?></span></div>
<div class="back" id="back_red" >  Pire défaut  : <span class="res" id="defaut"><?=$defauts[0]?></span></div> 
