...
<?php
          $qualites = array('Il tuo coraggio','La tua eloquenza','Il tuo carisma','Il tuo fascino','La tua determinazione','La tua onestà','Il tuo coraggio','La tua lealtà','La tua fiducia');
          shuffle($qualites);
?>
<!DOCTYPE HTML>
