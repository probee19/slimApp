...
<!DOCTYPE HTML>
<?php
          $causes = array('su gran corazón','su belleza','su franquicia','su elegancia','su modestia','su humor','su coraje','su valentía','su honestidad');
          shuffle($causes);
?>
<div id="profile_img">
          <img src="<?php echo urldecode($_GET['url_img_profile_user']); ?>" class="img_profile" id="fb_id_user">
</div>
<div class="texte" id="texte1" ><span style="color:#B71C1C;"><?php echo urldecode($_GET['friend_first_name_1']); ?></span> pensé en <?php echo urldecode($_GET['user_name']); ?> </div>
<div class="texte" id="texte2"><?php echo mt_rand(102,450); ?> HORA</div>
<div class="texte" id="texte3">este año debido a </div> 
