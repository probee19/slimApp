...
<?php
$texte = array('You are a person of perfect beauty, you can put anyone in your pocket','Wow! With this magnificent beauty you have, everyone is looking for you!','We only talk about you! You have an extraordinary beauty!');
$score = array('11','12','10');
$k = mt_rand(0,2);
?>
<div class="texte" id="top"> <?php echo urldecode($_GET['user_name']); ?> THIS IS YOUR SCORE! </div>
