...
<?php
          $pour = array('por seus excelentes serviços de guarda-costas','por suas habilidades de atuação','para os banhos que ele dá aos leões','por seu talento cômico');
          $en = array('em reconhecimento de seu apoio e proteção em todos os momentos','em reconhecimento de sua personalidade que torna o mundo um pouco menos chato','em reconhecimento dos banhos que ele consegue dar aos leões sem nenhum acidente','em reconhecimento do seu humor que dá o sorriso a todos');
          $ind = mt_rand(0,3);
?>
<!DOCTYPE HTML>
...
<div class="texte" id="header_t"> Certificado de sucesso </div>

<div class="texte" id="header_t_2"> orgulhosamente emitido para </div>
...
<div class="texte" id="deliv" >Reconhecimento emitido e reconhecido por:</div>
