...
<?php
          $qualites = array('sinceridade','a precisão','a competência','bondade','Romantismo', 'fidelidade','bravura','coragem','honestidade','perseverança','fidelidade','a liderança');
          shuffle($qualites);
?>
<!DOCTYPE HTML>
...
<div class="texte" id="header"><?php echo urldecode($_GET['user_name']); ?>, com base em nossa análise profunda, a qualidade que melhor descreve você é:</div>

<div class="texte" id="quality"><?=$qualites[0]?></div>

<div class="texte" id="footer">( preciso para <?=mt_rand(94,99)?> % )</div
