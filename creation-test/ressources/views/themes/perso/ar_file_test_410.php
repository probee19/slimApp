...
<?php
 $qualites = array('ولاءك','صدقك','صدقك','صراحتك','إخلاصك', 'صحتك','صبركم','شجاعتك', 'حساسيتك','كرمك','حكمتك');
 shuffle($qualites);
?>
<!DOCTYPE HTML>
...
<div class="texte qualites" id="qualites_entete"> Les deux plus grandes qualités dé <?php echo $_GET['user_name']; ?> :</div>
