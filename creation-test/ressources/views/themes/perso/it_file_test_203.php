...
<?php
  if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
                     $texte = array('Dai sempre con il cuore','Non lascerai mai nessuno a terra','Non hai bisogno di nessuno','Hai la preoccupazione del dettaglio',
                     'Non farai mai del male a nessuno','Non ti fermi davanti a nulla','Passerai attraverso un incendio per salvare la tua famiglia',
                     'Tu odi l&#39;ingiustizia','Non mollare mai le persone','La tua lealtà è infallibile','Impari dai tuoi errori','Guardi sempre i tuoi amici','Sei sempre onesto con le persone');

  }
            else{ 
             $texte = array('contento','Capo','Onesto','Potente','Saggio','Successo');
