 ...
 <?php 
            ...
            $message_2 = array('Você é impossível analisar','LOUCO'); }
            else{ 
                 $message_1 = rand(25,50);
            $message_2 = array('Você é impossível analisar','LOUCO WOMAN');
          
            }
            $max_key = 1; $key = mt_rand(0,$max_key);
            ?>
            <img src="http://creation.funizi.com/images-theme-perso/1509205159.jpg" id="background">
            <div id="certificat">Certificado psicológico</div> <div id="name">Nome :</div>
            <div id="name_reponse"> <?php echo urldecode($_GET['full_user_name']); ?></div> <div id="diagnostic">Idade mental :</div>
            <div id="diagnostic_reponse"><?php echo $message_1; ?></div> <div id="niveau">Este documento confirma que você é :</div>
