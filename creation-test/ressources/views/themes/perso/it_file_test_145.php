...
#mot3{position:absolute; z-index:1; left: 0px; top: 160px;}
   ...
   if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
		 $mot = array('Intelligente','Lavoro','Famille','Onesto','Affettuoso','Visionario','Grave','Amicizia');
   }
   else{
		 $mot = array('intelligente','Lavoro','Famiglia','Onesto','affettuoso','Visionario','grave','Amicizia');
   }
  ...
  <img src="http://creation.funizi.com/images-theme-perso/1508526452.jpg" id='background'>
      <div id='titre_test'>Quali sono le 3 parole che ti descrivono?</div>
