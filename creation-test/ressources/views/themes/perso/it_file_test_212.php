...
<?php
      if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
               $message = array('Lei è già al tuo fianco.','Condividi già la tua vita con lei.','Lei è sempre stata al tuo fianco e rimarrà tale.');          }
            else{ 
               $message = array('Lui è già al tuo fianco.','Condividi già la tua vita con lui.','È sempre stato al tuo fianco e rimarrà tale.');     
            }
