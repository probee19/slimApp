...
<?php
           ...
           $message_1 = array('¿Todavía piensas en mí?','Hola, ha pasado un tiempo ...','Hola.','Estas bien ?');
                $message_2 = array('A veces...','Espera ... ¿oyes eso?','Hoy no, Satanás.','Genial, gracias. Ha sido un largo tiempo...');
                $message_3 = array('Eso es verdad ?','Qué ?',' ¡Qué! Solo quiero seguir siendo amigo ...','Cada vez que cierro los ojos, veo tu cara.');
                $message_4 = array('Sí, y luego me despierto y me digo a mí mismo: &quot;¡Afortunadamente esta pesadilla ha terminado!&quot;','El sonido de mi indiferencia. DESPEDIDA !','¡Darse de baja!','Parece un problema médico. Deberias consultar un doctor.');
