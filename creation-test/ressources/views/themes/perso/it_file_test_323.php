...
<?php
          $like = array('la sua famiglia','i suoi amici','donner','la sua passione per i viaggi','offri un sorriso','aiutare le persone');
          $dislike = array('Bugiardi','le docce','le persone scontrose');
          $nature = array('fedele','empatico','socievole');
          $personnalite = array('piace condividere','non è egoista','fai ridere tutti');
...
<div class="texte ligne" id="ligne3"> $_GET[' t Natura :  </div>
<div class="texte resultat" id="resultat3"> <?=$nature[0];?> </div>

<div class="texte ligne" id="ligne4"> $_GET[' t Personalità :  </div>
