...
<?php
         ...
         function getAdverb($team, $adverbe="de l'"){ 
                   $feminin = array('بلجيكا','كولومبيا','Croitie','لا فرنسا','كوريا الشمالية','المكسيك','بولندا','روسيا','صربيا','السويد','سويسري','تونس');
         ...
         if( $pr ==  'a'){
                    ...
                    //$team = "France";
                   $ph = 'توقع النصر '.getAdverb($team).'<span style="color:#e21b1b">'.$team.'</span>.';
         }
         elseif( $pr ==  'b'){
                   $class_no = 'yes_a';
                   $class_yes = 'yes_b';   
