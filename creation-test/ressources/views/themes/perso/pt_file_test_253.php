...
<!DOCTYPE HTML>
<?php
          $reves = array('Você terá um carro novo','Você vai se mudar para uma nova villa','Você se tornará rico','Você ganhará um prêmio nacional',
          'Você terá um aumento de salário','Você se casará com uma celebridade rica','Você terá um novo filho');
          shuffle($reves);
?>
