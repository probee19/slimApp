...
<?php
          $actions = array(' emménage chez toi ',' pleure chaque instant ',' vole ton ordinateur ',' vole toute la bouffe dans ton frigo ',' engage Derrick pour te retrouver ',
          ' prend soin de ta famille ',' vole tous tes habits ',' récupère ton compte bancaire ');
          shuffle($actions);
