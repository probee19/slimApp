...
<?php
          $sentiments = array('em paz','Amado','motivado','desejado');
          $explications = array('Você tem uma influência suave em todos ao seu redor. Você aceita a vida como ela é e compartilha sua sabedoria com pessoas que têm problemas.',
          ...
          'Às vezes as pessoas precisam ser empurradas para perseguir seus sonhos. É aqui que você intervém. Você irradia determinação e otimismo. Um verdadeiro impulso para o moral',
          'A sensação de solidão desaparece quando você está com você. Sua bondade e energia contagiante espalham alegria ao seu redor. Um verdadeiro raio de sol.');
...
<div class="texte" id="head_text">Veja como as pessoas se sentem na sua presença</div>
