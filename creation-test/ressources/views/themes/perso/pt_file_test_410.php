...
<?php
 $qualites = array('sua lealdade','sua honestidade','sua sinceridade','sua franquia','sua fidelidade', 'sua autenticidade','sua paciência','sua coragem', 'sua sensibilidade','sua generosidade','sua sabedoria');
 shuffle($qualites);
?>
<!DOCTYPE HTML>
...
<div class="texte qualites" id="qualites_entete">As duas maiores qualidades de <?php echo $_GET['user_name']; ?>:</div>
