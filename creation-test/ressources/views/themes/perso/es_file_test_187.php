...
<?php
 ...
 {
       $texte = array("¡Cuando lo doblamos en una cola!","Cuando su teléfono no tiene batería!",
"Cuando su peluquero hace desastres!", "¡Cuando su madre lo llama 10 veces al día!", "Cuando un mosquito le impide dormir"
,"¡Cuando está lloviendo y él no tiene paraguas!","Cuando la gente habla a sus espaldas","Cuando la gente susurra en el cine");    
 }
 else
 {
           $texte = array("¡Cuando lo doblamos en una cola!","Cuando su teléfono no tiene batería!",
"Cuando su peluquera hace desastres!", "¡Cuando su madre lo llama 10 veces al día!", "Cuando un mosquito le impide dormir"
,"¡Cuando está lloviendo y ella no tiene paraguas!","Cuando la gente habla a sus espaldas","Cuando la gente susurra en el cine ");
 }
...
<div id="titretest" >¿Cuáles son las 5 cosas que más odia <?php echo urldecode($_GET['user_name']); ?>?</div>
<div class="name texte" id="name_user" ></div>
