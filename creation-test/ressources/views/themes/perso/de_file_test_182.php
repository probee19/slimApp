...
<div id='titre'><span style="font-size:40px;"><?php echo urldecode($_GET['user_name']); ?>,</span><br>du wirst haben <br><?php echo $nb_enfants;?> Kind (er)</div>
<div id='boys'><?php echo $garcon ?>Jungen)</div>
<div id='girls'><?php echo $fille?> Tochter (en)</div>
