...
<div class="texte" id="texte_top">  Qui me suit en secret ?  </div>
...
<div class="texte" id="paragraphe"><?php echo urldecode($_GET['user_name']); ?>, <?php echo urldecode($_GET['friend_first_name_1']); ?>  te suit en secret !  </div>
