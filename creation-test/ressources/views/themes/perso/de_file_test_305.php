...
$message = array('Mutig','Bewundernswert','bezaubernd','Ehrlich','Stabil','Zärtlich','Einzigartig','Freiwillig','hervorragend','Gut','Heroisch');  
shuffle($message);

?>
<div id="message0"> <?php echo ''.urldecode($_GET['user_name']).'' ?></div>
<div id="message"> <?php echo 'Ihre beste Qualität:<br>- '.$message[0].' -'; ?></div>
