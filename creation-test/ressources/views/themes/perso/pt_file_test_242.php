...
<?php
          $actions = array('entre com você','chore todos os momentos','roube seu computador','roube toda a comida na sua geladeira','envie Derrick para encontrá-lo',
          'cuide da sua família','roube todas as suas roupas','obtenha sua conta bancária');
          shuffle($actions);
