...
<?php
$texte = array("solo dice cosas interesantes","es gracioso","es misterioso","es bonito","abrazos de amor","es listo","transmite su joie de vivre","se ha completado", "cuidar de ella","es inaccesible"
,"tiene sentido del humor","es apasionado","es burbujeante y enérgico","tiene sentido del humor","está listo para comprometer","Me gusta ir a caminar", "saber lo que ella quiere"
,"es una mujer independiente","es amable y considerado");
 shuffle($texte);
?>
...
<div id="titretest" >¿Por qué <?php echo urldecode($_GET['user_name']); ?> es una mujer perfecta?</div>
<div class="name texte" id="name_user" ></div>
