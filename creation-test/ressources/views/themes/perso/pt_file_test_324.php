...
<?php     
          ...
          $nb_mots = count($nom);
          $significations = array('honestidade','Liderança','motivação','perseverança','coragem','força','fidelidade');
          ...
          foreach($nom as $mot){
                    $signification .= '<div class="one_line underline" style="font-size:'.$font_size.'px;"><span class="nom" >'.$mot.'</span> significa : </div> 
