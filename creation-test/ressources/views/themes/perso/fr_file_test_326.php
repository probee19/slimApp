...
<div class="texte" id="head">  Combien de personnes ont visité ton profil aujourd'hui ?  </div>
...
<div class="texte" id="visite">
          ...
          <div class="texte" id="compteur"> <?=mt_rand(75,204)?> <div class="texte" id="lab_compteur">  visites </div> </div>
</div>
