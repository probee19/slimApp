...
<?php
          $qualites = array('sincerity','the precision','the competence','kindness','Romanticism', 'faithfulness','bravery','courage','honesty','perseverance','loyalty','the leadership');
          shuffle($qualites);
?>
<!DOCTYPE HTML>
...
<div class="texte" id="header"><?php echo urldecode($_GET['user_name']); ?>, based on our deep analysis, the quality that best describes you is:</div>

<div class="texte" id="quality"><?=$qualites[0]?></div>

<div class="texte" id="footer">( accurate to <?=mt_rand(94,99)?> % )</div
