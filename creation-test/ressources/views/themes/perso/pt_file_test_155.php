          ...
          <div class='main'>
            ...
            <?php
                $don = array('Sua lealdade','Sua Honestidade','Seu coração macio','Seu charme natural','Sua fé','Bondade sua','Sua compaixão','Sua perseverança');
                shuffle($don);
            ?>
            <img src="http://creation.funizi.com/images-theme-perso/1508587038.jpg" id="background">
            <span id="titre" class="titre">Que presente você recebeu de Deus?</span>
