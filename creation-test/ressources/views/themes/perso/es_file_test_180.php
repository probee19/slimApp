...
<?php
      if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
               $message = array('Que dejes de beber','que tienes mucho dinero','que tienes mucho dineromais sans avoir comment ','que comes mucho pero no engordas','que eres hermosa, mujeriego y borracha',
'que a menudo cambias novias','que aquellos que te conocen no te olviden','que besaste a muchas chicas','que te gusta tener varias novias');          }
            else{ 
               $message = array('que tienes mucho dinero','que comes mucho pero no engordas','que tienes mucho dineromais sans avoir comment ','que hiciste cirugía estética porque eres súper hermosa',
'que te gustan las cosas refinadas','que aquellos que te conocen no te olviden');
            }
