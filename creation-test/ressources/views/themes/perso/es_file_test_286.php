...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
                    $amour = array('Casado','Casado, 2 children','Casado, 3 children','Casado, 2 twins','Casado, 1 child');
                    $carriere = array('Científico','Agente estrella','Famoso Vlogger','Fotógrafo de estrellas','Famoso poeta');
                    $argent = array('2 cuentas bancarias con millones de dólares','$ 2,000,000 al año','$ 2,500,000 al año','Dueño de 3 casas improvisadas','Millonario. Dueño de 5 villas grandes. ');
                    $accomplissement = array('Doctor en Filosofía','Creando tu propia empresa','Ayuda de muchas organizaciones benéficas','Dueño de una importante marca de automóviles','Amigo de las celebridades','Dueño de una glamurosa discoteca');
          }
          else{
                    $amour = array('Casado','Novia, 2 hijos','Novia, 3 hijos','Novia, 2 gemelos','Novia, 1 niño');
                    $carriere = array('Científico','Agente estrella','Vlogger famoso','Fotógrafo de estrellas','Famoso poeta');
                    $argent = array('2 cuentas bancarias con millones de dólares','$ 2,000,000 al año','$ 2,500,000 al año','Dueño de 3 casas improvisadas','Millonario. Dueño de 5 villas grandes. ');
                    $accomplissement = array('Doctor en Filosofía','Creando tu propia empresa','Ayuda de muchas organizaciones benéficas','Dueño de una importante marca de automóviles','Amigo de las celebridades','Dueño de una glamurosa discoteca');
...
<div class="texte box" id="box_heart"> Amor </div>
...
<div class="texte box" id="box_job"> Carrera </div>
...
<div class="texte box" id="box_money"> Dinero </div>
...
<div class="texte box" id="box_done"> logro </div>
