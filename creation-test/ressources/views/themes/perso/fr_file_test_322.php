...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
                    $amour = array(' 5 enfants, 18 petits-enfants ',' 45 petits-enfants ',' 4 enfants, 21 petits-enfants  ',' 7 enfants, 28 petits-enfants  ');
                    $carriere = array(' Scientifique ',' Pilote ',' Poète célèbre ');
                    $argent = array(' 2 comptes bancaires avec des miilions de dollars ',' 15 000 000 $ ',' 12 500 000 $ ',' Propriétaire de 3 maisons de fortune ',' Millionnaire. Propriétaire de 5 grandes villas.  ');
                    $accomplissement = array(' Création de sa propre société ',' Aide de nombreuses oeuvres caritatives ',' Propriètaire d\'une grande marque automobile ',' Conseiller du Président de la République ');
          }
...
<div class="texte box" id="box_heart">  Famille  </div>
