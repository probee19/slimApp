...
#nouvelle_bottom{position:absolute; z-index:2; left: 420px; width:360px; bottom: 50px; font-size:30px; color:#FFBF00;line-height:30px; text-align:center; font-family: 'Raleway', sans-serif;} 
   ...
   <?php
                ...
                $message_1 = array('"Neue Begegnungen"','"Gelassenheit"','"Der Reichtum"','"Projekte"','"Erneuerung"');
                $message_2 = array('Du wirst nie alleine sein.','Du wirst inneren Frieden finden!','Ihr Bankkonto wird es Ihnen danken.','Nutzen Sie die Möglichkeiten!','Sie werden nichts dem Zufall überlassen!');
...
<div class="name texte" id="name_user" >Das Jahr des<?php echo urldecode($_GET['user_name']); ?> :</div>
