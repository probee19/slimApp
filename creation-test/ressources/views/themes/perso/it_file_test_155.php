          ...
          <div class='main'>
            ...
            <?php
                $don = array('La tua lealtà','Vostra onestà','Il tuo cuore tenero','Il tuo fascino naturale','La tua fede','La tua gentilezza','La tua compassione','La tua perseveranza');
                shuffle($don);
            ?>
            <img src="http://creation.funizi.com/images-theme-perso/1508587038.jpg" id="background">
            <span id="titre" class="titre">Quale dono hai ricevuto da Dio?</span>
