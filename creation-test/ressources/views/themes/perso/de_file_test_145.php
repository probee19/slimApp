...
#mot3{position:absolute; z-index:1; left: 0px; top: 160px;}
   ...
   if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
		 $mot = array('Klug','Job','Famille','Ehrlich','Zärtlich','Visionär','Ernst','Freundschaft');
   }
   else{
		 $mot = array('intelligent','Job','Familie','Ehrlich','zärtlich','Visionär','ernst','Freundschaft');
   }
  ...
  <img src="http://creation.funizi.com/images-theme-perso/1508526452.jpg" id='background'>
      <div id='titre_test'>Was sind die 3 Wörter, die dich beschreiben?</div>
