...
<div class="name texte" id="name_user" ><?php echo urldecode($_GET['user_name']); ?>, vas a tener <span style="color:#C03A2B; font-weight:normal; font-size:40px; ">
          <?php echo rand(5,35) ?></span> relaciones en tu vida!<br><br><span>Precisión <?php echo rand(95,99) ?>.<?php echo rand(1,9) ?>%</span></div>
