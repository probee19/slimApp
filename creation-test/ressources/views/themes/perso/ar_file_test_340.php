...
<?php
          $sentiments = array('بسلام','أحب','متحفز، مندفع','مرغوب');
          $explications = array('لديك تأثير مهدئ على الجميع من حولك. أنت تقبل الحياة كما هي وأنت تشارك حكمة مع الناس الذين لديهم مشاكل.',
          'You have a very rare gift; you have the ability to make people feel noticed and أحب. Your openness and understanding help people feel themselves.',
          'في بعض الأحيان يحتاج الناس إلى دفعهم لتحقيق أحلامهم. هذا هو المكان الذي تتدخل فيه. تشع العزيمة والتفاؤل. دفعة حقيقية لمعنويات',
          'يختفي الشعور بالوحدة عندما تكون معك. ينتشر لطفك والطاقة المعديه فرح كل من حولك. شعاع حقيقي من أشعة الشمس.');
...
<div class="texte" id="head_text">إليك كيف يشعر الناس بحضورك</div>
