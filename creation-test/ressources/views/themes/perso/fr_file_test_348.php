...
<?php
          $mots = array(' Bonne fête des mères. Je pense à toi avec beaucoup d\'amour et de tendresse ! ',
          ' Bonne fête à la maman la plus géniale que l\'histoire ait connue ! ',
          ' Grâce à toi, je suis moi ! <br> Merci...et bonne fête. ',' Bonne fête à ma maman, mon ange, mon amie ! ',
          ' Aucune langue ne peut exprimer la beauté et la force d’une mère. <br> Bonne fête Maman. '
          );
          shuffle($mots);
?>
<!DOCTYPE HTML>
