...
<?php
      if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
               $type = array('أنت مرسيليا صحيح','متعصب حقيقي');
               $message = array('أنت مع فريقك في النصر كما في الهزيمة','هنا مرسيليا','إلى الأبد أولا','لا رحمة ل كلاسيكو');          }
            else{ 
               $type = array('أنت مرسيليا صحيحe','متعصب حقيقي');
              $message = array('أنت مع فريقك في النصر كما في الهزيمة','هنا مرسيليا','إلى الأبد أولا','لا رحمة ل كلاسيكو'); 
            }
