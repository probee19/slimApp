...
<?php
          $textes = array('{؟ user_name؟} يعطي نصيحة دائما.','{؟ يظهر user_name؟} حبه للجميع.','{؟ يحب user_name؟} دون قيد أو شرط.','{؟ هل سيفعل user_name؟} أي شيء لعائلته.',
          '{؟ user_name؟} دائما نموذج للآخرين.','{؟ سوف يذهب إلى نهاية العالم مع أصدقائه.','{؟ user_name؟} ينتشر الفرح والسعادة','{؟ user_name؟} لا تستسلم أبدًا.',
          '{؟ user_name؟} دائما شجاع.','{؟ user_name؟} لا يزال متفائلاً.','{؟ يعرف user_name؟} كيف يغفر.','{؟ سوف user_name؟} أبدا خداع أصدقائه.');
          shuffle($textes);
?>
<!DOCTYPE HTML>
