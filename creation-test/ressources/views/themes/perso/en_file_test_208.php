...
<div class="name texte" id="name_user" ><span style="font-size:30px">Me <span style="color:#EF372C"><?php echo urldecode($_GET['user_name']); ?></span></span>,<br> I say <span style="color:#EF372C">STOP</span><br> at the auction in<span style="color:#EF372C">Libya</span> migrants like <span style="color:#EF372C">slaves</span> !</div>
