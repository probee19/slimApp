...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
                    ...
                    $details = array('أنت اليقظة الحقيقية وقادرة على كل شيء لحماية لك.','كنت محبوبا واحتراما وقادرة على الحفاظ على الأسرار التي تهدد استقرار بلدك.',
                    'كنت مقاتلا هائلا مع الاستخبارات غير عادية','','كنت عالما على مستوى عال وكنت تمتلك قوة خارقة والتحمل',
                    'أنت قائد عظيم ولديك قدرات خارقة.','أنت مستشار مخلص، رجل ثقة.');
                    $ind = mt_rand(0,6);
          }
          else{
                    $personnages = array('Ramonda','Nakia','Okoye','Shuri');
                    $images = array('1519662856','1519662954','1519663017','1519663589');
                    $details = array('أنت مستشارة سرية، أم ملكة.',
                    'أنت محارب حقيقي قادر على قيادة أي مهمة لتحرير المظلومين.','أنت جنرال مخلص ومخلص.',
                    'أنت أميرة، عبقرية قادرة على أن تكون مسؤولة عن العديد من الابتكارات التكنولوجية.');
                    $ind = mt_rand(0,3);
          }
