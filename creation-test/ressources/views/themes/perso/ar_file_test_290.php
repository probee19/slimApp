...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
                    ...
                    $details = array('كنت الحارس الحقيقي وقادرة على كل شيء لحماية لك.','أنت محبوب ومحترم وقادر على الحفاظ على الأسرار التي تهدد استقرار بلدك.',
                    'أنت مقاتل هائل مع ذكاء غير عادي','','أنت عالمة عالية المستوى ولديك قوة خارقة وقدرة على التحمل',
                    'أنت قائد عظيم ولديك قدرات فوق طاقة البشر.','أنت مستشار أمين ، رجل ثقة.');
                    $ind = mt_rand(0,6);
          }
          else{
                    $personnages = array('Ramonda','Nakia','Okoye','Shuri');
                    $images = array('1519662856','1519662954','1519663017','1519663589');
                    $details = array('أنت مستشارة سرية ، أم كوين.',
                    'أنت محارب حقيقي قادر على قيادة أي مهمة لتحرير المضطهدين.','أنت جنرال مخلص ومخلص.',
                    'أنت أميرة ، عبقرية قادرة على تحمل المسؤولية عن العديد من الابتكارات التكنولوجية.');
                    $ind = mt_rand(0,3);
          }
