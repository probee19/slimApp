...
<?php
$texte = array('Eres una persona de belleza perfecta, puedes poner a cualquiera en tu bolsillo','¡Guauu! Con esta magnífica belleza que tienes, ¡todos te buscan!','¡Solo hablamos de ti! ¡Tienes una belleza extraordinaria!');
$score = array('11','12','10');
$k = mt_rand(0,2);
?>
<div class="texte" id="top"> <?php echo urldecode($_GET['user_name']); ?> ¡ESTA ES TU PUNTUACIÓN! </div>
