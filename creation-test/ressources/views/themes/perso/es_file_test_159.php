...
<?php
$message_1 = array('¿Quién tiene ropa de bebé?<br> ¡Estamos esperando pequeños gemelos! :)', 'Mamá, papá, lamento anunciar que seréis ABUELOS!');
$message_2 = array('Qué !!!!:)','¡Sospeché algo! <3 ¡Felicitaciones!');
$message_3 = array('Felicitaciones a ustedes 2 !!! No puedo creerlo','Está bien, ¿está confirmado? ¡Harás padres maravillosos!');
$date = array('22 de diciembre a las 22:53','11 de marzo a las 8:03 p.m.','13 de junio a las 21:43');shuffle($date);
