...
<?php
  ...
  $texte = array(''.$_GET['user_name'].' mantenere i segreti!', 'Con '.$_GET['User_name'].' Non ci annoiamo mai!', ''.$_GET['user_name'].' è semplicemente adorabile!',
  ''.$_GET['user_name'].' può dare tutto per amicizia!',''.$_GET['user_name'].' sa come dare buoni consigli!', 
  ''.$_GET['user_name'].' prepara meravigliose sorprese!',''.$_GET['user_name'].' sa come rendere la vita più bella!');
shuffle($texte);
?>
...
<div id="titretest" >Il <span style="color:#D90000">5 motivi</span> essere amici con <br><?php echo $_GET['full_user_name']; ?></div>
