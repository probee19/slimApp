...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
                   $sis = array('Retenlo, debes casarte con él.','No lo dejes ir, él es amable.','Espera, él es protector.','Recuerde, él es un esposo perfecto.'
                    ,'Espera, él es fiel.','Espera, es galante. ');
          else
                   $sis = array('No la dejes ir, tienes que casarte con ella.','Retenerlo, ella es amable.','No la dejes ir, ella es una esposa perfecta.'
                    ,'Recuerde, ella es fiel y leal.','Retenerlo, ella será una buena madre.');
          shuffle($sis);
?>

<div class="texte" id="sis_1"> Si su nombre es </div>
