...
<div id="honnete"><span class="result"><?php $pourcentageH=rand(92,100); echo $pourcentageH;?>%</span><span style="font-size:23px">honnête</span></div>
<div id="malhonnete"><span class="result"><?php echo 100-$pourcentageH;?>%</span><span style="font-size:23px">Malhonnête</span></div>
