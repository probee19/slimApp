...
<?php
          $significations = array('fiducia','lealtà','pace','prosperità','coraggio','coraggio','dignità','gentilezza','forza');
...
<div class="texte" id="texte1"> 100% sangue reale </div>
<div class="texte" id="texte2"> si intende </div>
