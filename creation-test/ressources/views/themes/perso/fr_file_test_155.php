          ...
          <div class='main'>
            ...
            <?php
                $don = array('Ta loyauté','Ton Honnêteté','Ton coeur tendre','Ton charme naturel','Ta Foi','Ta gentillesse','Ta compassion','Ta persévérence');
                shuffle($don);
            ?>
            <img src="http://creation.funizi.com/images-theme-perso/1508587038.jpg" id="background">
            <span id="titre" class="titre">Quel don as-tu reçu de Dieu?</span>
