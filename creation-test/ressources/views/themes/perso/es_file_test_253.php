...
<!DOCTYPE HTML>
<?php
          $reves = array('Tendrás un auto nuevo','Te mudarás a una nueva villa','Te harás rico','Ganarás un premio nacional',
          'Tendrás un aumento salarial','Te casarás con una rica celebridad','Tendrás un nuevo hijo');
          shuffle($reves);
?>
