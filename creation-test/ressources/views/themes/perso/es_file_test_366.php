...
<?php 
          $texte = array('Mis pensamientos a las víctimas de las lluvias torrenciales en Abiyán','Yako a mis amigos de Costa de Marfil. Sinceramente con Costa de Marfil.');
          shuffle($texte);
?>
<!DOCTYPE HTML>
