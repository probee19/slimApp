...
<?php
 $nom_explication = array('honestidade','sinceridade','amor','franquia','fidelidade', 'autenticidade','paciência','coragem', 'sensibilidade','generosidade','sabedoria');
...
<div>=</div><div style="color:#FFF"><?php echo strtoupper ($nom_explication[0]) ?></div><div style="color:#FFF; font-size:20px;">mas também</div> <div style="color:#FFF"><?php echo strtoupper ($nom_explication[1]) ?></div>
</div>
</div>
