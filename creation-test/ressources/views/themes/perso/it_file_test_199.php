...
#nouvelle_bottom{position:absolute; z-index:2; left: 420px; width:360px; bottom: 50px; font-size:30px; color:#FFBF00;line-height:30px; text-align:center; font-family: 'Raleway', sans-serif;} 
   ...
   <?php
                ...
                $message_1 = array('"Nuovi incontri"','"Serenità"','"La ricchezza"','"progetti"','"Rinnovo"');
                $message_2 = array('Non sarai mai sola.','Troverai la pace interiore!','Il tuo conto bancario ti ringrazierà.','Cogli le opportunità!','Non lascerai niente al caso!');
...
<div class="name texte" id="name_user" >L&#39;anno di<?php echo urldecode($_GET['user_name']); ?> :</div>
