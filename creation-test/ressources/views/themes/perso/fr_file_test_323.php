...
<?php
          $like = array(' sa famille ',' ses amis ','donner',' sa passion pour les voyages ',' offrir un sourire ',' aider les gens ');
          $dislike = array(' les menteurs ',' les frimeurs ',' les gens grognons ');
          $nature = array(' fidèle ',' empathique ',' sociable ');
          $personnalite = array(' aime partager ',' n\'est pas égoïste ',' fait rire tout le monde ');
...
<div class="texte ligne" id="ligne1">   Aime  :  </div>
<div class="texte resultat" id="resultat1"> <?=$like[0];?> </div>

<div class="texte ligne" id="ligne2">   Déteste  :  </div>
<div class="texte resultat" id="resultat2"> <?=$dislike[0];?> </div>

<div class="texte ligne" id="ligne3">   Nature  :  </div>
<div class="texte resultat" id="resultat3"> <?=$nature[0];?> </div>

<div class="texte ligne" id="ligne4">   Personnalité  :  </div>
