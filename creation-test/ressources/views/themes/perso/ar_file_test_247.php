...
<?php
          $houses = array('فيلا 20،000،000 $', 'فيلا فاخرة من 15،000،000 $', 'مبنى في ميامي', 'جزيرة فقط لأجلك');
          $cars = array('A مرسيدس الفئة A','A لامبورغيني أوروس' ,'بي إم دبليو الفئة السابعة');
          $calls = array('آيفون X', 'A غالاكسي S9');
          $trips = array('عطلة في بورا بورا','15 يوما من الجنون في دبي','بالي العطل', 'إقامة في لندن');
          $money = array('شيك بمبلغ 5000 دولار أمريكي', 'شيكا بمبلغ 10000 دولار أمريكي', 'شيكا بمبلغ 15،000 دولار أمريكي');
...
<div class="footer" id="footer" >... من أصدقائك!</div>
