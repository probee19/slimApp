...
<?php
          $qualites = array('Somos los campeones mundiales de fútbol 2018','¡La gastronomía francesa está clasificada en la UNESCO!','Somos los inventores brillantes de \"French Kiss\".',
          '¡Daft Punk hace bailar a todo el mundo!','Tenemos el mille-feuille!','Francia es la nación de Champagne.','¡Los franceses encarnan elegancia y romance!','¡Tenemos las mejores papas fritas del mundo!');
          shuffle($qualites);
?>
<!DOCTYPE HTML>
