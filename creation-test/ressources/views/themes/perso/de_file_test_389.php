...
<?php
  ...
  $texte = array(''.$_GET['Benutzername'].' Geheimnisse bewahren!', 'Mit '.$_GET['Benutzername'].' Uns wird nie langweilig!', ''.$_GET['user_name'].' ist einfach bezaubernd!',
  ''.$_GET['user_name'].' kann alles durch Freundschaft geben!',''.$_GET['user_name'].' weiß, wie man guten Rat gibt!', 
  ''.$_GET['user_name'].' bereitet wunderbare Überraschungen vor!',''.$_GET['user_name'].' weiß, wie man das Leben schöner macht!');
shuffle($texte);
?>
...
<div id="titretest" >Das <span style="color:#D90000">5 Gründe</span> mit ihnen befreundet sein <br><?php echo $_GET['full_user_name']; ?></div>
