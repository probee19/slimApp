...
<?php 
           if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
                   $faits = array('perdona a todos','ama a su familia','hará todo por sus amigos','nunca te rindas','es muy paciente',' es un luchador','es valiente',
                         'nunca lastima a una persona','siempre está sonriendo','siempre encuentre tiempo para sus amigos','siempre superar una falla','ama a su madre');
          else
                    $faits = array('perdona a todos','ama a su familia','hará todo por sus amigos','nunca te rindas','es muy paciente','es un balanceo','es valiente',
                         'nunca lastima a una persona','siempre está sonriendo','siempre encuentre tiempo para sus amigos','siempre superar una falla','ama a su madre');
...
<div id="header"> 7 datos sobre <?php echo urldecode($_GET['user_name']); ?></div>
<hr>
<div id="profile_img">
