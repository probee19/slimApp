...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
                    $amour = array('5 bambini, 18 nipoti','45 nipoti','4 bambini, 21 nipoti','7 bambini, 28 nipoti');
                    $carriere = array('Scienziato','Pilota','Poeta famoso');
                    $argent = array('2 conti bancari con milioni di dollari','$ 15.000.000','$ 12,500,000','Proprietario di 3 case di fortuna','Milionario. Proprietario di 5 grandi ville. ');
                    $accomplissement = array('Creare la propria azienda','Aiuto di molte organizzazioni benefiche','Proprietario di un importante marchio automobilistico','Consigliere del Presidente della Repubblica');
          }
...
<div class="texte box" id="box_heart"> Famiglia </div>
