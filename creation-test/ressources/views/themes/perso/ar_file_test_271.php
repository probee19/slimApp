...
<?php
 if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
               $message_1 = array('{؟ user_name؟} رئيسا لبلده بنسبة 98.9٪ من الأصوات','{؟ user_name؟} قد تم مجرد التصويت على الرجل الأكثر جمالا في الكون',
               '{؟ اسم المستخدم؟} يصبح ثروة العالم الثاني وراء بيل غيتس',
               '{؟ user_name؟} اشترى بلده فقط',
               '{؟ user_name؟} يكتشف علاج السرطان',
               '{؟ اسم المستخدم؟} يمنع الغزو الأجنبي',
               '{؟ اسم المستخدم؟} يجعل السلام في العالم');
     }
            else{ 
           $message_1 = array('{؟ user_name؟} انتخب رئيسا لبلدها بنسبة 96.9٪ من الأصوات', '{؟ user_name؟} انتخب امرأة أجمل في الكون',
           '{؟ اسم المستخدم؟} يصبح ثروة العالم الثاني وراء بيل غيتس',
               '{؟ user_name؟} اشترى بلده فقط',
               '{؟ user_name؟} يكتشف علاج السرطان',
               '{؟ اسم المستخدم؟} يمنع الغزو الأجنبي',
