...
<div class="texte" id="texte_top">Quem está me seguindo em segredo? </div>
...
<div class="texte" id="paragraphe"><?php echo urldecode($_GET['user_name']); ?>, <?php echo urldecode($_GET['friend_first_name_1']); ?> Siga-o em segredo! </div>
