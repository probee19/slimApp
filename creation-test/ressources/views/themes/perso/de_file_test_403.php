...
<?php
          $qualites = array('Wir haben Jacques Brel, Stromae, Selah Sue, Loïc ...','Wir haben Tintin, Lucky Luke!','In jedem Dorf finden Sie ein großes Fest.',
          'Wir sind wirklich gut in der Sprache ...','Wir haben großartige Hopfengetränke!','Wir haben die besten Schokoladen der Welt?','Wir haben Jean-Claude Van Damme?','Wir haben die besten Pommes frites der Welt!');
          shuffle($qualites);
?>
<!DOCTYPE HTML>
