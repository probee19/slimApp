...
<?php
 $texte = array('Dropped arms','It&#39;s a mess','Single','Secretly in a relationship');
 $texte1 = array('Hesite between 2 people','Broken Heart','Officially in a relationship','Finally as a couple','In couple and happy','Hands off ! heart already taken !');
 shuffle($texte);
 shuffle($texte1);
?>
