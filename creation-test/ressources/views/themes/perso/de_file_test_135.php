          ...
          <div class='main'>
            ...
            <!DOCTYPE HTML> <?php $diagnostic = array('Ansteckender Humor','Erweiterte Freundlichkeit','Akute Loyalität','Viraler Optimismus','Unheilbare Sinnlichkeit');
            $niveau = array('Ernst','Alarmierend','Hochgradig ansteckend');
            shuffle($diagnostic); shuffle($niveau); ?>
            <img src="http://creation.funizi.com/images-theme-perso/1508420459.jpg" id="background">
            <div id="certificat">Ärztliche Bescheinigung</div> <div id="name">Name:</div>
            <div id="name_reponse"> <?php echo urldecode($_GET['user_name']); ?></div> <div id="diagnostic">Diagnose:</div>
