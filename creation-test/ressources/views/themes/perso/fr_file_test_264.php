...
<?php
 ...
 $mots = ['Akloakloa','Bon Albert','Chapchap','Dédjassez','Enjaillé','Fan gninnin','Gbaissai','Habi !!!','Ivoiro','Je suis bôrô','Kpakpatoyas','lessandja','Mouk de moi',
 'Nikélé','Oridjazzy','Piah','quel wé','Routard','Serrer les kpakites','Tchèkè','un boumssi','vigo...humm (!?)','woulé','Xtra','Yé sui fanta dji',
 'Zinzin d\'enjaillement','Afoulangahi','Batouala','Ca ê dans kpokan','Djampant','En zogobadi','Faut blèblè','Grigra','Homologer','Il y a drap','Jaba','ket','Léna','manhan-minhin','Nafro','ouétsa','pleces','Quitte la route !','roussabade','Sababou','Takloukoudji','un zidane','Vladir','walo','Y\'a drap!','zina'];
