...
<?php
          $surprises = array('Você terá um bebê. '.$_GET[' User_name'].' A família terá um novo tesouro!', 
                    'Difícil escolher '.$_GET[' User_name'].'. Muitas coisas melhorarão no próximo ano!',
                    'Você receberá um novo trabalho perfeito que irá perfeitamente atender às suas expectativas!',
                    'Você terá uma promoção profissional durante este ano',
                    'Você fará uma jornada rica em experiências e descobertas!');
          shuffle($surprises);
?>
<!DOCTYPE HTML>
