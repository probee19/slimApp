...
<?php
  if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
            $texte = array('glücklich','Führer','Ehrlich','Leistungsstark','Führer','Erfolg');
  }
            else{ 
...
<div class='photo' style="top:0;left:200px">
 <img src="https://graph.facebook.com/<?php echo $_GET['fb_id_user']; ?>/picture/?width=275&height=275" class="img_profile" id="fb_id_user" style=" opacity: 0.5;">
</div>
