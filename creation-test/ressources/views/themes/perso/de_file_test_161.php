...
<div class="texte" id="titre_top">Wer hat deine Facebook Fotoalben angeschaut? </div>
...
<div class="texte" id="phrase"> <span class="name"><?php echo urldecode($_GET['friend_first_name_1']); ?></span> schaute auf die Bilder von <span class="name"><?php echo urldecode($_GET['user_name']); ?></span> <?php echo mt_rand(20,37);  ?>heute </div>
