...
<?php
 $nom_explication = array('Ehrlichkeit','Aufrichtigkeit','Liebe','Franchise','Loyalität', 'Authentizität','die Geduld','Mut', 'Empfindlichkeit','Großzügigkeit','Weisheit');
 shuffle($nom_explication);
?>
<img src="http://creation.funizi.com/images-theme-perso/1508771127.jpg" id="background"> <img src="<?php echo urldecode($_GET['url_img_profile_user']); ?>" class="img_profile" id="fb_id_user">
<div class="name texte" id="name_user" ></div>
<div id="message"> 
<div style="font-family: 'Lobster', cursive; color:#FFFF00"><?php echo urldecode($_GET['user_name']); ?>
<div>=</div><div style="color:#FFF"><?php echo strtoupper ($nom_explication[0]) ?></div><div style="color:#FFF; font-size:20px;">aber auch</div> <div style="color:#FFF"><?php echo strtoupper ($nom_explication[1]) ?></div>
</div>
</div>
