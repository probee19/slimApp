...
<div>=</div><div style="color:#FFF; text-transform:uppercase"><?= $nom_explication[0] ?></div><div style="color:#FFF; font-size:20px;">aber auch</div> <div style="color:#FFF; text-transform:uppercase"><?=$nom_explication[1]?></div>
</div>
</div>
