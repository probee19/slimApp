...
<?php
          $actions = array('entra con te','piangere ogni momento','rubare il tuo computer','ruba tutto il cibo nel tuo frigo','coinvolgere Derrick per trovarti',
          'prenditi cura della tua famiglia','rubare tutti i tuoi vestiti','prendi il tuo conto in banca');
          shuffle($actions);
