...
<!DOCTYPE HTML>
<?php
          $surprises = array('أنت ستتزوج.','سيكون لديك سيارة جديدة كهدية.','أنت ذاهب للحصول على الانخراط.','سوف تتصل بك السابقين.',
                    'سيكون لديك عطلة في ميامي.', 'أنت ذاهب إلى التوائم');
