...
<?php
          $surprises = array('Ich werde einen neuen Job haben.', 'wird zunehmen.', 'wird heiraten.', 'werde ein neues Kind haben.', 'wird ein Treffen machen, das sein Leben verändern wird.', 'wird verlobt werden.');
...
<div id="texte_surprise" >Im Jahr 2018, <?php echo urldecode($_GET['user_name']); ?> <?php echo $surprises[$index]; ?></div>
