...
#fb_id_user{position: absolute; z-index:1; left: 50px; top: 100px; width:200px ; border-radius:100px; max-width:800px; max-height:420px; border:3px solid #09843F ;}
#name_user{position:absolute; z-index:1; left: 0px; top: 280px; font-size:30px; color:#FFF; text-align:center; width:300px;}
#name_user span{padding:5px; background:#09843F ; color:#FFF;border-radius:10px; font-size:0.7em;}
#resultat{position:absolute; z-index:1; left: 350px; top: 120px; font-size:40px; color:#000; width:400px; height:200px;line-height:45px; text-align:center;}
              </style>
