          ...
          <div class='main'>
            ...
            <!DOCTYPE HTML> <?php $diagnostic = array('Humor contagioso','Amabilidad avanzada','Lealtad aguda','Optimismo viral','Sensualidad incurable');
            $niveau = array('Grave','Alarmante','Altamente contagioso');
            shuffle($diagnostic); shuffle($niveau); ?>
            <img src="http://creation.funizi.com/images-theme-perso/1508420459.jpg" id="background">
            <div id="certificat">Certificado médico</div> <div id="name">Nombre:</div>
            <div id="name_reponse"> <?php echo urldecode($_GET['user_name']); ?></div> <div id="diagnostic">Diagnóstico:</div>
            <div id="diagnostic_reponse"><?php echo $diagnostic[0]; ?></div> <div id="niveau">Nivel:</div>
