...
<?php
          $surprises = array('will have a new job.', 'will have an increase.', 'will marry.', 'will have a new child.', 'will make a meeting that will change his life.', 'will get engaged.');
...
<div id="texte_surprise" >During the year 2018, <?php echo urldecode($_GET['user_name']); ?> <?php echo $surprises[$index]; ?></div>
