...
#mot3{position:absolute; z-index:1; left: 0px; top: 160px;}
   ...
   if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
		 $mot = array('Clever','Job','Famille','Honest','Affectionate','Visionary','Serious','Friendship');
   }
   else{
		 $mot = array('intelligent','Job','Family','Honest','affectionate','Visionary','serious','Friendship');
   }
