          ...
          <div class='main'>
            ...
            <?php
                $nature = array('Alegre','feliz');
                $personnalite = array('St.', 'crente', 'grave');
                $aime = array('Modéstia','A simplicidade');
                $deteste = array('A mentira','Traindo','A traição');
                $force = array('Motivação','O poder','dinheiro');
            ...
            <span id="titre" class="titre"> Qual é a sua personalidade <?php echo urldecode($_GET['user_name']); ?>?</span>
            ...
            <span id="texte_1" class="texte"> <b>Natureza:</b> <?php echo $nature[0] ?></span>
            <span id="texte_2" class="texte"> <b> Personalidade:</b> <?php echo $personnalite[0] ?></span>
            <span id="texte_3" class="texte"> <b>Ame :</b> <?php echo $aime[0] ?></span>
            <span id="texte_4" class="texte"> <b> Ódio:</b> <?php echo $deteste[0] ?></span>
            <span id="texte_5" class="texte"> <b> Força:</b> <?php echo $force[0] ?></span>
            <span id="texte_6" class="texte"> <b> Fraqueza:</b> <?php echo $faiblesse[0] ?></span>
