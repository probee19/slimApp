...
<?php
          ...
          $qualites = array('veloce','tecnico','tattico','intelligente','Atletico','Calma','Intelligente');
...
<div class="texte" id="foot"><span class="green"><?php echo $_GET['user_name']; ?></span> sembra  <span class="red"><?=$joeurs[$ind]?></span> </div>
