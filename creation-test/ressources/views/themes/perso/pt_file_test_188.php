...
<?php
$texte = array("só diz coisas interessantes","é gracioso","é misterioso","é bonito","Abraços de amor","é inteligente","transmite sua alegria de viver","é cumprido", "cuide dela","é inacessível"
,"tem um senso de humor","é apaixonada","é borbulhante e enérgico","tem um senso de humor","está pronto para comprometer","gosta de dar um passeio", "sabe o que ela quer"
,"é uma mulher independente","é amável e atencioso");
 shuffle($texte);
?>
...
<div id="titretest" >Por que <?php echo urldecode($_GET['user_name']); ?> é uma Mulher perfeita?</div>
<div class="name texte" id="name_user" ></div>
