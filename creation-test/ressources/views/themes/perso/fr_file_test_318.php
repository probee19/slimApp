...
<?php
          $pour = array(' pour ses excellents services de garde du corps ',' pour ses talents d\'acteur ',' pour les bains qu\'il donne aux lions ',' pour son talent comique ');
          $en = array(' en reconnaissance de son soutien et de sa protection de tous les instants ',' en reconnaissance de sa personnalité qui rend le monde un peu moins ennuyeux ',' en reconnaissance des bains qu\'il arrive à donner aux lions sans aucun accident ',' en reconnaissance de son humour qui donne le sourie à tout le monde ');
          $ind = mt_rand(0,3);
?>
<!DOCTYPE HTML>
...
<div class="texte" id="header_t">  Certificat de réussite  </div>

<div class="texte" id="header_t_2">  fièrement délivré à  </div>
...
<div class="texte" id="deliv" > Reconnaissance délivrée et reconnue par : </div>
