...
<div class="texte" id="head_club"> Interested clubs :</div>
...
<div class="texte" id="cout"> Cost : <span style="color:#f1c40f; font-weight:700"><?=$couts?> M€</span> <?php if($couts>220) echo "<br><span style='color:#e74c3c; font-weight:700;text-transform:uppercase'> World record</span> ";?> </div>
