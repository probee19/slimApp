...
$message = array('Valiente','Admirable','Adorable','Honesto','Estable','Oferta','Único','Voluntario','magnífico','Bueno','Heroico');  
shuffle($message);

?>
<div id="message0"> <?php echo ''.$_GET['user_name'].'' ?></div>
<div id="message"> <?php echo 'Tu mejor calidad:<br>- '.$message[0].' -'; ?></div>
