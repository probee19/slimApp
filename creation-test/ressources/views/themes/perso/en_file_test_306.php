...
<?php
          $rev = array('You are tranquility in person.','You embody wisdom.','You are trustworthy.','You have a great courage',
          'We can always trust you.','You have the creative spirit.','You have a good heart.','You have a high sense of loyalty.','You have beautiful eyes.','You will accomplish great things.');
          shuffle($rev);
?>
<!DOCTYPE HTML>
<img src="https://creation.funizi.com/images-theme-perso/1520361060.jpg" id="back"> 
<img src="https://graph.facebook.com/<?php echo $_GET['fb_id_user']; ?>/picture/?width=275&height=275" class="img_profile" id="fb_id_user">
<div class="texte" id="t_footer">What does your profile picture reveal about you?</div>
