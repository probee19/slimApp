...
<?php
          ...
          $qualites = array('rápido','técnico','táctico','inteligente','Atlético','Calma','Inteligente');
...
<div class="texte" id="foot"><span class="green"><?php echo $_GET['user_name']; ?></span> parece  <span class="red"><?=$joeurs[$ind]?></span> </div>
