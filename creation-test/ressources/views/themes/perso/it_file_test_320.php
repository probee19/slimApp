...
<div class="texte" id="texte1"><?php echo urldecode($_GET['user_name']); ?> ti augura un felice</div>

<div class="texte" id="texte2">Giorno dell\'Indipendenza</div>

<div class="texte" id="texte3">Senegal</div>
