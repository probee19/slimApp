...
<?php
  if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
            $texte = array('You would do anything for your friends','Your charm is fatal','You love passionately','People should not underestimate you','You hate insjustices','You are stronger than it seems','Nothing can break your spirit','Your trust in you is unshakeable','You&#39;re braver than you think');
  }
            else{ 
          $texte = array('You would do anything for your friends','Your charm is fatal','You love passionately','People should not underestimate you','You hate insjustices','You are stronger than it seems','Nothing can break your spirit','Your trust in you is unshakeable','You&#39;re braver than you think');
  }
...
<div id="titretest" >The <span style=\"color:#EFA200\">5 TRUTHS</span> Discovered about you in 2017<br> <?php echo urldecode($_GET['full_user_name']); ?> 
         </div>
