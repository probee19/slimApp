...
<?php
          $qualites = array('liebenswürdig','angenehm','gesellig','würdig','bescheiden','Wirksam','integriert','komisch');
          $defauts = array('zu sensibel',' tropliebenswürdig');
...
<div class="back" id="back_blue" > Beste Qualität : <span class="res" id="qualite"><?=$qualites[0]?></span></div>
<div class="back" id="back_red" > Schlimmste Fehler : <span class="res" id="defaut"><?=$defauts[0]?></span></div> 
