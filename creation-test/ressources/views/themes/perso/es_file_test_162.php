...
<?php
$message = array('Piensas en los demás antes de pensar en ti mismo','Siempre confías en las personas','A veces cuestionas demasiado tus elecciones',
'Dejas que la gente abuse de tu amabilidad');
shuffle($message);
?>
