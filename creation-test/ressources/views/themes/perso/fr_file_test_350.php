...
<?php
          $mots = array(' Ton coeur étincelle de courage. ',' Tu débordes d\'énergie. ',' Tu te bats contre l\'injustice. ',' Ta vie est faite d\'honnêteté. ',' Tu aimes répandre le sourire. ',' Tu as un caractère humoristique. ',' Tu aimes partager. ',' Tu ne supportes pas les idiots. ',' Tu n\'as pas peur du changement. ');
          shuffle($mots);
?>
<!DOCTYPE HTML> 
