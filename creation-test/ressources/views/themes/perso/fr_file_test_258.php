...
<!DOCTYPE HTML>
<?php
          $causes = array(' son grand cœur ',' sa beauté ',' sa franchise ',' son élegance ',' sa pudeur ',' son humour ',' son courage ',' sa bravoure ',' son honnêteté ');
          shuffle($causes);
?>
<div id="profile_img">
          <img src="<?php echo urldecode($_GET['url_img_profile_user']); ?>" class="img_profile" id="fb_id_user">
</div>
<div class="texte" id="texte1" ><span style="color:#B71C1C;"><?php echo urldecode($_GET['friend_first_name_1']); ?></span>  a pensé à  <?php echo urldecode($_GET['user_name']); ?> </div>
<div class="texte" id="texte2"><?php echo mt_rand(102,450); ?>  FOIS </div>
<div class="texte" id="texte3"> cette année à cause de  </div> 
