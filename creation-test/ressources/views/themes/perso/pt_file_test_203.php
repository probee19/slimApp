...
<?php
  if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
                     $texte = array('Você sempre dá com o coração','Você nunca vai deixar ninguém para baixo','Você não precisa de ninguém','Você tem a preocupação do detalhe',
                     'Você nunca vai machucar ninguém','Você não pára em nada','Você iria passar por um incêndio para salvar sua família',
                     'Você odeia a injustiça','Você nunca desiste de pessoas','Sua lealdade é infalível','Você aprende com seus erros','Você sempre vigia seus amigos','Você é sempre honesto com as pessoas');

  }
            else{ 
             $texte = array('feliz','Líder','Honesto','Poderoso','Sensato','Sucesso');
