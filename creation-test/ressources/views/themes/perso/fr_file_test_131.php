          ...
          <div class='main'>
            ...
            <?php
                $nature = array('Joyeuse','Heureuse');
                $personnalite = array('Sainte', 'Croyante', 'Sérieuse');
                $aime = array('La modestie','La simplicité');
                $deteste = array('Le mensonge','La tricherie','La trahison');
                $force = array('La motivation','Le pouvoir','L&#39;argent');
            ...
            <span id="titre" class="titre"> Quelle est ta personnalité <?php echo urldecode($_GET['user_name']); ?>?</span>
            ...
            <span id="texte_1" class="texte"> <b>La nature :</b> <?php echo $nature[0] ?></span>
            <span id="texte_2" class="texte"> <b> Personnalité:</b> <?php echo $personnalite[0] ?></span>
            <span id="texte_3" class="texte"> <b>Aime:</b> <?php echo $aime[0] ?></span>
            <span id="texte_4" class="texte"> <b> Déteste:</b> <?php echo $deteste[0] ?></span>
            <span id="texte_5" class="texte"> <b> Obliger :</b> <?php echo $force[0] ?></span>
            <span id="texte_6" class="texte"> <b> Faiblesse:</b> <?php echo $faiblesse[0] ?></span>
