...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
                    $mots = array('관능적 인','건장한','진지한','자석','창조적 인','카리스마적인','강한','보호적인','좋은','다가의','재미있는','감사하는','매력적인','취향','이상한'  );
         else
                    $mots = array('관능적 인','건장한','진지한','자석ic','창조적 인','카리스마적인','강한','보호자','부드러운','변하기 쉬운','재미있는','감사하는','아름다운','취향','이상한'  );
          shuffle($mots);
?>
<!DOCTYPE HTML>
