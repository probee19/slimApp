...
<?php
          $positions = array('هداف');
          $roles = array('زعيم','بطل','قائد المنتخب');
          $forces = array('أبدا تفقد!','عمل شاق!','روح الفريق !');
          $faiblesses = array('عنده إيثار','يفهم كثيرا');
          $tactiques = array('ابحث و دمر!','مارك والاحتفال!');
          $devises = array('الحياة ليست عن الفوز ولكن لا تخسر!','أفضل اللاعبين لديك هو أسوأ ما عندي!');
...
<div class="texte label_r" id="position"> موضع : </div>
<div class="texte label_r" id="role"> وظيفة : </div>
<div class="texte label_r" id="force"> قوة : </div>
<div class="texte label_r" id="faiblesse"> ضعف : </div>
<div class="texte label_r" id="tactique"> تكتيكي : </div>
<div class="texte label_r" id="devise"> شعار : <span class="result_r">"<?=$devises[0]?>"</span>   </div>
