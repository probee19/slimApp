...
<?php
          $significations = array('Vertrauen','Loyalität','Frieden','der Wohlstund','Mut','Mut','Würde','Freundlichkeit','Stärke');
...
<div class="texte" id="texte1"> 100% königliches Blut </div>
<div class="texte" id="texte2"> meint </div>
<div class="texte" id="texte3"> <?=$significations[0]?> und <?=$significations[1]?> </div>
