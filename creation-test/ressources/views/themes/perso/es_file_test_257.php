...
<!DOCTYPE HTML>
<?php
          $dons = array('esperanza', 'calma', 'suerte', 'sinceridad', 'valor', 'fuerza', 'el liderazgo');
          $qualites = array('sensibilidad','valor','Advertencia','encanto','seguro','individualidad','altruismo','fuerza of character','lealtad','imparcialidad','flexibilidad');
          shuffle($qualites);
          shuffle($dons);
?>
