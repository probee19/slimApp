...
<?php
          $philosophie = array('O tempo é precioso, não devo perdê-lo por futilidade. Eu me concentro o tempo todo no essencial.',
          'A felicidade está naqueles pequenos momentos que a vida nos oferece. Eu aproveito cada momento com minha família, amigos e colegas.',
          'Celebridade ou riqueza não são importantes. O importante é uma vida sem estresse, sem preocupações e cheia de felicidade.',
          'Eu não me arrependo de nenhum conhecimento na vida. As pessoas boas sempre estarão lá e as ruins vão me deixar experiências que me levarão adiante.');
          shuffle($philosophie);
?>
<!DOCTYPE HTML>
