...
<?php
$message = array('Tu penses aux autres avant de penser à toi','Tu fais toujours confiance aux gens','Tu remets parfois trop en question tes choix',
'Tu laisses les gens abuser de ta gentillesse');
shuffle($message);
?>
