...
<?php 
$message_1 = array('لا يكون هناك لأصدقائك','اختر صديقا سيئا','فقدان صديق','النفايات حبك للشخص الخطأ');
$message_2 = array('كنت تهتم كثيرا عن أصدقائك أن كنت خائفا من عدم وجود هناك عندما هم في أشد الحاجة إليها. يجب أن تقبل كونه إنسانا.',
'كان خطأك أن تضع سعادتك في يد شخص آخر. لقد اخترت الآن أن تكون مسؤولة عن السعادة الخاصة بك حتى لا تكرار أخطاء الماضي.',
'تحب أصدقائك أكثر من أي شيء في العالم. هم دائما هناك بالنسبة لك وكنت دائما هناك بالنسبة لهم. إذا كان لديك لتفقد واحدة، وكنت قد دمرت.',
'عندما تقع في الحب، كنت تقع من الصعب جدا. بالنسبة لك الحب هو العاطفة فقط ولكن هذا الحب لا يستحق دائما. خذ وقتك لاختيار الشخص المناسب.');
