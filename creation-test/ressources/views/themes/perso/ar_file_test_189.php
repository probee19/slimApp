...
if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
              $texte = array("سرا في علاقة","نسيت في منطقة صديق","في علاقة مع الفودكا","مثير، حرة ومفردة",
"في انتظار معجزة","عشاق شخص ما","لا يفهم أي شيء للمرأة");     }
            else{ 
              $texte = array("سرا في علاقة","نسيت في منطقة صديق","في علاقة مع الفودكا","مثير، حرة ومفردة",
"في انتظار معجزة","في الحب مع شخص ما","لا يفهم أي شيء للرجال");
            }
