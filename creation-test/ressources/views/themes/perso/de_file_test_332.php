...
<?php
          $qualites = array('Aufrichtigkeit','die Präzision','die Kompetenz','Freundlichkeit','Romantik', 'Treue','Mut','Mut','Ehrlichkeit','Ausdauer','Loyalität','die Führung');
          shuffle($qualites);
?>
<!DOCTYPE HTML>
...
<div class="texte" id="header"><?php echo urldecode($_GET['user_name']); ?>, basierend auf unserer tiefgreifenden Analyse lautet die Qualität, die Sie am besten beschreibt:</div>

<div class="texte" id="quality"><?=$qualites[0]?></div>

<div class="texte" id="footer">( genau zu <?=mt_rand(94,99)?> % )</div
