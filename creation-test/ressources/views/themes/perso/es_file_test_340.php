...
<?php
          $sentiments = array('en paz','amado','motivado','deseado');
          $explications = array('Tienes una influencia tranquilizadora sobre todos los que te rodean. Aceptas la vida tal como es y compartes tu sabiduría con personas que tienen problemas.',
          'You have a very rare gift; you have the ability to make people feel noticed and amado. Your openness and understanding help people feel themselves.',
          'A veces las personas necesitan ser empujadas para perseguir sus sueños. Aquí es donde interviene. Usted irradia determinación y optimismo. Un verdadero impulso para la moral',
          'La sensación de soledad desaparece cuando estás contigo. Tu bondad y energía contagiosa extienden alegría a tu alrededor. Un verdadero rayo de sol.');
...
<div class="texte" id="head_text">Así es como las personas se sienten en tu presencia</div>
