...
if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
           $qualites = array('إنه يعرف حقًا من هو. إنه لا يدع آراء الآخرين تمنعه ​​من السعي وراء أحلامه. أولئك الذين وقفوا في طريقه بسرعة ندموا عليه.',
           'لديه روح غير قابلة للكسر تلهم الجميع من حوله. حاول البعض إسقاطه ، لكنهم فشلوا جميعًا. إنه أحد الناجين ، صديق ، كائن فريد حقا.',
           'لديه روح غير قابلة للكسر تلهم الجميع من حوله. عندما تظهر العقبات ، يبتسم ويجذب نفسه داخل نفسه القوة للتغلب عليها.',
           );       
 }
 else{
           $qualites = array('انها تعرف حقا من هي. إنها لا تدع آراء الآخرين تمنعها من السعي وراء أحلامها. أولئك الذين وقفوا في طريقه بسرعة ندموا عليه.',
           'لديها روح غير قابلة للكسر تلهم الجميع من حولها. حاول البعض إسقاطه ، لكنهم فشلوا جميعًا. إنها ناجية ، صديقة ، كائن فريد حقا.',
           'لديها روح غير قابلة للكسر تلهم الجميع من حولها. عندما تظهر العقبات ، تبتسم وتتجاذب نفسها بقوة لتتغلب عليها.',
           );       
 }
...
<div class="texte qualites" id="qualites_entete">هذا <?php echo $_GET['user_name']; ?>!</div>
