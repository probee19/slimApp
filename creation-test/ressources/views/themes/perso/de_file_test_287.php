...
<?php 
          $forces = array('sein Mut','seine Intelligenz','seine Freundlichkeit','seine Coolness','seine Art zu sprechen','sein Respektgefühl','sein Pflichtgefühl');
          shuffle($forces);
?>
<!DOCTYPE HTML>
...
<div class="texte" id="force">  
          <div  id="force_1"> Die Hauptstärke von <?php echo urldecode($_GET['user_name']); ?> ist</div>
          <div  id="force_2"> <?= $forces[0];?>  </div>
</div>

<div class="texte" id="texte_bottom">Was ist deine größte Stärke?</div>
