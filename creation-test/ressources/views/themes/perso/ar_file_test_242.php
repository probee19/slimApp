...
<?php
          $actions = array('التحرك معك','تبكي كل لحظة','سرقة جهاز الكمبيوتر الخاص بك','سرقة كل الطعام في الثلاجة','والانخراط ديريك لتجد لك',
          'رعاية عائلتك','سرقة كل ما تبذلونه من الملابس','الحصول على حسابك المصرفي');
          shuffle($actions);
