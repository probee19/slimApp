...
<?php
          ...
          $background = $background_eden; $verdict = "الجنة"; $color1 = '#1A237E'; $color2 = '#fff';
...
<div class="notes" style="color:<?php echo $color1;?>; background:<?php echo $bg_color;?>">
          <div id="nom">اسم: <?php echo urldecode($_GET['user_name']); ?></div>
          <div id="good">إجراءات جيدة: <?php echo number_format($action); ?> </div>
          <div id="bad">الذنوب: <?php echo number_format($peches); ?></div>
          <div id="kindness">العطف: <?php echo $gentillesse; ?> %</div>
</div>

<div class="decision" style="color:<?php echo $color2;?>; background:<?php echo $bg_color;?>">
         قرار نهائي : <?php echo $verdict;?>
</div>
