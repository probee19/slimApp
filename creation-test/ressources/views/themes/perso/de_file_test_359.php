...
<?php
         ...
         function getAdverb($team, $adverbe="de l'"){ 
                   $feminin = array('Belgien','Kolumbien','Croitie','la Frankreich','Nord Korea','Mexiko','Polen','Russland','Serbien','Schweden','schweizerisch','Tunesien');
         ...
         if( $pr ==  'a'){
                    ...
                    //$team = "France";
                   $ph = 'sagte den Sieg voraus '.getAdverb($team).'<span style="color:#e21b1b">'.$team.'</span>.';
         }
         elseif( $pr ==  'b'){
                   $class_no = 'yes_a';
                   $class_yes = 'yes_b';   
                   ...
                   $class_no = 'yes_ab';
                   $class_yes = 'yes_ab';  
                   $ph = 'sagte ein Unentschieden voraus.';
         }
...
<img src="<?php echo $_GET['url_img_prvonile_user']; ?>" class="img_prvonile" id="fb_id_user"> 
