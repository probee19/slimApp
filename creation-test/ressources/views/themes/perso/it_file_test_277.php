...
<?php
           if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
                  $results = array('Guardare video divertenti su Youtube','Divertirsi davanti alla partita PSG Real Madrid FC','Festeggia la vittoria del PSG sul Real Madrid','Festeggia la vittoria del Real Madrid sul PSG',
          'Baciare una bella ragazza','In una cena romantica', 'Contando i tuoi soldi','Visitare gli amici');
           }
           else{
                  $results = array('Guardare video divertenti su Youtube','Festeggia la vittoria del PSG sul Real Madrid','Festeggia la vittoria del Real Madrid sul PSG',
          'Baciare un bravo ragazzo','In una cena romantica', 'Contando i tuoi soldi','Ragazze in visita');
           }
           shuffle($results);
