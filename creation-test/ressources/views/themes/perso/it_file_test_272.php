...
<?php
      if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
               $message = array('Lei è già al tuo fianco','Stai già uscendo con lei','Vivi già con lei');          }
            else{ 
              $message = array('Lui è già al tuo fianco','Stai già uscendo con lui','Vivi già con lui');
            }
