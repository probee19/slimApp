...
<!DOCTYPE HTML>
<?php
          $reves = array('Tu auras une nouvelle voiture','Tu emménageras dans une nouvelle villa','Tu deviendras riche','Tu gagneras un prix national',
          'Tu auras une augmentation de salaire','Tu épouseras une célébrité riche','Tu auras un nouvel enfant');
          shuffle($reves);
?>
