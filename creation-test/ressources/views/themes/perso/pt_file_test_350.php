...
<?php
          $mots = array('Seu coração brilha com coragem.','Você está cheio de energia.','Você luta contra a injustiça.','Sua vida é feita de honestidade.','Você gosta de espalhar o sorriso.','Você tem um personagem humorístico.','Você gosta de compartilhar.','Você não suporta idiotas.','Você não tem medo de mudanças.');
          shuffle($mots);
?>
<!DOCTYPE HTML> 
