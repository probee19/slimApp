...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
                    ...
                    $details = array('Eres un verdadero vigilante y capaz de todo para proteger el tuyo.','Eres amado, respetado y capaz de guardar secretos que amenazan la estabilidad de tu país.',
                    'Eres un luchador formidable con una inteligencia extraordinaria','','Eres un científico de alto nivel y posees fuerza y ​​resistencia sobrehumanas',
                    'Eres un gran líder y tienes habilidades sobrehumanas.','Eres un consejero fiel, un hombre de confianza.');
                    $ind = mt_rand(0,6);
          }
          else{
                    $personnages = array('Ramonda','Nakia','Okoye','Shuri');
                    $images = array('1519662856','1519662954','1519663017','1519663589');
                    $details = array('Eres una consejera discreta, una reina madre.',
                    'Eres un verdadero guerrero capaz de dirigir cualquier misión para liberar a los oprimidos.','Eres un general leal y dedicado.',
                    'Eres una princesa, un genio capaz de ser responsable de varias innovaciones tecnológicas.');
                    $ind = mt_rand(0,3);
          }
