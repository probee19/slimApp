...
<?php
          $aimes = array('حب','صداقة','العائلة','الأطفال','الأصدقاء');
          $detestes = array(\"الكذابون','غير مخلص','المنافقين','المخادعون','أخطاء');
...
<div class="texte" id="phrase">يعرف <?php echo $_GET['user_name']; ?> ما هو جيد وغير جيد في حياته</div>
