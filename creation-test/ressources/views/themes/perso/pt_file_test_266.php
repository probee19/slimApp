...
<!DOCTYPE HTML>
<?php
          $surprises = array('Você vai se casar.','Você terá um carro novo como presente.','Você vai se comprometer.','Você vai ligar para o seu ex.',
                    'Você terá férias em Miami.', 'Você vai ter gêmeos');
