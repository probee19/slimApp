...
<?php
          $sentiments = array('in pace','amato','motivata','desiderato');
          $explications = array('Hai un\'influenza calmante su tutti quelli che ti circondano. Accetti la vita così com\'è e condividi la tua saggezza con le persone che hanno problemi.',
          'You have a very rare gift; you have the ability to make people feel noticed and amato. Your openness and understanding help people feel themselves.',
          'A volte le persone hanno bisogno di essere spinte a perseguire i loro sogni. Qui è dove si interviene. Irradi determinazione e ottimismo. Una vera spinta per il morale',
          'La sensazione di solitudine scompare quando sei con te. La tua gentilezza e la tua energia contagiosa diffondono la gioia intorno a te. Un vero raggio di sole.');
...
<div class="texte" id="head_text">Ecco come le persone si sentono alla tua presenza</div>
