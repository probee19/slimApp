...
<?php
          $surprises = array('Avrai un bambino. '.$_GET[' User_name'].' La famiglia S avrà un nuovo tesoro!', 
                    'Difficile scegliere '.$_GET[' Nome utente'].'. Molte cose miglioreranno l&#39;anno prossimo!',
                    'Otterrai un nuovo lavoro perfetto che soddisferà perfettamente le tue aspettative!',
                    'Avrai una promozione professionale durante quest&#39;anno',
                    'Farai un viaggio ricco di esperienze e scoperte!');
          shuffle($surprises);
?>
<!DOCTYPE HTML>
