...
<?php 
          $qualites = array('Tu sonrisa','Tu belleza','Tu lealtad','Tu coraje','Tu personaje','Tu inteligencia','Tu calma','Tu modestia',
          'Tu humor','Tu honestidad','Tu pasión','Tu amabilidad','Tu fuerza','Tu carisma');
          shuffle($qualites);
?>        
<!DOCTYPE HTML>
