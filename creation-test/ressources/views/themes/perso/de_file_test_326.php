...
<div class="texte" id="head"> Wie viele Personen haben dein Profil heute besucht? </div>
...
<div class="texte" id="visite">
          ...
          <div class="texte" id="compteur"> <?=mt_rand(75,204)?> <div class="texte" id="lab_compteur"> Besuche</div> </div>
</div>
