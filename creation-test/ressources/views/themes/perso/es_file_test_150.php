...
<?php
 if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
               $message_1 = array('... ¡y ponte tu atuendo más elegante! ¡Será la noche de nuestra vida!','Como eres mi mejor amigo, ¡te elegí!','Contigo, ¡eso sería completamente loco! Sin ti, sin embargo ...');
     }
            else{ 
           $message_1 = array('... ¡y ponte tu atuendo más elegante! ¡Será la noche de nuestra vida!','Como eres mi mejor amigo, ¡te elegí!',
           'Contigo, ¡eso sería completamente loco! Sin ti, sin embargo ...');
 
            }

 
 $message_2 = array('No me preguntes cómo lo hice, pero logré conseguir boletos para la fiesta VIP de esta noche. ¡Responder!','... bueno para dos personas!','Estaba pensando en organizar una fiesta loca, pero honestamente no ayuda mucho si no puedes venir.');
 $message_3 = array('Llamadas perdidas (6)','¡Acabo de ganar un viaje a Japón!','¡Espero que no tengas planes para esta noche!');
 $max_key = 2; $key = mt_rand(0,$max_key);    
?>
<img src="http://creation.funizi.com/images-theme-perso/1508537456.jpg" id="background"> 
<div class="name texte" id="position1_name_friend_1" ><?php echo urldecode($_GET['friend_name_1']); ?> <span>justo ahora</span></div>
<div  id="message1" ><?php echo $message_1[$key]; ?></div>
<div class="name texte" id="position2_name_friend_1" ><?php echo urldecode($_GET['friend_name_1']); ?> <span>hace 4 minutos</span></div>
<div  id="message2" ><?php echo $message_2[$key]; ?></div>
<div class="name texte" id="position3_name_friend_1" ><?php echo urldecode($_GET['friend_name_1']); ?> <span>Hace 6 minutos</span></div>
