...
<?php
           ...
           $message_1 = array('هل لا تزال تفكر في لي؟','مرحبا، لقد كانت بعض الوقت ...','مرحبا.','أنت بخير ؟');
                $message_2 = array('بعض الأحيان...','انتظر ... هل تسمع ذلك؟','ليس اليوم الشيطان.','رائع شكرا لك. لقد مر وقت طويل...');
                $message_3 = array('هذا صحيح ؟','ماذا ؟',' ماذا! أريد فقط أن أبقى أصدقاء ...','في كل مرة أغمض عيناي، أرى وجهك.');
                $message_4 = array('نعم ثم استيقظ وأقول لنفسي، &quot;لحسن الحظ هذا الكابوس قد انتهى!&quot;','صوت بلا مبالاة. فارويل!','إلغاء الاشتراك!','يبدو وكأنه مشكلة طبية. يجب أن تستشير طبيبا.');
