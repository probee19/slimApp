...
<?php
          $to = array('Paris', 'Havana', 'Havaí', 'Bora Bora', 'Londres', 'México', 'Miami');
          $mois = array('janeiro','fevereiro','marcha','abril','pode','Junho');
          shuffle($mois); shuffle($to);
?>

<img src="http://creation.funizi.com/images-theme-perso/1515157095.jpg" id="background">
<div id="label_passenger"> Passageiro : </div>
<div id="passenger"> <?php echo $_GET['full_user_name']; ?> </div>
<div id="date"> <?=  mt_rand(1,28).' '.$mois[0].' 2018 para '.mt_rand(12,23).':'.mt_rand(11,59); ?></div>

<div id="label_to">AT : </div>
<div id="to"><?=  $to[0]; ?></div>

<div id="abordage">Hora de embarque :</div>
