...
<?php
          $qualites = array('amiable','pleasant','sociable','worthy','modest','effective','integrated','funny');
          $defauts = array('too sensitive',' too kind');
...
<div class="back" id="back_blue" > Best quality : <span class="res" id="qualite"><?=$qualites[0]?></span></div>
<div class="back" id="back_red" > Worst defect : <span class="res" id="defaut"><?=$defauts[0]?></span></div> 
