...
<?php
          $surprises = array('سيكون لها وظيفة جديدة.', 'سوف يكون لها زيادة.', 'سوف أتزوج.', 'سوف يكون لها طفل جديد.', 'سيعقد اجتماعا سيغير حياته.', 'سوف تشارك.');
...
<div id="texte_surprise" >خلال عام 2018, <?php echo urldecode($_GET['user_name']); ?> <?php echo $surprises[$index]; ?></div>
