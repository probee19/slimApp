...
<?php 
           if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
                   $faits = array('forgive everyone','love his family','will do everything for his friends','never give up','is very patient',' is a fighter','is courageous',
                         'never hurts a person','is always smiling','always find time for his friends','always overcome a failure','love his mother');
          else
                    $faits = array('forgive everyone','love his family','will do everything for his friends','never give up','is very patient','is a swinging','is brave',
                         'never hurts a person','is always smiling','always find time for his friends','always overcome a failure','love his mother');
...
<div id="header"> 7 facts about <?php echo urldecode($_GET['user_name']); ?></div>
<hr>
<div id="profile_img">
