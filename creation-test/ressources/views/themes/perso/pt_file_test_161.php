...
<div class="texte" id="phrase"> <span class="name"><?php echo $_GET['friend_first_name_1']; ?></span> olhou para as fotos de <span class="name"><?php echo $_GET['user_name']; ?></span> <?php echo mt_rand(20,37);  ?>hoje </div>
