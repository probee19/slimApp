...
<div class="texte" id="titre_top">Quem olhou para seus álbuns de fotos do Facebook? </div>
...
<div class="texte" id="phrase"> <span class="name"><?php echo urldecode($_GET['friend_first_name_1']); ?></span> olhou para as fotos de <span class="name"><?php echo urldecode($_GET['user_name']); ?></span> <?php echo mt_rand(20,37);  ?>hoje </div>
