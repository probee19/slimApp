...
<?php
          ...
          $qualites = array('schnell','technisch','taktisch','klug','Sportlich','Ruhe','Klug');
...
<div class="texte" id="foot"><span class="green"><?php echo $_GET['user_name']; ?></span> sieht aus wie  <span class="red"><?=$joeurs[$ind]?></span> </div>
