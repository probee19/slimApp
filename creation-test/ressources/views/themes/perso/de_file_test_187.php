...
<?php
 ...
 {
       $texte = array("Wenn wir es in einer Warteschlange verdoppeln!","Wenn sein Telefon keine Batterie hat!",
"Wenn sein Friseur Katastrophen macht!", "Wenn seine Mutter ihn 10 Mal am Tag anruft!", "Wenn eine Mücke ihn vom Schlafen abhält"
,"Wenn es regnet und er keinen Regenschirm hat!","Wenn Leute hinter seinem Rücken sprechen!","Wenn Leute im Kino flüstern!");    
 }
 else
 {
           $texte = array("Wenn wir es in einer Warteschlange verdoppeln!","Wenn sein Telefon keine Batterie hat!",
"Wenn ihr Friseur Katastrophen macht!", "Wenn seine Mutter ihn 10 Mal am Tag anruft!", "Wenn eine Mücke ihn vom Schlafen abhält"
,"Wenn es regnet und sie keinen Regenschirm hat!","Wenn Leute hinter seinem Rücken sprechen!","Wenn Leute im Kino flüstern! ");
 }
...
<div id="titretest" >Welche 5 Dinge hassen <?php echo urldecode($_GET['user_name']); ?> am meisten?</div>
<div class="name texte" id="name_user" ></div>
