...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
                    $amour = array('5 أطفال ، 18 أحفاد','45 حفيد','4 أطفال ، 21 أحفاد','7 أطفال ، 28 أحفاد');
                    $carriere = array('امن','طيار','الشاعر الشهير');
                    $argent = array('2 حسابات بنكية بملايين الدولارات','15،000،000 دولار','12،500،000 دولار','مالك من 3 منازل مؤقتة','مليونير. صاحب 5 فيلات كبيرة. ');
                    $accomplissement = array('خلق شركتك الخاصة','مساعدة من العديد من الجمعيات الخيرية','مالك لعلامة تجارية رئيسية للسيارات','مستشار لرئيس الجمهورية');
          }
...
<div class="texte box" id="box_heart"> أسرة </div>
...
<div class="texte box" id="box_money"> ثروة </div>
