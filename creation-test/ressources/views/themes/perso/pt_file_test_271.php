...
<?php
 if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
               $message_1 = array(''.$_GET['user_name'].' foi eleito Presidente do seu país com 98,9% dos votos',''.$_GET['user_name'].' acaba de ser eleito o cara mais bonito do universo',
               ''.$_GET['user_name'].' se torna a segunda fortuna mundial por trás de Bill Gates',
               ''.$_GET['user_name'].' acabou de comprar seu próprio país',
               ''.$_GET['user_name'].' descobre uma cura para o câncer',
               ''.$_GET['user_name'].' impede uma invasão alienígena',
               ''.$_GET['user_name'].' faz a paz no mundo');
     }
            else{ 
           $message_1 = array(''.$_GET['user_name'].' foi eleita Presidente do seu país com 96,9% dos votos', ''.$_GET['user_name'].' foi eleita a mulher mais bonita do universo',
           ''.$_GET['user_name'].' se torna a segunda fortuna mundial por trás de Bill Gates',
               ''.$_GET['user_name'].' acabou de comprar seu próprio país',
               ''.$_GET['user_name'].' descobre uma cura para o câncer',
               ''.$_GET['user_name'].' impede uma invasão alienígena',
