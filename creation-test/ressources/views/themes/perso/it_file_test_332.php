...
<?php
          $qualites = array('sincerità','la precisione','la competenza','gentilezza','Romanticismo', 'fedeltà','coraggio','coraggio','onestà','perseveranza','lealtà','la leadership');
          shuffle($qualites);
?>
<!DOCTYPE HTML>
...
<div class="texte" id="header"><?php echo urldecode($_GET['user_name']); ?>, in base alla nostra analisi approfondita, la qualità che ti descrive meglio è:</div>

<div class="texte" id="quality"><?=$qualites[0]?></div>

<div class="texte" id="footer">( accurato a <?=mt_rand(94,99)?> % )</div
