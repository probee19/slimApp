...
<?php 
           if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
                   $faits = array('vergib allen','liebe seine Familie','wird alles für seine Freunde tun','Gib nie auf','ist sehr geduldig',' ist ein Kämpfer','ist mutig',
                         'verletzt nie eine Person','lächelt immer','finde immer Zeit für seine Freunde','Immer einen Fehler überwinden','liebe seine Mutter');
          else
                    $faits = array('vergib allen','liebe seine Familie','wird alles für seine Freunde tun','Gib nie auf','ist sehr geduldig','ist ein Schwingen','ist mutig',
                         'verletzt nie eine Person','lächelt immer','finde immer Zeit für seine Freunde','Immer einen Fehler überwinden','liebe seine Mutter');
...
<div id="header"> 7 Fakten über <?php echo $_GET['user']; ?></div>
<hr>
<div id="profile_img">
