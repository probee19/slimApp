          ...
          <div class='main'>
            ...
            {
                $message_1 = array('Se enteró que '.$_GET['¿User_name'].' Iba a las Maldivas?', 'Odio cuando '.$_GET['¿User_name'].' Entra en una habitación, todos lo miran', 'Fiesta secreta VIP esta noche, ¿estás invitado? User_name'].'?','Haz visto '.urldecode($_GET['user_name']).' ¿Últimamente? Oh querido !','Acabo de ver '.urldecode($_GET['user_name']).' En una limusina!','Has visto '.$_GET['¿User_name'].' ¿En la fiesta de ayer? !!');
                ...
                $message_3 = array('Él es muy misterioso ...', 'Eso es verdad. Es una verdadera estrella', ' Si hay un VIP en nuestro grupo, es bueno '.urldecode($_GET['user_name']).'!','Hay personas que me preguntan si está soltero','Él es cada vez más misterioso ...','Nadie podía quitarle los ojos de encima. Una verdadera estrella.');
            }
            else{ 
                $message_1 = array('Se enteró que '.$_GET['¿User_name'].' Iba a las Maldivas?', 'Odio cuando '.urldecode($_GET['user_name']).' Entra en una habitación, todos la miran', 'Fiesta secreta VIP esta noche, ¿estás invitado? User_name'].'?','Haz visto '.urldecode($_GET['user_name']).' ¿Últimamente? Oh querido !','Acabo de ver '.urldecode($_GET['user_name']).' En una limusina! ','Has visto '.$_GET['¿User_name'].' ¿En la fiesta de ayer? !!');
                ...
                $message_3 = array('Ella es muy misteriosa ...', 'Eso es verdad. Es una verdadera estrella', ' Si hay un VIP en nuestro grupo, es bueno '.urldecode($_GET['user_name']).'!','Hay personas que me preguntan si está soltera',' Ella es cada vez más misteriosa ...','Nadie podría quitarle los ojos. Una verdadera estrella.');
