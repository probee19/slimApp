          ...
          <div class='main'>
            ...
            <?php
                $don = array('Tu lealtad','Tu honestidad','Tu corazón tierno','Tu encanto natural','Tu fe','Tu amabilidad','Tu compasión','Tu perseverancia');
                shuffle($don);
            ?>
            <img src="http://creation.funizi.com/images-theme-perso/1508587038.jpg" id="background">
            <span id="titre" class="titre">¿Qué regalo recibió de Dios?</span>
