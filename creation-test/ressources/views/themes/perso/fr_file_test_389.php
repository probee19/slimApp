...
<?php
  ...
  $texte = array(' '.$_GET['user_name'].' garde des secrets ! ', ' Avec '.$_GET['user_name'].' on ne s\'ennuit jamais ! ', ' '.$_GET['user_name'].' est tout simplement adorable ! ',
  ' '.$_GET['user_name'].' peut tout donner par amitié ! ',' '.$_GET['user_name'].' sait donner de bons conseils ! ', 
  ' '.$_GET['user_name'].' prépare de magnifiques surprises ! ',' '.$_GET['user_name'].' sait rendre la vie plus belle ! ');
shuffle($texte);
?>
...
<div id="titretest" > Les  <span style="color:#D90000"> 5 raisons </span>  d'être ami(e) avec  <br><?php echo $_GET['full_user_name']; ?></div>
