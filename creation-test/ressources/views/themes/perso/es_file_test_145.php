...
#mot3{position:absolute; z-index:1; left: 0px; top: 160px;}
   ...
   if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
		 $mot = array('Inteligente','Trabajo','Famille','Honestoo','Cariñoso','Visionario','Grave','Amistad');
   }
   else{
		 $mot = array('inteligente','Trabajo','Familia','Honestoo','cariñoso','Visionario','grave','Amistad');
   }
  ...
  <img src="http://creation.funizi.com/images-theme-perso/1508526452.jpg" id='background'>
      <div id='titre_test'>¿Cuáles son las 3 palabras que te describen?</div>
