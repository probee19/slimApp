...
.result{font-size:43px; margin-top:0px;font-family: 'Acme', sans-serif; color:#FFF; width:100%; }
 ...
 <?php
                $aime = array('لتضحك','سريرك','أصدقائك','الموسيقى');
                $couleur = array('أزرق', 'أحمر', 'أخضر','أبيض','البرتقالي');
                $force = array('سحر الابتسامة','البساطة','سخاء','شخصيتك','قلبك');
                $deteste = array('الكذبة','المنبه الخاص بك','الخيانة','حركة المرور','سنوبس');
                $personnalite = array('بديع','خلاق','تحدد');
                $tondefaut = array('حساس','الكمال');
...
<div id="deteste"><span class="titre_rubrique">أنت تكره</span><div class="result"><?php echo $deteste[0] ?></div></div>
<div id="personnalite"><span class="titre_rubrique">الشخصية</span><div class="result" style="font-size:30px"><?php echo $personnalite[0] ?></div></div>
<div id="defaut"><span class="titre_rubrique">خطأك</span><div class="result"><?php echo $tondefaut[0] ?></div></div>
