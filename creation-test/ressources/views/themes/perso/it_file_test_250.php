...
<?php
          $surprises = array('avrà un nuovo lavoro.', 'avrà un aumento.', 'si sposerà.', 'avrà un nuovo figlio.', 'farà un incontro che cambierà la sua vita.', 'si fidanzerà.');
...
<div id="texte_surprise" >Durante l&#39;anno 2018, <?php echo urldecode($_GET['user_name']); ?> <?php echo $surprises[$index]; ?></div>
