          ...
          <div class='main'>
            ...
            <!DOCTYPE HTML> <?php $diagnostic = array('Umorismo contagioso','Gentilezza avanzata','Lealtà acuta','Ottimismo virale','Sensualità incurabile');
            $niveau = array('Grave','Allarmante','Altamente contagioso');
            shuffle($diagnostic); shuffle($niveau); ?>
            <img src="http://creation.funizi.com/images-theme-perso/1508420459.jpg" id="background">
            <div id="certificat">Certificato medico</div> <div id="name">Nome:</div>
            <div id="name_reponse"> <?php echo urldecode($_GET['user_name']); ?></div> <div id="diagnostic">Diagnostico :</div>
            <div id="diagnostic_reponse"><?php echo $diagnostic[0]; ?></div> <div id="niveau">Livello:</div>
