...
<?php
$texte = array("sagt nur interessante Dinge","ist anmutig","ist mysteriös","ist schön","liebe Umarmungen","ist schlau","vermittelt seine Lebensfreude","ist erfüllt", "Pass auf sie auf","ist nicht zugänglich"
,"hat einen Sinn für Humor","ist leidenschaftlich","ist sprudelnd und energisch","hat einen Sinn für Humor","ist bereit, Kompromisse zu machen","gerne spazieren gehen", "weiß was sie will"
,"ist eine unabhängige Frau","ist nett und rücksichtsvoll");
 shuffle($texte);
?>
...
<div id="titretest" >Warum ist <?php echo urldecode($_GET['user_name']); ?> eine perfekte Frau?</div>
<div class="name texte" id="name_user" ></div>
