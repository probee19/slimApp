...
<?php
          $mots = array('Buona festa della mamma. Ti penso con tanto amore e tenerezza!',
          'Buon compleanno alla mamma più straordinaria che la storia abbia mai conosciuto!',
          'Grazie a te, sono io! <br> Grazie ... e buon compleanno.','Buon compleanno a mia madre, angelo mio, amico mio!',
          'Nessuna lingua può esprimere la bellezza e la forza di una madre. <br> Buon compleanno Mamma.'
          );
          shuffle($mots);
?>
<!DOCTYPE HTML>
