...
<?php 
          $qualites = array('Il tuo sorriso','La tua bellezza','La tua lealtà','Il tuo coraggio','Il vostro personaggio','La tua intelligenza','La tua calma','La tua modestia',
          'Il tuo umorismo','La tua onestà','La tua passione','La tua gentilezza','La tua forza','Il tuo carisma');
          shuffle($qualites);
?>        
<!DOCTYPE HTML>
