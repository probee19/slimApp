...
<?php
 ...
 $mots = ['admirable','agile','affable', 'attentionné', 'authentique', 'bienveillant', 'brillant', 'bienfaisant', 'brave', 'bon', 'combatif', 'chanceux', 'charmant', 'clément', 'courageux','digne','discipliné','dévoué','dynamique','efficace','exemplaire','eloquent','eblouissant','equilibré','fantastique','fidèle','fort','fascinant','fiable'
           ,'galant','généreux','gentil','génial','gracieux','honnête','honorable','humble','habile','héroïque','ingénieux','intelligent','irrésistible','innovateur','indomptable','judicieux','juste','jovial','joyeux','joueur','kiffable','Kiff','leader','loyal','laborieux','magnifique','marrant','méthodique','malin','modèle'
           ,'naturel','noble','novateur','ordonné','original','optimiste','pacifique','parfait','précieux','pédagogue','protecteur','quièt','radieux','rayonnant','respectueux','romantique','rusé','sage','serein','serviable','sincère','splendide','tendre','travailleur','tombeur','unique','utile','vaillant','vigilant','virtuose','wouah','winner'
           ,'xtra','x fois plein de qualités…','yeux magnifiques','y\'en a pas deux comme toi !','zen','zélé','zlantanesque'];
 else
 $mots = ['admirable','agile','affable', 'attentionnée', 'authentique', 'bienveillante', 'brillante', 'bienfaisante', 'brave', 'combative', 'chanceuse', 'charmante', 'clémente', 'courageuse','digne','disciplinée','dévouée','dynamique','efficace','exemplaire','eloquente','eblouissante','equilibrée','fantastique','fidèle','forte','fascinante','fiable'
