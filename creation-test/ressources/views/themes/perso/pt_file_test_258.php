...
<!DOCTYPE HTML>
<?php
          $causes = array('seu grande coração','sua beleza','sua franquia','sua elegância','seu modesto','seu humor','sua coragem','sua bravura','sua honestidade');
          shuffle($causes);
?>
<div id="profile_img">
          <img src="<?php echo urldecode($_GET['url_img_profile_user']); ?>" class="img_profile" id="fb_id_user">
</div>
<div class="texte" id="texte1" ><span style="color:#B71C1C;"><?php echo urldecode($_GET['friend_first_name_1']); ?></span> pensei em <?php echo urldecode($_GET['user_name']); ?> </div>
<div class="texte" id="texte2"><?php echo mt_rand(102,450); ?> TEMPO</div>
<div class="texte" id="texte3">este ano por causa de </div> 
