...
<?php
      if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
               $message = array('Sie ist schon an deiner Seite','Du gehst schon mit ihr aus','Du lebst schon bei ihr');          }
            else{ 
              $message = array('Er ist schon an deiner Seite','Du gehst schon mit ihm aus','Du lebst schon bei ihm');
            }
