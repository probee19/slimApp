...
<!DOCTYPE HTML>
<?php
          $reves = array('Du wirst ein neues Auto haben','Sie werden in eine neue Villa ziehen','Du wirst reich werden','Sie werden einen nationalen Preis gewinnen',
          'Sie werden eine Gehaltserhöhung haben','Du wirst eine reiche Berühmtheit heiraten','Du wirst ein neues Kind haben');
          shuffle($reves);
?>
<img src="http://creation.funizi.com/images-theme-perso/1514369932.jpg" id="background"> 
<img src="https://graph.facebook.com/<?php echo $_GET['fb_id_user']; ?>/picture/?width=350&height=350" class="img_profile" id="fb_id_user">
