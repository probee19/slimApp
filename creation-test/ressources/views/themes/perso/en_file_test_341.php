...
<?php
          $significations = array('trust','loyalty','peace','prosperity','bravery','courage','dignity','kindness','strength');
...
<div class="texte" id="texte1"> 100% royal blood </div>
<div class="texte" id="texte2"> means </div>
<div class="texte" id="texte3"> <?=$significations[0]?> and <?=$significations[1]?> </div>
