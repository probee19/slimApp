...
<?php
          ...
          $qualites = array(' rapide ',' technique ',' tactique ',' habile ',' Athlétique ',' Calme ',' Intelligent ');
...
<div class="texte" id="foot"><span class="green"><?php echo $_GET['user_name']; ?></span>  ressemble à   <span class="red"><?=$joeurs[$ind]?></span> </div>
