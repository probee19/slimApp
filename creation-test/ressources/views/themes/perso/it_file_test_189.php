...
if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
              $texte = array("Segretamente in una relazione","Dimenticato nella zona amici","In una relazione con Vodka","Sexy, gratis e single",
"In attesa di un miracolo","Gli amanti di qualcuno preso","Non capisce nulla per le donne");     }
            else{ 
              $texte = array("Segretamente in una relazione","Dimenticato nella zona amici","In una relazione con Vodka","Sexy, gratis e single",
"In attesa di un miracolo","Innamorato di qualcuno preso","Non capisce nulla per gli uomini");
            }
