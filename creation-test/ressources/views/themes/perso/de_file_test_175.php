...
<?php
$texte = array('Sie sind eine Person von perfekter Schönheit, Sie können jeden in Ihre Tasche stecken','Beeindruckend! Mit dieser herrlichen Schönheit, die Sie haben, sucht jeder nach Ihnen!','Wir reden nur über dich! Du hast eine außergewöhnliche Schönheit!');
$score = array('11','12','10');
$k = mt_rand(0,2);
?>
<div class="texte" id="top"> <?php echo urldecode($_GET['user_name']); ?> Das ist deine Punktzahl! </div>
