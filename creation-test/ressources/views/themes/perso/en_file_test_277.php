...
<?php
           if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
                  $results = array('Watching funny videos on Youtube','Having a good time in front of the match PSG Real Madrid FC','Celebrating PSG&#39;s victory over Real Madrid','Celebrating Real Madrid&#39;s victory over PSG',
          'Kissing a pretty girl','In romantic dinner', 'Counting your money','Visiting friends');
           }
           else{
                  $results = array('Watching funny videos on Youtube','Celebrating PSG&#39;s victory over Real Madrid','Celebrating Real Madrid&#39;s victory over PSG',
          'Kissing a nice guy','In romantic dinner', 'Counting your money','Visiting girlfriends');
           }
           shuffle($results);
