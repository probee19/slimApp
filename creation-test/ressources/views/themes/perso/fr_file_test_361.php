...
<?php
          $positions = array(' Buteur ');
          $roles = array(' Meneur ',' Héros ',' Capitaine ');
          $forces = array(' Ne lâche jamais ! ',' Travaill acharné ! ',' Esprit d\'équipe ! ');
          $faiblesses = array(' Altruiste ',' Comprend trop ');
          $tactiques = array(' Chercher et détruire ! ',' Marquer et célébrer ! ');
          $devises = array(' La vie ne consiste pas à gagner mais à ne pas perdre ! ',' Le meilleur de tes joueurs est le pire des miens ! ');
...
<div class="texte label_r" id="role">  Role  : </div>
<div class="texte label_r" id="force">  Force  : </div>
<div class="texte label_r" id="faiblesse">  Faiblesse  : </div>
<div class="texte label_r" id="tactique">  Tactique  : </div>
<div class="texte label_r" id="devise">  Devise  : <span class="result_r">"<?=$devises[0]?>"</span>   </div>
