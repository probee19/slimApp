...
if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' )
            {
              $texte = array("Secrètement en couple","Oublié dans la zone ami","Dans une relation avec la Vodka","Sexy, libre et célibataire",
"En attente d&#39;un miracle","Amoureux de quelqu&#39;un de pris","Ne comprend plus rien aux femmes");     }
            else{ 
              $texte = array("Secrètement en couple","Oublié dans la zone ami","Dans une relation avec la Vodka","Sexy, libre et célibataire",
"En attente d&#39;un miracle","Amoureuse de quelqu&#39;un de pris","Ne comprend plus rien aux hommes");
            }
