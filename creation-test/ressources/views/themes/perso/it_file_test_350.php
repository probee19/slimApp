...
<?php
          $mots = array('Il tuo cuore brilla di coraggio.','Sei pieno di energia.','Combatti contro l\'ingiustizia.','La tua vita è fatta di onestà.','Ti piace diffondere il sorriso.','Hai un personaggio umoristico.','Ti piace condividere.','Non supportate gli idioti.','Non hai paura del cambiamento.');
          shuffle($mots);
?>
<!DOCTYPE HTML> 
