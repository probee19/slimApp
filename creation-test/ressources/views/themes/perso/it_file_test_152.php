          ...
          <div class='main'>
            ...
            <?php
                $apparence = array('carismatico','sbalorditivo','maestoso');
                $ame = array('Magnetico', 'Divine', 'pulito');
                $personnalite = array('ammaliatore','riconosciuto','Umile');
            ...
            <span id="texte_3" class="texte"> <b> Personalità:</b> <?php echo $personnalite[0] ?></span>
