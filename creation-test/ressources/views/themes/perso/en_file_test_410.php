...
<?php
 $qualites = array('his loyalty','his honesty','his sincerity','his franchise','his fidelity', 'its authenticity','his patience','his courage', 'his sensitivity','his generosity','his wisdom');
 shuffle($qualites);
?>
<!DOCTYPE HTML>
...
<div class="texte qualites" id="qualites_entete">The two greatest qualities of <?php echo $_GET['user_name']; ?>:</div>
