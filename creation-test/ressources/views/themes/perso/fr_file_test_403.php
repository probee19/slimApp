...
<?php
          $qualites = array(' Nous avons Jacques Brel, Stromae, Selah Sue, Loïc ... ',' Nous avons Tintin, Lucky Luke ! ',' Dans chaque village, tu peux trouver un super festival. ',
          ' On est vraiment très bons en langue … ',' Nous avons de fantastiques breuvages houblonnés ! ',' Nous avons les meilleurs chocolats du monde ? ',' Nous avons Jean-Claude Van Damme ? ',' On a les meilleurs frites du monde ! ');
          shuffle($qualites);
?>
<!DOCTYPE HTML>
