...
<?php
          if( $_GET['user_gender'] == 'homme' || $_GET['user_gender'] == 'male' || $_GET['user_gender'] == 'masculin' ){
                    $amour = array('5 niños, 18 nietos','45 nietos','4 niños, 21 nietos','7 niños, 28 nietos');
                    $carriere = array('Científico','Piloto','Famoso poeta');
                    $argent = array('2 cuentas bancarias con millones de dólares','$ 15,000,000','$ 12,500,000','Dueño de 3 casas improvisadas','Millonario. Dueño de 5 villas grandes. ');
                    $accomplissement = array('Creando tu propia empresa','Ayuda de muchas organizaciones benéficas','Dueño de una importante marca de automóviles','Asesor del Presidente de la República');
          }
...
<div class="texte box" id="box_heart"> Familia </div>
