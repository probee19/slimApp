 ...
 <?php 
            ...
            {
               $message_1 = array('صادق جدا','صادق جدا','مثير جدا','هرتبركر','صريح جدا');
            $message_2 = array('خطير لأنه يقول الأشياء كما هي.','خطير لأولئك الذين لا يريدون أن نرى الحقيقة في الجبهة','يحصنها الرجال 18 إلى 35 سنة'
            ,'خطر على النساء اللواتي تتراوح أعمارهن بين 18 و 26 عاما','خطرة للأشخاص الذين لا يدعمون الامتياز'); }
            else{ 
                 $message_1 = array('Trop honnête','صادق جدا','مثير جدا','هرتبركر','صريح جدا');
            $message_2 = array('خطير لأنه يقول الأشياء كما هي.','خطير لأولئك الذين لا يريدون أن نرى الحقيقة في الجبهة','تحجبها نساء تتراوح أعمارهن بين 18 و 35 عاما'
            ,'خطورة على النساء اللواتي تتراوح أعمارهن بين 25 و 45 عاما','خطرة للأشخاص الذين لا يدعمون الامتياز');
