...
<?php
          $like = array('his family','his friends','donner','his passion for traveling','offer a smile','helping people');
          $dislike = array('liars','the showers','the grumpy people');
          $nature = array('faithful','empathic','sociable');
          $personnalite = array('like to share','is not selfish','make everyone laugh');
...
<div class="texte ligne" id="ligne1"> $_GET['love you :  </div>
<div class="texte resultat" id="resultat1"> <?=$like[0];?> </div>

<div class="texte ligne" id="ligne2"> $_GET[' t Hate :  </div>
...
<div class="texte ligne" id="ligne4"> $_GET[' t Personality :  </div>
