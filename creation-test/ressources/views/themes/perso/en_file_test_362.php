...
<?php
          ...
          $qualites = array('fast','technical','tactical','clever','Athletic','Calm','Clever');
...
<div class="texte" id="foot"><span class="green"><?php echo $_GET['user_name']; ?></span> looks like  <span class="red"><?=$joeurs[$ind]?></span> </div>
