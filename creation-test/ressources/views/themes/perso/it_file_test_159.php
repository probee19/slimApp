...
<?php
$message_1 = array('Chi ha i vestiti per bambini?<br> Aspettiamo gemellini !!! :)', 'Mamma, papà, mi dispiace annunciare che sarai nonni!');
$message_2 = array('Che cosa !!!!:)','Sospettavo qualcosa! <3 Complimenti!');
$message_3 = array('Congratulazioni a voi 2 !!! non posso crederci','È buono è confermato? Farai genitori meravigliosi!');
$date = array('22 dicembre alle 22:53','11 marzo alle 20:03','13 giugno alle 21:43');shuffle($date);
