...
<?php
 $texte = array('Brazos caídos','Es un desastre','Soltero','Secretamente en una relación');
 $texte1 = array('Hesite entre 2 personas','Corazón roto','Oficialmente en una relación','Finalmente como pareja','En pareja y feliz','Manos fuera! corazón ya tomado!');
 shuffle($texte);
 shuffle($texte1);
?>
...
<div style=" position:absolute; width:800px; top:115px; text-align:center; z-index:2; font-size:20px; font-weight:bold; color:#0C6CFF">Hoy</div>
...
<div style=" position:absolute; width:800px; top:330px; text-align:center; z-index:2; font-size:20px; font-weight:bold; color:#0C6CFF">En 6 meses</div>
