...
class HomeController extends Controller
{
    ...
    public function chunk($request, $response, $args){
      ...
      $all_lang = $this->helper->getActivatedLanguages();
      return $this->view->render($response, 'chunk.twig', compact('no_ads', 'lang', 'url','id_user','test', 'code', 'all_test', 'permission', 'loginUrl', 'loginUrl2' , 'img_url', 'interface_ui','lang','all_lang'));
