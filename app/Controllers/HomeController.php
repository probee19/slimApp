...
class HomeController extends Controller
{
    public function index($request, $response, $arg) {
      ...
      if($pageid == 1){
        ...
        $first_tests = array(393,394,395,389);
        shuffle($first_tests);
    ...
    public function chunk($request, $response, $args){
              ...
              $this->helper->debug($test->testInfo);
              $this->helper->debug($test->test_info);
              ...
              if(isset($_GET['utm']) && !empty($_GET['utm']))
                  $helper->setUTM($_GET['utm'], "test", $test->test_info->id_test);
              ...
              if(isset($_GET['ref']) && $_GET['ref'] === 'fb' && $test != null){
                  ...
                  **/
                  ...
                  $testId = $test->test_id;
                  $unique_result = $test->test_info->unique_result;
                  $id_rubrique = $test->test_info->id_rubrique;
                  $if_additionnal_info = $test->test_info->if_additionnal_info;
