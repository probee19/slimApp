...
class Helper
{
    ...
    public static function getRelatedTest($id, $countryCode, $exclude, $lang, $total = 3)
    {
      ...
      $related_tests_src = [
        ...
        112 =>  "393-400-394-392",
        205 =>  "393-400-394-392",
        393 =>  "395-400-399-397-362-207-388-371",
        395 =>  "393-400-399-397-362-207-388-371",
        397 =>  "393-399-401-395-362-207-388-371",
        388 =>  "393-400-401-399-395-397-362-207-388-371",
        399 =>  "393-400-401-395-397-362-207-388-371",
        400 =>  "393-401-395",
      ];
